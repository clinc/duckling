...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5598986333622836,
                               unseen = -6.2285110035911835,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 505},
                   koData =
                     ClassData{prior = -0.8469208575552172, unseen = -5.942799375126701,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.48550781578170077,
                               unseen = -7.1853870155804165,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.491481972157369),
                                    ("Father's Dayyear (latent)", -6.491481972157369),
                                    ("Karva Chauthyear (latent)", -6.491481972157369),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.491481972157369),
                                    ("Maha Shivaratriyear (latent)", -6.491481972157369),
                                    ("Ramadanyear (latent)", -5.238719003662001),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.39286968348926),
                                    ("Bhai Doojyear (latent)", -6.491481972157369),
                                    ("hourday", -4.476578951615105),
                                    ("dayhour", -3.547042992990929),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.39286968348926),
                                    ("Martin Luther King's Dayyear (latent)", -6.0860168640492045),
                                    ("Shemini Atzeretyear (latent)", -6.491481972157369),
                                    ("daymonth", -4.699722502929315),
                                    ("monthyear", -4.188896879163323),
                                    ("Yom Ha'atzmautyear (latent)", -6.491481972157369),
                                    ("Orthodox Good Fridayyear (latent)", -6.0860168640492045),
                                    ("Vijayadashamiyear (latent)", -6.491481972157369),
                                    ("Thanksgiving Dayyear (latent)", -5.39286968348926),
                                    ("Thai Pongalyear (latent)", -5.798334791597424),
                                    ("Thiru Onamyear (latent)", -5.798334791597424),
                                    ("hhhmmabsorption of , after named day", -6.491481972157369),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.575191240283214),
                                    ("<day-of-month> (ordinal)Wednesday", -6.491481972157369),
                                    ("Krishna Janmashtamiyear (latent)", -6.0860168640492045),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.491481972157369),
                                    ("houryear", -5.575191240283214),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.491481972157369),
                                    ("Christmas<time-of-day> am|pm", -6.491481972157369),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.491481972157369),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.798334791597424),
                                    ("intersectin|during <named-month>|year", -6.491481972157369),
                                    ("<time-of-day> am|pmintersect", -5.238719003662001),
                                    ("Earth Houryear (latent)", -6.491481972157369),
                                    ("Ganesh Chaturthiyear (latent)", -6.491481972157369),
                                    ("Octoberyear (latent)", -4.987404575381095),
                                    ("intersect<time-of-day> am|pm", -6.491481972157369),
                                    ("Mattu Pongalyear (latent)", -6.491481972157369),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.491481972157369),
                                    ("Januaryyear (latent)", -6.491481972157369),
                                    ("Shavuotyear (latent)", -6.491481972157369),
                                    ("Parsi New Yearyear (latent)", -5.575191240283214),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.491481972157369),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.491481972157369),
                                    ("todayin|within|after <duration>", -6.491481972157369),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0860168640492045),
                                    ("Marchyear (latent)", -6.0860168640492045),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0860168640492045),
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.491481972157369),
                                    ("Sukkotyear (latent)", -6.0860168640492045),
                                    ("hhhmmintersect", -6.0860168640492045),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0860168640492045),
                                    ("since <time>year (latent)", -6.491481972157369),
                                    ("Clean Mondayyear (latent)", -6.0860168640492045),
                                    ("monthhour", -6.0860168640492045),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.575191240283214),
                                    ("todayat <time-of-day>", -6.491481972157369),
                                    ("Thursday<time> timezone", -4.093586699358998),
                                    ("tonight<time-of-day> am|pm", -6.491481972157369),
                                    ("time-of-day (latent)tonight", -6.0860168640492045),
                                    ("dd/mm<time-of-day> am|pm", -6.491481972157369),
                                    ("<time-of-day> am|pmon <day>", -4.476578951615105),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.491481972157369),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0860168640492045),
                                    ("dayday", -3.7506419482321682),
                                    ("dd/mmat <time-of-day>", -6.491481972157369),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0860168640492045),
                                    ("tonightat <time-of-day>", -5.39286968348926),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.798334791597424),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.491481972157369),
                                    ("today<time-of-day> am|pm", -6.491481972157369),
                                    ("at <time-of-day><time> <part-of-day>", -6.491481972157369),
                                    ("<day-of-month> (ordinal)intersect", -6.0860168640492045),
                                    ("hourhour", -3.521067506587668),
                                    ("Mahavir Jayantiyear (latent)", -6.0860168640492045),
                                    ("Navaratriin|during <named-month>|year", -6.491481972157369),
                                    ("Wednesdaythis|last|next <cycle>", -6.491481972157369),
                                    ("Lentyear (latent)", -6.491481972157369),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.619679795255778),
                                    ("Boghiyear (latent)", -6.491481972157369),
                                    ("dayyear", -1.8665091588730982),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.491481972157369),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.491481972157369),
                                    ("Thursdayat <time-of-day>", -5.798334791597424),
                                    ("Islamic New Yearyear (latent)", -6.0860168640492045),
                                    ("Laylat al-Qadryear (latent)", -5.575191240283214),
                                    ("Aprilyear (latent)", -6.491481972157369),
                                    ("part of days<time-of-day> am|pm", -6.491481972157369),
                                    ("Shrove Tuesdayyear (latent)", -6.491481972157369),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.798334791597424),
                                    ("hourminute", -6.0860168640492045),
                                    ("<time-of-day> am|pmtomorrow", -5.575191240283214),
                                    ("Yom Kippuryear (latent)", -6.491481972157369),
                                    ("<day-of-month> (ordinal)Tuesday", -5.798334791597424),
                                    ("<part-of-day> of <time>year (latent)", -6.491481972157369),
                                    ("minutehour", -5.238719003662001),
                                    ("Kaanum Pongalyear (latent)", -6.0860168640492045),
                                    ("Maha Saptamiyear (latent)", -6.491481972157369),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.798334791597424),
                                    ("time-of-day (latent)tomorrow", -5.575191240283214),
                                    ("part of daysat <time-of-day>", -4.882044059723269),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.476578951615105),
                                    ("for <duration> from <time>December", -6.491481972157369),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.491481972157369),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.238719003662001),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.238719003662001),
                                    ("time-of-day (latent)this <part-of-day>", -6.491481972157369),
                                    ("Pentecostyear (latent)", -6.491481972157369),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.238719003662001),
                                    ("<day-of-month> (ordinal)February", -6.491481972157369),
                                    ("Eid al-Fitryear (latent)", -5.105187611037478),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.491481972157369),
                                    ("Mondayin|during the <part-of-day>", -6.491481972157369),
                                    ("Chhathin|during <named-month>|year", -6.491481972157369),
                                    ("Diwaliin|during <named-month>|year", -6.491481972157369),
                                    ("this <part-of-day><time-of-day> am|pm", -6.491481972157369),
                                    ("Vaisakhiin|during <named-month>|year", -6.491481972157369),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.238719003662001),
                                    ("Raksha Bandhanyear (latent)", -6.491481972157369),
                                    ("daysecond", -6.0860168640492045),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0860168640492045),
                                    ("Ratha-Yatrayear (latent)", -6.491481972157369),
                                    ("Ashurayear (latent)", -6.491481972157369),
                                    ("Tuesdayin|during <named-month>|year", -6.491481972157369),
                                    ("Chinese New Yearyear (latent)", -6.491481972157369),
                                    ("tomorrowintersect", -6.491481972157369),
                                    ("Juneyear (latent)", -6.0860168640492045),
                                    ("Lag BaOmeryear (latent)", -6.491481972157369),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.491481972157369),
                                    ("Eid al-Adhayear (latent)", -4.351415808661098),
                                    ("Palm Sundayyear (latent)", -6.491481972157369),
                                    ("Christmasat <time-of-day>", -6.491481972157369),
                                    ("Passoveryear (latent)", -6.491481972157369),
                                    ("Lazarus Saturdayyear (latent)", -6.491481972157369),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.491481972157369),
                                    ("the last <cycle> of <time>year (latent)", -5.798334791597424),
                                    ("hhhmmon <day>", -5.575191240283214),
                                    ("Yom HaShoahyear (latent)", -6.0860168640492045),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.491481972157369),
                                    ("Septemberyear (latent)", -6.0860168640492045),
                                    ("Decemberyear (latent)", -6.0860168640492045),
                                    ("Halloweenyear (latent)", -6.491481972157369),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.491481972157369),
                                    ("at <time-of-day>intersect", -5.575191240283214),
                                    ("Rosh Hashanahyear (latent)", -5.798334791597424),
                                    ("Dhanterasyear (latent)", -6.491481972157369),
                                    ("Tu BiShvatyear (latent)", -6.491481972157369),
                                    ("<day-of-month> (ordinal)December", -5.798334791597424),
                                    ("Holiyear (latent)", -5.798334791597424),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.491481972157369),
                                    ("Holika Dahanyear (latent)", -5.798334791597424),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0860168640492045),
                                    ("dayminute", -3.292808854606688),
                                    ("Mawlidyear (latent)", -6.491481972157369),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0860168640492045),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.491481972157369),
                                    ("Jumu'atul-Widayear (latent)", -5.575191240283214),
                                    ("minuteday", -2.790179998044876),
                                    ("absorption of , after named dayintersect",
                                     -5.798334791597424),
                                    ("intersectyear (latent)", -6.491481972157369),
                                    ("Orthodox Easter Sundayyear (latent)", -6.491481972157369),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.491481972157369),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.491481972157369),
                                    ("intersecthhhmm", -6.0860168640492045),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.491481972157369),
                                    ("Mothering Sundayyear (latent)", -6.0860168640492045),
                                    ("Boss's Dayyear (latent)", -6.0860168640492045),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.491481972157369),
                                    ("Global Youth Service Dayyear (latent)", -6.491481972157369),
                                    ("Dhanterasin|during <named-month>|year", -6.491481972157369),
                                    ("tonight<time-of-day> o'clock", -6.491481972157369),
                                    ("Tisha B'Avyear (latent)", -6.491481972157369),
                                    ("Isra and Mi'rajyear (latent)", -5.575191240283214),
                                    ("at <time-of-day>on <day>", -4.882044059723269),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0860168640492045),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.798334791597424),
                                    ("Christmasyear (latent)", -6.0860168640492045),
                                    ("Saturdayintersect", -6.491481972157369),
                                    ("Naraka Chaturdashiyear (latent)", -6.0860168640492045),
                                    ("Thai Pongalin|during <named-month>|year", -6.491481972157369),
                                    ("dayweek", -6.491481972157369),
                                    ("Easter Sundayyear (latent)", -5.798334791597424),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0860168640492045),
                                    ("weekyear", -5.238719003662001),
                                    ("King's Dayyear (latent)", -4.987404575381095),
                                    ("hh:mmin|during the <part-of-day>", -5.575191240283214),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0860168640492045),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.798334791597424),
                                    ("Hanukkahyear (latent)", -5.798334791597424),
                                    ("Rama Navamiyear (latent)", -6.491481972157369),
                                    ("February<time> <part-of-day>", -6.491481972157369),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.798334791597424),
                                    ("Great Lentyear (latent)", -6.491481972157369),
                                    ("tomorrowat <time-of-day>", -5.798334791597424),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.491481972157369),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.0860168640492045),
                                    ("Ugadiyear (latent)", -5.105187611037478),
                                    ("Vaisakhiyear (latent)", -5.798334791597424),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.798334791597424),
                                    ("last <cycle> of <time>year (latent)", -5.798334791597424),
                                    ("at <time-of-day>tomorrow", -6.0860168640492045),
                                    ("tomorrow<time-of-day> am|pm", -6.491481972157369),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.491481972157369),
                                    ("Diwaliyear (latent)", -6.491481972157369),
                                    ("between <time> and <time>on <day>", -6.0860168640492045),
                                    ("Black Fridayyear (latent)", -6.0860168640492045),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.491481972157369),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.491481972157369),
                                    ("Chhathyear (latent)", -6.0860168640492045),
                                    ("Vasant Panchamiyear (latent)", -6.491481972157369),
                                    ("Rabindra Jayantiyear (latent)", -5.238719003662001),
                                    ("this <part-of-day>at <time-of-day>", -5.238719003662001),
                                    ("St Patrick's Dayyear (latent)", -6.491481972157369),
                                    ("Thursday<time> (timezone)", -6.491481972157369),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.491481972157369),
                                    ("Pargat Diwasyear (latent)", -5.238719003662001),
                                    ("August Bank Holidayyear (latent)", -5.798334791597424),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.798334791597424),
                                    ("Februaryintersect", -6.491481972157369),
                                    ("Simchat Torahyear (latent)", -6.491481972157369),
                                    ("minuteyear", -6.491481972157369)],
                               n = 504},
                   koData =
                     ClassData{prior = -0.9555114450274363, unseen = -6.848005274576363,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.64971856224916),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.74833085091727),
                                    ("hourday", -3.4796473095989056),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.153795959025435),
                                    ("<day-of-month> (ordinal)August", -6.153795959025435),
                                    ("dayhour", -3.668889309237434),
                                    ("<time> timezoneyear (latent)", -5.460648778465489),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.23750522715128),
                                    ("after <time><time-of-day> am|pm", -6.153795959025435),
                                    ("daymonth", -3.4129559351002334),
                                    ("hourquarter", -5.055183670357325),
                                    ("monthday", -5.23750522715128),
                                    ("monthyear", -4.901032990530067),
                                    ("<time-of-day> am|pmyear (latent)", -5.460648778465489),
                                    ("time-of-day (latent)qq", -6.153795959025435),
                                    ("Thai Pongalyear (latent)", -5.460648778465489),
                                    ("intersecthh:mm", -6.153795959025435),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.74833085091727),
                                    ("<day-of-month> (ordinal)Wednesday", -6.153795959025435),
                                    ("houryear", -4.4490478667870095),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.153795959025435),
                                    ("Julyintersect", -5.460648778465489),
                                    ("<day-of-month> (ordinal)October", -6.153795959025435),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.460648778465489),
                                    ("<time-of-day> am|pmintersect", -4.901032990530067),
                                    ("time-of-day (latent)until <time>", -5.74833085091727),
                                    ("Octoberyear (latent)", -6.153795959025435),
                                    ("Good Fridayyear (latent)", -5.74833085091727),
                                    ("early morningat <time-of-day>", -6.153795959025435),
                                    ("until <time>on <day>", -5.460648778465489),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.153795959025435),
                                    ("time-of-day (latent)intersect", -6.153795959025435),
                                    ("todayin <number> (implicit minutes)", -6.153795959025435),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.153795959025435),
                                    ("hh:mmon <day>", -4.901032990530067),
                                    ("hhhmmintersect", -5.74833085091727),
                                    ("absorption of , after named dayJuly", -5.23750522715128),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.23750522715128),
                                    ("Clean Mondayyear (latent)", -6.153795959025435),
                                    ("monthhour", -4.767501597905544),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.74833085091727),
                                    ("hourmonth", -4.013729795529164),
                                    ("todayat <time-of-day>", -6.153795959025435),
                                    ("since <time>until <time>", -6.153795959025435),
                                    ("Bank Holidayyear (latent)", -5.460648778465489),
                                    ("hhhmmyear (latent)", -4.901032990530067),
                                    ("<time-of-day> am|pmon <day>", -4.901032990530067),
                                    ("Mondayyear (latent)", -5.460648778465489),
                                    ("dayday", -4.0743544173455986),
                                    ("dd/mmat <time-of-day>", -5.74833085091727),
                                    ("on <day>September", -5.460648778465489),
                                    ("since <time>intersect", -5.460648778465489),
                                    ("time-of-day (latent)September", -5.74833085091727),
                                    ("hourhour", -3.902504160418939),
                                    ("time-of-day (latent)on <day>", -4.64971856224916),
                                    ("Thursdaydd/mm", -6.153795959025435),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.74833085091727),
                                    ("dayyear", -3.1333710728810718),
                                    ("New Year's Dayyear (latent)", -5.23750522715128),
                                    ("time-of-day (latent)Sunday", -5.74833085091727),
                                    ("Thursdayat <time-of-day>", -4.544358046591334),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.153795959025435),
                                    ("Aprilyear (latent)", -6.153795959025435),
                                    ("the <day-of-month> (ordinal)July", -6.153795959025435),
                                    ("the <day-of-month> (number)July", -6.153795959025435),
                                    ("monthminute", -6.153795959025435),
                                    ("hourminute", -5.460648778465489),
                                    ("<time-of-day> am|pmtomorrow", -5.74833085091727),
                                    ("Thursdayhh:mm", -5.23750522715128),
                                    ("<day-of-month> (ordinal)Tuesday", -5.74833085091727),
                                    ("minutemonth", -4.0743544173455986),
                                    ("time-of-day (latent)Friday", -5.74833085091727),
                                    ("minutehour", -6.153795959025435),
                                    ("part of daysat <time-of-day>", -5.055183670357325),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.8024207018619567),
                                    ("Augustyear (latent)", -5.74833085091727),
                                    ("week-endin|during <named-month>|year", -6.153795959025435),
                                    ("time-of-day (latent)Tuesday", -5.74833085091727),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.153795959025435),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.74833085091727),
                                    ("Sundayyear (latent)", -5.23750522715128),
                                    ("hourweek", -5.23750522715128),
                                    ("the <day-of-month> (ordinal)Monday", -5.460648778465489),
                                    ("Christmasat <time-of-day>", -6.153795959025435),
                                    ("dd/mmyear (latent)", -6.153795959025435),
                                    ("the last <cycle> of <time>year (latent)", -5.74833085091727),
                                    ("hhhmmon <day>", -5.23750522715128),
                                    ("Julyuntil <time>", -5.74833085091727),
                                    ("yesterday<time-of-day> am|pm", -6.153795959025435),
                                    ("<day-of-month> (ordinal)July", -5.460648778465489),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.153795959025435),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.153795959025435),
                                    ("at <time-of-day>intersect", -5.23750522715128),
                                    ("hh:mmyear (latent)", -4.767501597905544),
                                    ("Holiyear (latent)", -6.153795959025435),
                                    ("until <time><time-of-day> am|pm", -6.153795959025435),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.74833085091727),
                                    ("dayminute", -3.514738629410176),
                                    ("yyyy-mm-ddhh:mm", -5.74833085091727),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.153795959025435),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -6.153795959025435),
                                    ("intersectSeptember", -4.281993782123843),
                                    ("minuteday", -3.0857430238918173),
                                    ("absorption of , after named dayintersect",
                                     -6.153795959025435),
                                    ("intersectyear (latent)", -6.153795959025435),
                                    ("Februaryin|during the <part-of-day>", -6.153795959025435),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.153795959025435),
                                    ("time-of-day (latent)July", -5.460648778465489),
                                    ("Saturdayyear (latent)", -6.153795959025435),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.153795959025435),
                                    ("<day-of-month> (ordinal)Monday", -4.901032990530067),
                                    ("at <time-of-day>on <day>", -5.23750522715128),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.153795959025435),
                                    ("absorption of , after named daySeptember",
                                     -4.901032990530067),
                                    ("Naraka Chaturdashiyear (latent)", -6.153795959025435),
                                    ("Easter Sundayyear (latent)", -5.74833085091727),
                                    ("time-of-day (latent)at <time-of-day>", -5.460648778465489),
                                    ("Thursday<time-of-day> am|pm", -5.055183670357325),
                                    ("weekyear", -5.23750522715128),
                                    ("after <time>year (latent)", -5.74833085091727),
                                    ("time-of-day (latent)Thursday", -5.74833085091727),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.74833085091727),
                                    ("<day-of-month> (ordinal)April", -6.153795959025435),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.74833085091727),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.460648778465489),
                                    ("absorption of , after named dayFebruary", -5.23750522715128),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.74833085091727),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.153795959025435),
                                    ("tomorrowat <time-of-day>", -6.153795959025435),
                                    ("Fridayin|during <named-month>|year", -6.153795959025435),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.74833085091727),
                                    ("last <cycle> of <time>year (latent)", -5.74833085091727),
                                    ("tomorrow<time-of-day> am|pm", -6.153795959025435),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.74833085091727),
                                    ("Diwaliyear (latent)", -5.74833085091727),
                                    ("this <part-of-day>at <time-of-day>", -5.23750522715128),
                                    ("Fridayyear (latent)", -5.23750522715128),
                                    ("time-of-day (latent)<named-month> <day-of-month> (non ordinal)",
                                     -6.153795959025435),
                                    ("time-of-day (latent)April", -6.153795959025435),
                                    ("minuteyear", -4.013729795529164)],
                               n = 315}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13621020483454893,
                               unseen = -5.472270673671475,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.564243061333767e-2),
                                    ("intersect 2 numbers", -4.081765780015241)],
                               n = 233},
                   koData =
                     ClassData{prior = -2.060888133784088, unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6851150088626811, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.7012443907925646, unseen = -4.836281906951478,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.164874643190234),
                                    ("integer (0..19)", -1.8838747581358606)],
                               n = 123}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
