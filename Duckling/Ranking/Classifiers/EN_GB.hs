...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5842342632977512, unseen = -6.156978985585555,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 470},
                   koData =
                     ClassData{prior = -0.8153885383580399, unseen = -5.926926025970411,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4744143200522243, unseen = -7.192182058713246,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.498282149476434),
                                    ("Father's Dayyear (latent)", -6.498282149476434),
                                    ...
                                    ("hourday", -4.483379128934169),
                                    ("dayhour", -3.4778572633320715),
                                    ...
                                    ("monthday", -6.09281704136827),
                                    ("monthyear", -4.706522680248379),
                                    ...
                                    ("hhhmmabsorption of , after named day", -6.498282149476434),
                                    ...
                                    ("houryear", -5.5819914176022785),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.498282149476434),
                                    ("Christmas<time-of-day> am|pm", -6.498282149476434),
                                    ...
                                    ("<time-of-day> am|pmintersect", -5.2455191809810655),
                                    ("Earth Houryear (latent)", -6.498282149476434),
                                    ("Ganesh Chaturthiyear (latent)", -6.498282149476434),
                                    ("Octoberyear (latent)", -4.99420475270016),
                                    ("intersect<time-of-day> am|pm", -6.498282149476434),
                                    ("Mattu Pongalyear (latent)", -6.498282149476434),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.498282149476434),
                                    ("Shavuotyear (latent)", -6.498282149476434),
                                    ("Parsi New Yearyear (latent)", -5.5819914176022785),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.498282149476434),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.498282149476434),
                                    ("todayin|within|after <duration>", -6.498282149476434),
                                    ...
                                    ("hhhmmintersect", -6.09281704136827),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.09281704136827),
                                    ("Clean Mondayyear (latent)", -6.09281704136827),
                                    ("monthhour", -6.09281704136827),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.805134968916488),
                                    ("todayat <time-of-day>", -6.498282149476434),
                                    ("Thursday<time> timezone", -4.100386876678063),
                                    ("tonight<time-of-day> am|pm", -6.498282149476434),
                                    ("time-of-day (latent)tonight", -6.09281704136827),
                                    ("from|since|after <time>December", -6.498282149476434),
                                    ("dd/mm<time-of-day> am|pm", -6.498282149476434),
                                    ("<time-of-day> am|pmon <day>", -4.483379128934169),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.498282149476434),
                                    ("yyyy-mm-ddhh:mm:ss", -6.09281704136827),
                                    ("dayday", -3.790231948374224),
                                    ("dd/mmat <time-of-day>", -6.498282149476434),
                                    ("<time> <part-of-day>at <time-of-day>", -6.09281704136827),
                                    ("tonightat <time-of-day>", -5.3996698608083245),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.805134968916488),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.498282149476434),
                                    ("today<time-of-day> am|pm", -6.498282149476434),
                                    ("Februarythe <day-of-month> (ordinal)", -6.09281704136827),
                                    ("at <time-of-day><time> <part-of-day>", -6.498282149476434),
                                    ("<day-of-month> (ordinal)intersect", -6.09281704136827),
                                    ("hourhour", -3.5278676839067327),
                                    ("Mahavir Jayantiyear (latent)", -6.09281704136827),
                                    ("Navaratriin|during <named-month>|year", -6.498282149476434),
                                    ...
                                    ("dayyear", -1.8981245053118867),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.498282149476434),
                                    ("Thursdayfrom|since|after <time>", -6.09281704136827),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.498282149476434),
                                    ("Thursdayat <time-of-day>", -5.805134968916488),
                                    ("Islamic New Yearyear (latent)", -6.09281704136827),
                                    ("Laylat al-Qadryear (latent)", -5.5819914176022785),
                                    ("part of days<time-of-day> am|pm", -6.498282149476434),
                                    ("Shrove Tuesdayyear (latent)", -6.498282149476434),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.805134968916488),
                                    ("hourminute", -6.09281704136827),
                                    ("<time-of-day> am|pmtomorrow", -5.805134968916488),
                                    ("Yom Kippuryear (latent)", -6.498282149476434),
                                    ("<day-of-month> (ordinal)Tuesday", -6.09281704136827),
                                    ("<part-of-day> of <time>year (latent)", -6.498282149476434),
                                    ("minutehour", -5.2455191809810655),
                                    ("Kaanum Pongalyear (latent)", -6.09281704136827),
                                    ("Maha Saptamiyear (latent)", -6.498282149476434),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.805134968916488),
                                    ("time-of-day (latent)tomorrow", -5.5819914176022785),
                                    ("part of daysat <time-of-day>", -4.888844237042333),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.483379128934169),
                                    ("for <duration> from <time>December", -6.498282149476434),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.498282149476434),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.2455191809810655),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.2455191809810655),
                                    ("time-of-day (latent)this <part-of-day>", -6.498282149476434),
                                    ...
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.498282149476434),
                                    ("Mondayin|during the <part-of-day>", -6.498282149476434),
                                    ("Chhathin|during <named-month>|year", -6.498282149476434),
                                    ("Diwaliin|during <named-month>|year", -6.498282149476434),
                                    ("this <part-of-day><time-of-day> am|pm", -6.498282149476434),
                                    ("Vaisakhiin|during <named-month>|year", -6.498282149476434),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.2455191809810655),
                                    ("Raksha Bandhanyear (latent)", -6.498282149476434),
                                    ("daysecond", -6.09281704136827),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.498282149476434),
                                    ("the last <cycle> of <time>year (latent)", -5.805134968916488),
                                    ("hhhmmon <day>", -5.5819914176022785),
                                    ...
                                    ("minuteday", -2.7606125311930656),
                                    ("absorption of , after named dayintersect",
                                     -5.805134968916488),
                                    ("intersectyear (latent)", -6.498282149476434),
                                    ...
                                    ("at <time-of-day>tomorrow", -6.09281704136827),
                                    ("tomorrow<time-of-day> am|pm", -6.498282149476434),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.498282149476434),
                                    ("Diwaliyear (latent)", -6.498282149476434),
                                    ("between <time> and <time>on <day>", -6.09281704136827),
                                    ...
                                    ("this <part-of-day>at <time-of-day>", -5.2455191809810655),
                                    ("St Patrick's Dayyear (latent)", -6.498282149476434),
                                    ("Thursday<time> (timezone)", -6.498282149476434),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.498282149476434),
                                    ("Pargat Diwasyear (latent)", -5.2455191809810655),
                                    ("August Bank Holidayyear (latent)", -5.805134968916488),
                                    ("<datetime> - <datetime> (interval)July", -6.09281704136827),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.805134968916488),
                                    ("Februaryintersect", -6.498282149476434),
                                    ("Simchat Torahyear (latent)", -6.498282149476434),
                                    ("minuteyear", -6.498282149476434)],
                               n = 509},
                   koData =
                     ClassData{prior = -0.9735210597050016, unseen = -6.834108738813838,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.635807155449982),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.734419444118091),
                                    ("hourday", -3.7419892794278846),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.139884552226255),
                                    ("<day-of-month> (ordinal)August", -6.139884552226255),
                                    ("dayhour", -3.4318343511240452),
                                    ("<time> timezoneyear (latent)", -5.44673737166631),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.2235938203521),
                                    ("after <time><time-of-day> am|pm", -6.139884552226255),
                                    ("Tuesdayfrom|since|after <time>", -5.44673737166631),
                                    ("daymonth", -3.4657359027997265),
                                    ("hourquarter", -6.139884552226255),
                                    ("monthyear", -4.887121583730887),
                                    ("<time-of-day> am|pmyear (latent)", -5.44673737166631),
                                    ("time-of-day (latent)qq", -6.139884552226255),
                                    ("Thai Pongalyear (latent)", -5.44673737166631),
                                    ("intersecthh:mm", -6.139884552226255),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.734419444118091),
                                    ("<day-of-month> (ordinal)Wednesday", -6.139884552226255),
                                    ("houryear", -4.7535901911063645),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.139884552226255),
                                    ("<day-of-month> (ordinal)October", -6.139884552226255),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.44673737166631),
                                    ("hournograin", -4.887121583730887),
                                    ("<time-of-day> am|pmintersect", -4.887121583730887),
                                    ("Octoberyear (latent)", -6.139884552226255),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.734419444118091),
                                    ("early morningat <time-of-day>", -6.139884552226255),
                                    ("until <time>on <day>", -5.44673737166631),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.139884552226255),
                                    ("time-of-day (latent)intersect", -5.44673737166631),
                                    ("todayin <number> (implicit minutes)", -6.139884552226255),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.44673737166631),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.139884552226255),
                                    ("hh:mmon <day>", -4.887121583730887),
                                    ("hhhmmintersect", -5.734419444118091),
                                    ("absorption of , after named dayJuly", -5.2235938203521),
                                    ("from|since|after <time>July", -5.734419444118091),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.2235938203521),
                                    ("Clean Mondayyear (latent)", -6.139884552226255),
                                    ("monthhour", -6.139884552226255),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.734419444118091),
                                    ("hourmonth", -4.2680823753246635),
                                    ("todayat <time-of-day>", -6.139884552226255),
                                    ("Bank Holidayyear (latent)", -5.44673737166631),
                                    ("hhhmmyear (latent)", -4.887121583730887),
                                    ("from|since|after <time>December", -6.139884552226255),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.139884552226255),
                                    ("<time-of-day> am|pmon <day>", -4.887121583730887),
                                    ("Mondayyear (latent)", -5.44673737166631),
                                    ("dayday", -4.12498153168399),
                                    ("dd/mmat <time-of-day>", -5.734419444118091),
                                    ("on <day>September", -5.44673737166631),
                                    ("time-of-day (latent)September", -5.734419444118091),
                                    ("hourhour", -3.88859275361976),
                                    ("time-of-day (latent)on <day>", -4.635807155449982),
                                    ("Thursdaydd/mm", -6.139884552226255),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.734419444118091),
                                    ("dayyear", -3.0953621145028323),
                                    ("New Year's Dayyear (latent)", -5.2235938203521),
                                    ("time-of-day (latent)Sunday", -5.734419444118091),
                                    ("Thursdayfrom|since|after <time>", -4.43513645998783),
                                    ("Thursdayat <time-of-day>", -4.530446639792155),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.139884552226255),
                                    ("Aprilyear (latent)", -6.139884552226255),
                                    ("the <day-of-month> (ordinal)July", -6.139884552226255),
                                    ("the <day-of-month> (number)July", -6.139884552226255),
                                    ("monthminute", -6.139884552226255),
                                    ("hourminute", -5.44673737166631),
                                    ("<time-of-day> am|pmtomorrow", -6.139884552226255),
                                    ("Thursdayhh:mm", -5.2235938203521),
                                    ("<day-of-month> (ordinal)Tuesday", -5.734419444118091),
                                    ("minutemonth", -3.9998183887299845),
                                    ("time-of-day (latent)Friday", -5.734419444118091),
                                    ("minutehour", -6.139884552226255),
                                    ("part of daysat <time-of-day>", -5.041272263558145),
                                    ("Augustyear (latent)", -5.734419444118091),
                                    ("week-endin|during <named-month>|year", -6.139884552226255),
                                    ("time-of-day (latent)Tuesday", -5.734419444118091),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.139884552226255),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.734419444118091),
                                    ("Sundayyear (latent)", -5.2235938203521),
                                    ("the <day-of-month> (ordinal)Monday", -5.44673737166631),
                                    ("Christmasat <time-of-day>", -6.139884552226255),
                                    ("from|since|after <time>year (latent)", -5.041272263558145),
                                    ("dd/mmyear (latent)", -6.139884552226255),
                                    ("the last <cycle> of <time>year (latent)", -5.734419444118091),
                                    ("hhhmmon <day>", -5.2235938203521),
                                    ("yesterday<time-of-day> am|pm", -6.139884552226255),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.139884552226255),
                                    ("at <time-of-day>intersect", -5.2235938203521),
                                    ("hh:mmyear (latent)", -4.7535901911063645),
                                    ("Holiyear (latent)", -6.139884552226255),
                                    ("until <time><time-of-day> am|pm", -6.139884552226255),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.734419444118091),
                                    ("dayminute", -3.2776836712967867),
                                    ("yyyy-mm-ddhh:mm", -5.734419444118091),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.139884552226255),
                                    ("intersectfrom|since|after <time>", -5.734419444118091),
                                    ("intersectSeptember", -4.2680823753246635),
                                    ("minuteday", -2.9828841310761423),
                                    ("absorption of , after named dayintersect",
                                     -6.139884552226255),
                                    ("intersectyear (latent)", -6.139884552226255),
                                    ("Februaryin|during the <part-of-day>", -6.139884552226255),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.139884552226255),
                                    ("time-of-day (latent)July", -5.44673737166631),
                                    ("Saturdayyear (latent)", -6.139884552226255),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.139884552226255),
                                    ("<day-of-month> (ordinal)Monday", -5.2235938203521),
                                    ("at <time-of-day>on <day>", -5.2235938203521),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.139884552226255),
                                    ("absorption of , after named daySeptember",
                                     -4.887121583730887),
                                    ("Naraka Chaturdashiyear (latent)", -6.139884552226255),
                                    ("from|since|after <time>on <day>", -5.2235938203521),
                                    ("dayweek", -6.139884552226255),
                                    ("Easter Sundayyear (latent)", -5.734419444118091),
                                    ("time-of-day (latent)at <time-of-day>", -5.44673737166631),
                                    ("Thursday<time-of-day> am|pm", -4.887121583730887),
                                    ("weekyear", -5.2235938203521),
                                    ("after <time>year (latent)", -6.139884552226255),
                                    ("time-of-day (latent)Thursday", -5.734419444118091),
                                    ("<day-of-month> (ordinal)April", -6.139884552226255),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.734419444118091),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.44673737166631),
                                    ("Sundayfrom|since|after <time>", -6.139884552226255),
                                    ("absorption of , after named dayFebruary", -5.2235938203521),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.734419444118091),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.139884552226255),
                                    ("tomorrowat <time-of-day>", -6.139884552226255),
                                    ("daynograin", -5.734419444118091),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.734419444118091),
                                    ("last <cycle> of <time>year (latent)", -5.734419444118091),
                                    ("tomorrow<time-of-day> am|pm", -6.139884552226255),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.44673737166631),
                                    ("Diwaliyear (latent)", -5.734419444118091),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.139884552226255),
                                    ("this <part-of-day>at <time-of-day>", -5.2235938203521),
                                    ("Fridayyear (latent)", -5.734419444118091),
                                    ("time-of-day (latent)April", -6.139884552226255),
                                    ("minuteyear", -3.9426599748900357)],
                               n = 309}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14965629023941907,
                               unseen = -5.429345628954441,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.6787315963649843e-2),
                                    ("intersect 2 numbers", -4.038655656361512)],
                               n = 223},
                   koData =
                     ClassData{prior = -1.9733091232434277, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
