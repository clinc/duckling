...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5884986620842088, unseen = -6.152732694704104,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 468},
                   koData =
                     ClassData{prior = -0.8100409320314447, unseen = -5.932245187448011,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4705025067816497, unseen = -7.173958319756793,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.480044561926653),
                                    ...
                                    ("hourday", -4.465141541384388),
                                    ("dayhour", -3.484312288372662),
                                    ...
                                    ("daymonth", -4.608242385025061),
                                    ("monthyear", -4.688285092698598),
                                    ...
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.786897381366708),
                                    ("intersectin|during <named-month>|year", -6.480044561926653),
                                    ...
                                    ("Marchyear (latent)", -6.480044561926653),
                                    ...
                                    ("time-of-day (latent)tonight", -6.0745794538184885),
                                    ("from|since|after <time>December", -6.480044561926653),
                                    ("dd/mm<time-of-day> am|pm", -6.480044561926653),
                                    ("<time-of-day> am|pmon <day>", -4.465141541384388),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.480044561926653),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0745794538184885),
                                    ("dayday", -3.8058959125001244),
                                    ("dd/mmat <time-of-day>", -6.480044561926653),
                                    ...
                                    ("<day-of-month> (ordinal)intersect", -6.0745794538184885),
                                    ("hourhour", -3.509630096356952),
                                    ...
                                    ("dayyear", -1.8899880137486098),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.480044561926653),
                                    ("Thursdayfrom|since|after <time>", -6.0745794538184885),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.480044561926653),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.227281593431285),
                                    ("time-of-day (latent)this <part-of-day>", -6.480044561926653),
                                    ("Pentecostyear (latent)", -6.480044561926653),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.227281593431285),
                                    ("<day-of-month> (ordinal)February", -6.480044561926653),
                                    ...
                                    ("tomorrowintersect", -6.480044561926653),
                                    ...
                                    ("<day-of-month> (ordinal)December", -5.786897381366708),
                                    ...
                                    ("minuteday", -2.7423749436432847),
                                    ("absorption of , after named dayintersect",
                                     -5.786897381366708),
                                    ("intersectyear (latent)", -6.480044561926653),
                                    ...
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.480044561926653),
                                    ("Mothering Sundayyear (latent)", -6.0745794538184885),
                                    ...
                                    ("Saturdayintersect", -6.480044561926653),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.786897381366708),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.786897381366708),
                                    ("Februaryintersect", -6.480044561926653),
                                    ("Simchat Torahyear (latent)", -6.480044561926653),
                                    ("minuteyear", -6.480044561926653)],
                               n = 501},
                   koData =
                     ClassData{prior = -0.9799983431176388, unseen = -6.807934943699926,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.609604783055957),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.708217071724067),
                                    ("hourday", -3.7157869070338605),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.113682179832232),
                                    ("<day-of-month> (ordinal)August", -6.113682179832232),
                                    ("dayhour", -3.405631978730021),
                                    ("<time> timezoneyear (latent)", -5.420534999272286),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1973914479580765),
                                    ("after <time><time-of-day> am|pm", -6.113682179832232),
                                    ("Tuesdayfrom|since|after <time>", -5.420534999272286),
                                    ("daymonth", -3.4746248502169728),
                                    ("hourquarter", -6.113682179832232),
                                    ("monthyear", -4.8609192113368636),
                                    ("<time-of-day> am|pmyear (latent)", -5.420534999272286),
                                    ("time-of-day (latent)qq", -6.113682179832232),
                                    ("Thai Pongalyear (latent)", -5.420534999272286),
                                    ("intersecthh:mm", -6.113682179832232),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.708217071724067),
                                    ("<day-of-month> (ordinal)Wednesday", -6.113682179832232),
                                    ("houryear", -4.8609192113368636),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.113682179832232),
                                    ("<day-of-month> (ordinal)October", -6.113682179832232),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.420534999272286),
                                    ("hournograin", -5.1973914479580765),
                                    ("<time-of-day> am|pmintersect", -4.8609192113368636),
                                    ("Octoberyear (latent)", -6.113682179832232),
                                    ("early morningat <time-of-day>", -6.113682179832232),
                                    ("until <time>on <day>", -5.420534999272286),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.113682179832232),
                                    ("time-of-day (latent)intersect", -5.420534999272286),
                                    ("todayin <number> (implicit minutes)", -6.113682179832232),
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.113682179832232),
                                    ("hh:mmon <day>", -4.8609192113368636),
                                    ("hhhmmintersect", -5.708217071724067),
                                    ("absorption of , after named dayJuly", -5.1973914479580765),
                                    ("from|since|after <time>July", -6.113682179832232),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.1973914479580765),
                                    ("Clean Mondayyear (latent)", -6.113682179832232),
                                    ("monthhour", -6.113682179832232),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.708217071724067),
                                    ("hourmonth", -4.24188000293064),
                                    ("todayat <time-of-day>", -6.113682179832232),
                                    ("Bank Holidayyear (latent)", -5.420534999272286),
                                    ("hhhmmyear (latent)", -4.8609192113368636),
                                    ("from|since|after <time>December", -6.113682179832232),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.113682179832232),
                                    ("<time-of-day> am|pmon <day>", -4.8609192113368636),
                                    ("Mondayyear (latent)", -5.420534999272286),
                                    ("dayday", -4.0987791592899665),
                                    ("dd/mmat <time-of-day>", -5.708217071724067),
                                    ("on <day>September", -5.420534999272286),
                                    ("time-of-day (latent)September", -5.708217071724067),
                                    ("hourhour", -3.862390381225736),
                                    ("time-of-day (latent)on <day>", -4.609604783055957),
                                    ("Thursdaydd/mm", -6.113682179832232),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.708217071724067),
                                    ("dayyear", -3.1692432006657905),
                                    ("New Year's Dayyear (latent)", -5.1973914479580765),
                                    ("time-of-day (latent)Sunday", -5.708217071724067),
                                    ("Thursdayfrom|since|after <time>", -4.408934087593806),
                                    ("Thursdayat <time-of-day>", -4.504244267398131),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.113682179832232),
                                    ("Aprilyear (latent)", -6.113682179832232),
                                    ("the <day-of-month> (ordinal)July", -6.113682179832232),
                                    ("the <day-of-month> (number)July", -6.113682179832232),
                                    ("monthminute", -6.113682179832232),
                                    ("hourminute", -5.420534999272286),
                                    ("<time-of-day> am|pmtomorrow", -6.113682179832232),
                                    ("Thursdayhh:mm", -5.1973914479580765),
                                    ("<day-of-month> (ordinal)Tuesday", -5.708217071724067),
                                    ("minutemonth", -3.9736160163359604),
                                    ("time-of-day (latent)Friday", -5.708217071724067),
                                    ("minutehour", -6.113682179832232),
                                    ("part of daysat <time-of-day>", -5.015069891164122),
                                    ("Augustyear (latent)", -5.708217071724067),
                                    ("week-endin|during <named-month>|year", -6.113682179832232),
                                    ("time-of-day (latent)Tuesday", -5.708217071724067),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.113682179832232),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.708217071724067),
                                    ("Sundayyear (latent)", -5.1973914479580765),
                                    ("the <day-of-month> (ordinal)Monday", -5.420534999272286),
                                    ("Christmasat <time-of-day>", -6.113682179832232),
                                    ("from|since|after <time>year (latent)", -5.1973914479580765),
                                    ("dd/mmyear (latent)", -6.113682179832232),
                                    ("the last <cycle> of <time>year (latent)", -5.708217071724067),
                                    ("hhhmmon <day>", -5.1973914479580765),
                                    ("yesterday<time-of-day> am|pm", -6.113682179832232),
                                    ("<day-of-month> (ordinal)July", -5.420534999272286),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.113682179832232),
                                    ("at <time-of-day>intersect", -5.1973914479580765),
                                    ("hh:mmyear (latent)", -4.727387818712341),
                                    ("Holiyear (latent)", -6.113682179832232),
                                    ("until <time><time-of-day> am|pm", -6.113682179832232),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.708217071724067),
                                    ("dayminute", -3.251481298902763),
                                    ("yyyy-mm-ddhh:mm", -5.708217071724067),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.113682179832232),
                                    ("intersectfrom|since|after <time>", -5.708217071724067),
                                    ("intersectSeptember", -4.24188000293064),
                                    ("minuteday", -2.956681758682118),
                                    ("absorption of , after named dayintersect",
                                     -6.113682179832232),
                                    ("intersectyear (latent)", -6.113682179832232),
                                    ("Februaryin|during the <part-of-day>", -6.113682179832232),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.113682179832232),
                                    ("time-of-day (latent)July", -5.420534999272286),
                                    ("Saturdayyear (latent)", -6.113682179832232),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.113682179832232),
                                    ("<day-of-month> (ordinal)Monday", -5.1973914479580765),
                                    ("at <time-of-day>on <day>", -5.1973914479580765),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.113682179832232),
                                    ("absorption of , after named daySeptember",
                                     -4.8609192113368636),
                                    ("Naraka Chaturdashiyear (latent)", -6.113682179832232),
                                    ("from|since|after <time>on <day>", -5.1973914479580765),
                                    ("dayweek", -6.113682179832232),
                                    ("Easter Sundayyear (latent)", -5.708217071724067),
                                    ("time-of-day (latent)at <time-of-day>", -5.420534999272286),
                                    ("Thursday<time-of-day> am|pm", -4.8609192113368636),
                                    ("weekyear", -5.1973914479580765),
                                    ("after <time>year (latent)", -6.113682179832232),
                                    ("time-of-day (latent)Thursday", -5.708217071724067),
                                    ("<day-of-month> (ordinal)April", -6.113682179832232),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.708217071724067),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.420534999272286),
                                    ("Sundayfrom|since|after <time>", -6.113682179832232),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.113682179832232),
                                    ("tomorrowat <time-of-day>", -6.113682179832232),
                                    ("daynograin", -5.708217071724067),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.708217071724067),
                                    ("last <cycle> of <time>year (latent)", -5.708217071724067),
                                    ("tomorrow<time-of-day> am|pm", -6.113682179832232),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.420534999272286),
                                    ("Diwaliyear (latent)", -5.708217071724067),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.113682179832232),
                                    ("this <part-of-day>at <time-of-day>", -5.1973914479580765),
                                    ("Fridayyear (latent)", -5.708217071724067),
                                    ("time-of-day (latent)April", -6.113682179832232),
                                    ("minuteyear", -3.9164576024960116)],
                               n = 301}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13522678720976747,
                               ...
                               n = 221},
                   koData =
                     ClassData{prior = -2.067653585927794, unseen = -3.6109179126442243,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.623303607192681, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.7682376319150153, unseen = -4.718498871295094,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.480121308269841e-2),
                                    ("integer (0..19)", -2.630088659632498)],
                               n = 109}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
