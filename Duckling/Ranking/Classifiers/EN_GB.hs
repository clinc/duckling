...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5508534098564366, unseen = -6.26530121273771,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 524},
                   koData =
                     ClassData{prior = -0.8591017598896946, unseen = -5.958424693029782,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.38405101360434785,
                               unseen = -7.097548850614793,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.403574197934815),
                                    ("Father's Dayyear (latent)", -6.403574197934815),
                                    ("Karva Chauthyear (latent)", -6.403574197934815),
                                    ("Maha Shivaratriyear (latent)", -6.403574197934815),
                                    ("Ramadanyear (latent)", -5.150811229439447),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.304961909266705),
                                    ("Bhai Doojyear (latent)", -6.403574197934815),
                                    ("hourday", -4.457664048879502),
                                    ("dayhour", -3.570360853878599),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.304961909266705),
                                    ("Martin Luther King's Dayyear (latent)", -5.9981090898266505),
                                    ("Shemini Atzeretyear (latent)", -6.403574197934815),
                                    ("daymonth", -5.150811229439447),
                                    ("monthyear", -4.005678925136444),
                                    ("Yom Ha'atzmautyear (latent)", -6.403574197934815),
                                    ("Orthodox Good Fridayyear (latent)", -5.9981090898266505),
                                    ("Vijayadashamiyear (latent)", -6.403574197934815),
                                    ("Thanksgiving Dayyear (latent)", -5.304961909266705),
                                    ("Thai Pongalyear (latent)", -5.71042701737487),
                                    ("Thiru Onamyear (latent)", -5.71042701737487),
                                    ("hhhmmabsorption of , after named day", -6.403574197934815),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.48728346606066),
                                    ("Krishna Janmashtamiyear (latent)", -5.9981090898266505),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.403574197934815),
                                    ("houryear", -5.71042701737487),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.403574197934815),
                                    ("Christmas<time-of-day> am|pm", -6.403574197934815),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.403574197934815),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.71042701737487),
                                    ("<time-of-day> am|pmintersect", -5.150811229439447),
                                    ("Earth Houryear (latent)", -6.403574197934815),
                                    ("Ganesh Chaturthiyear (latent)", -6.403574197934815),
                                    ("Octoberyear (latent)", -4.8994968011585405),
                                    ("intersect<time-of-day> am|pm", -6.403574197934815),
                                    ("Mattu Pongalyear (latent)", -6.403574197934815),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.403574197934815),
                                    ("Januaryyear (latent)", -5.9981090898266505),
                                    ("Shavuotyear (latent)", -6.403574197934815),
                                    ("Parsi New Yearyear (latent)", -5.48728346606066),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.403574197934815),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.403574197934815),
                                    ("todayin|within|after <duration>", -6.403574197934815),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9981090898266505),
                                    ("Marchyear (latent)", -5.9981090898266505),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -5.9981090898266505),
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.403574197934815),
                                    ("Sukkotyear (latent)", -5.9981090898266505),
                                    ("hhhmmintersect", -5.9981090898266505),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.403574197934815),
                                    ("since <time>year (latent)", -6.403574197934815),
                                    ("<time-of-day> o'clock<time> <part-of-day>",
                                     -5.9981090898266505),
                                    ("Clean Mondayyear (latent)", -5.9981090898266505),
                                    ("monthhour", -6.403574197934815),
                                    ("todayat <time-of-day>", -6.403574197934815),
                                    ("Thursday<time> timezone", -4.005678925136444),
                                    ("tonight<time-of-day> am|pm", -6.403574197934815),
                                    ("dd/mm<time-of-day> am|pm", -6.403574197934815),
                                    ("<time-of-day> am|pmon <day>", -4.38867117739255),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.403574197934815),
                                    ("yyyy-mm-ddhh:mm:ss", -5.9981090898266505),
                                    ("dayday", -4.052198940771337),
                                    ("dd/mmat <time-of-day>", -6.403574197934815),
                                    ("<time> <part-of-day>at <time-of-day>", -5.9981090898266505),
                                    ("tonightat <time-of-day>", -5.304961909266705),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.71042701737487),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.403574197934815),
                                    ("today<time-of-day> am|pm", -6.403574197934815),
                                    ("at <time-of-day><time> <part-of-day>", -6.403574197934815),
                                    ("hourhour", -3.9612271625656104),
                                    ("Mahavir Jayantiyear (latent)", -5.9981090898266505),
                                    ("Navaratriin|during <named-month>|year", -6.403574197934815),
                                    ("Wednesdaythis|last|next <cycle>", -6.403574197934815),
                                    ("Lentyear (latent)", -6.403574197934815),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.531772021033223),
                                    ("Boghiyear (latent)", -6.403574197934815),
                                    ("dayyear", -1.7496138477772916),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.403574197934815),
                                    ("<time-of-day> o'clocktomorrow", -5.9981090898266505),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.403574197934815),
                                    ("Thursdayat <time-of-day>", -5.71042701737487),
                                    ("Islamic New Yearyear (latent)", -5.9981090898266505),
                                    ("Laylat al-Qadryear (latent)", -5.48728346606066),
                                    ("Aprilyear (latent)", -6.403574197934815),
                                    ("<day-of-month> (ordinal or number) of <named-month>year (latent)",
                                     -5.9981090898266505),
                                    ("Shrove Tuesdayyear (latent)", -6.403574197934815),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.71042701737487),
                                    ("hourminute", -6.403574197934815),
                                    ("<time-of-day> am|pmtomorrow", -5.304961909266705),
                                    ("Yom Kippuryear (latent)", -6.403574197934815),
                                    ("<part-of-day> of <time>year (latent)", -6.403574197934815),
                                    ("minutehour", -5.304961909266705),
                                    ("Kaanum Pongalyear (latent)", -5.9981090898266505),
                                    ("Maha Saptamiyear (latent)", -6.403574197934815),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.71042701737487),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.38867117739255),
                                    ("for <duration> from <time>December", -6.403574197934815),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.403574197934815),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.150811229439447),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.150811229439447),
                                    ("Pentecostyear (latent)", -6.403574197934815),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.150811229439447),
                                    ("Eid al-Fitryear (latent)", -5.017279836814924),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.403574197934815),
                                    ("Mondayin|during the <part-of-day>", -6.403574197934815),
                                    ("Chhathin|during <named-month>|year", -6.403574197934815),
                                    ("Diwaliin|during <named-month>|year", -6.403574197934815),
                                    ("this <part-of-day><time-of-day> am|pm", -6.403574197934815),
                                    ("Vaisakhiin|during <named-month>|year", -6.403574197934815),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.150811229439447),
                                    ("Raksha Bandhanyear (latent)", -6.403574197934815),
                                    ("daysecond", -5.9981090898266505),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9981090898266505),
                                    ("Februaryyear (latent)", -6.403574197934815),
                                    ("Ratha-Yatrayear (latent)", -6.403574197934815),
                                    ("Ashurayear (latent)", -6.403574197934815),
                                    ("Tuesdayin|during <named-month>|year", -6.403574197934815),
                                    ("Chinese New Yearyear (latent)", -6.403574197934815),
                                    ("Juneyear (latent)", -5.9981090898266505),
                                    ("Lag BaOmeryear (latent)", -6.403574197934815),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.403574197934815),
                                    ("Eid al-Adhayear (latent)", -4.263508034438544),
                                    ("Palm Sundayyear (latent)", -6.403574197934815),
                                    ("Christmasat <time-of-day>", -6.403574197934815),
                                    ("Passoveryear (latent)", -6.403574197934815),
                                    ("Lazarus Saturdayyear (latent)", -6.403574197934815),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.403574197934815),
                                    ("the last <cycle> of <time>year (latent)", -5.71042701737487),
                                    ("hhhmmon <day>", -5.48728346606066),
                                    ("Yom HaShoahyear (latent)", -5.9981090898266505),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.403574197934815),
                                    ("Septemberyear (latent)", -5.9981090898266505),
                                    ("Decemberyear (latent)", -5.9981090898266505),
                                    ("Halloweenyear (latent)", -6.403574197934815),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.403574197934815),
                                    ("at <time-of-day>intersect", -5.48728346606066),
                                    ("Rosh Hashanahyear (latent)", -5.71042701737487),
                                    ("Dhanterasyear (latent)", -6.403574197934815),
                                    ("Tu BiShvatyear (latent)", -6.403574197934815),
                                    ("Holiyear (latent)", -5.71042701737487),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.403574197934815),
                                    ("Holika Dahanyear (latent)", -5.71042701737487),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.9981090898266505),
                                    ("dayminute", -3.2049010803841336),
                                    ("Mawlidyear (latent)", -6.403574197934815),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.9981090898266505),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.403574197934815),
                                    ("Jumu'atul-Widayear (latent)", -5.48728346606066),
                                    ("minuteday", -2.7022722238223214),
                                    ("absorption of , after named dayintersect", -5.71042701737487),
                                    ("Orthodox Easter Sundayyear (latent)", -6.403574197934815),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.403574197934815),
                                    ("intersecthhhmm", -5.9981090898266505),
                                    ("Mothering Sundayyear (latent)", -5.9981090898266505),
                                    ("Boss's Dayyear (latent)", -5.9981090898266505),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.403574197934815),
                                    ("Global Youth Service Dayyear (latent)", -6.403574197934815),
                                    ("Dhanterasin|during <named-month>|year", -6.403574197934815),
                                    ("tonight<time-of-day> o'clock", -6.403574197934815),
                                    ("Tisha B'Avyear (latent)", -6.403574197934815),
                                    ("Isra and Mi'rajyear (latent)", -5.48728346606066),
                                    ("at <time-of-day>on <day>", -4.794136285500715),
                                    ("<day-of-month> (ordinal or number) of <month>year (latent)",
                                     -5.9981090898266505),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.9981090898266505),
                                    ("Christmasyear (latent)", -5.9981090898266505),
                                    ("Naraka Chaturdashiyear (latent)", -5.9981090898266505),
                                    ("Thai Pongalin|during <named-month>|year", -6.403574197934815),
                                    ("dayweek", -6.403574197934815),
                                    ("Easter Sundayyear (latent)", -5.71042701737487),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.9981090898266505),
                                    ("weekyear", -5.150811229439447),
                                    ("King's Dayyear (latent)", -4.8994968011585405),
                                    ("hh:mmin|during the <part-of-day>", -5.48728346606066),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.9981090898266505),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.71042701737487),
                                    ("Hanukkahyear (latent)", -5.71042701737487),
                                    ("Rama Navamiyear (latent)", -6.403574197934815),
                                    ("February<time> <part-of-day>", -6.403574197934815),
                                    ("Great Lentyear (latent)", -6.403574197934815),
                                    ("tomorrowat <time-of-day>", -5.71042701737487),
                                    ("tomorrow<part-of-day> at <time-of-day>", -5.9981090898266505),
                                    ("Ugadiyear (latent)", -5.017279836814924),
                                    ("Vaisakhiyear (latent)", -5.71042701737487),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.71042701737487),
                                    ("last <cycle> of <time>year (latent)", -5.71042701737487),
                                    ("at <time-of-day>tomorrow", -5.9981090898266505),
                                    ("tomorrow<time-of-day> am|pm", -6.403574197934815),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.403574197934815),
                                    ("Diwaliyear (latent)", -6.403574197934815),
                                    ("between <time> and <time>on <day>", -5.9981090898266505),
                                    ("Black Fridayyear (latent)", -5.9981090898266505),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.403574197934815),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.403574197934815),
                                    ("Chhathyear (latent)", -5.9981090898266505),
                                    ("Vasant Panchamiyear (latent)", -6.403574197934815),
                                    ("Rabindra Jayantiyear (latent)", -5.150811229439447),
                                    ("this <part-of-day>at <time-of-day>", -5.150811229439447),
                                    ("St Patrick's Dayyear (latent)", -6.403574197934815),
                                    ("Thursday<time> (timezone)", -6.403574197934815),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.403574197934815),
                                    ("the <day-of-month> (ordinal or number) of <month>year (latent)",
                                     -5.9981090898266505),
                                    ("Pargat Diwasyear (latent)", -5.150811229439447),
                                    ("August Bank Holidayyear (latent)", -5.71042701737487),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.71042701737487),
                                    ("Simchat Torahyear (latent)", -6.403574197934815),
                                    ("minuteyear", -6.403574197934815)],
                               n = 472},
                   koData =
                     ClassData{prior = -1.1428672976721503, unseen = -6.561030665896573,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.362390660157023),
                                    ("hourday", -4.767855768265187),
                                    ("dayhour", -3.381561407145296),
                                    ("<time> timezoneyear (latent)", -5.173320876373351),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.950177325059141),
                                    ("after <time><time-of-day> am|pm", -5.8664680569332965),
                                    ("daymonth", -3.4241210215640923),
                                    ("monthday", -4.950177325059141),
                                    ("monthyear", -4.6137050884379285),
                                    ("<time-of-day> am|pmyear (latent)", -5.173320876373351),
                                    ("Thai Pongalyear (latent)", -5.173320876373351),
                                    ("intersecthh:mm", -5.8664680569332965),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.461002948825132),
                                    ("houryear", -4.950177325059141),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.8664680569332965),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.173320876373351),
                                    ("<time-of-day> am|pmintersect", -4.6137050884379285),
                                    ("Octoberyear (latent)", -5.8664680569332965),
                                    ("Good Fridayyear (latent)", -5.461002948825132),
                                    ("until <time>on <day>", -5.173320876373351),
                                    ("todayin <number> (implicit minutes)", -5.8664680569332965),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -5.8664680569332965),
                                    ("hh:mmon <day>", -4.6137050884379285),
                                    ("hhhmmintersect", -5.461002948825132),
                                    ("absorption of , after named dayJuly", -4.950177325059141),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.950177325059141),
                                    ("Clean Mondayyear (latent)", -5.8664680569332965),
                                    ("monthhour", -5.8664680569332965),
                                    ("hourmonth", -4.950177325059141),
                                    ("todayat <time-of-day>", -5.8664680569332965),
                                    ("since <time>until <time>", -5.8664680569332965),
                                    ("Bank Holidayyear (latent)", -5.173320876373351),
                                    ("hhhmmyear (latent)", -4.6137050884379285),
                                    ("<time-of-day> am|pmon <day>", -4.6137050884379285),
                                    ("Mondayyear (latent)", -5.173320876373351),
                                    ("dayday", -5.8664680569332965),
                                    ("dd/mmat <time-of-day>", -5.461002948825132),
                                    ("on <day>September", -5.173320876373351),
                                    ("hourhour", -4.6137050884379285),
                                    ("Thursdaydd/mm", -5.8664680569332965),
                                    ("dayyear", -2.8460431707889344),
                                    ("New Year's Dayyear (latent)", -4.950177325059141),
                                    ("Thursdayat <time-of-day>", -4.257030144499196),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.8664680569332965),
                                    ("Aprilyear (latent)", -5.8664680569332965),
                                    ("monthminute", -5.8664680569332965),
                                    ("<time-of-day> am|pmtomorrow", -5.461002948825132),
                                    ("Thursdayhh:mm", -4.950177325059141),
                                    ("minutemonth", -3.787026515253461),
                                    ("Augustyear (latent)", -5.461002948825132),
                                    ("week-endin|during <named-month>|year", -5.8664680569332965),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.8664680569332965),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.461002948825132),
                                    ("Sundayyear (latent)", -4.950177325059141),
                                    ("Christmasat <time-of-day>", -5.8664680569332965),
                                    ("dd/mmyear (latent)", -5.8664680569332965),
                                    ("the last <cycle> of <time>year (latent)", -5.461002948825132),
                                    ("hhhmmon <day>", -4.950177325059141),
                                    ("Julyuntil <time>", -5.461002948825132),
                                    ("yesterday<time-of-day> am|pm", -5.8664680569332965),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.8664680569332965),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.8664680569332965),
                                    ("at <time-of-day>intersect", -4.950177325059141),
                                    ("hh:mmyear (latent)", -4.480173695813406),
                                    ("Holiyear (latent)", -5.8664680569332965),
                                    ("until <time><time-of-day> am|pm", -5.8664680569332965),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.461002948825132),
                                    ("dayminute", -3.227410727318038),
                                    ("yyyy-mm-ddhh:mm", -5.461002948825132),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -5.8664680569332965),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -5.8664680569332965),
                                    ("intersectSeptember", -3.994665880031705),
                                    ("minuteday", -2.7984151217996796),
                                    ("absorption of , after named dayintersect",
                                     -5.8664680569332965),
                                    ("Februaryin|during the <part-of-day>", -5.8664680569332965),
                                    ("<duration> after|before|from|past <time>December",
                                     -5.8664680569332965),
                                    ("Saturdayyear (latent)", -5.8664680569332965),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8664680569332965),
                                    ("at <time-of-day>on <day>", -4.950177325059141),
                                    ("absorption of , after named daySeptember",
                                     -4.6137050884379285),
                                    ("Naraka Chaturdashiyear (latent)", -5.8664680569332965),
                                    ("Easter Sundayyear (latent)", -5.461002948825132),
                                    ("Thursday<time-of-day> am|pm", -4.767855768265187),
                                    ("weekyear", -4.950177325059141),
                                    ("after <time>year (latent)", -5.461002948825132),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.173320876373351),
                                    ("absorption of , after named dayFebruary", -4.950177325059141),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.8664680569332965),
                                    ("tomorrowat <time-of-day>", -5.8664680569332965),
                                    ("Fridayin|during <named-month>|year", -5.8664680569332965),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.461002948825132),
                                    ("last <cycle> of <time>year (latent)", -5.461002948825132),
                                    ("tomorrow<time-of-day> am|pm", -5.8664680569332965),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.461002948825132),
                                    ("Diwaliyear (latent)", -5.461002948825132),
                                    ("this <part-of-day>at <time-of-day>", -4.950177325059141),
                                    ("Fridayyear (latent)", -4.950177325059141),
                                    ("minuteyear", -3.726401893437026)],
                               n = 221}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.12945806723688683,
                               unseen = -5.5254529391317835,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.4292692569044587e-2),
                                    ("intersect 2 numbers", -4.135166556742356)],
                               n = 246},
                   koData =
                     ClassData{prior = -2.108429078553088, unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Father's Day", -2.9704144655697013),
                                    ...
                                    ("Mothering Sunday", -2.9704144655697013),
