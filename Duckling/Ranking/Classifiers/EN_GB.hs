...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.3831860694870643, unseen = -7.091742115095153,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.397762641520038),
                                    ("Father's Dayyear (latent)", -6.397762641520038),
                                    ...
                                    ("hourday", -4.451852492464725),
                                    ("dayhour", -3.564549297463822),
                                    ...
                                    ("daymonth", -5.14499967302467),
                                    ("monthyear", -3.9998673687216675),
                                    ...
                                    ("Thanksgiving Dayyear (latent)", -5.299150352851928),
                                    ...
                                    ("Januaryyear (latent)", -5.9922975334118735),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.9922975334118735),
                                    ("Marchyear (latent)", -5.9922975334118735),
                                    ...
                                    ("dd/mm<time-of-day> am|pm", -6.397762641520038),
                                    ...
                                    ("dd/mmat <time-of-day>", -6.397762641520038),
                                    ...
                                    ("dayyear", -1.7533717423786654),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.397762641520038),
                                    ("<time-of-day> o'clocktomorrow", -5.9922975334118735),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.397762641520038),
                                    ...
                                    ("Aprilyear (latent)", -6.397762641520038),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.704615460960093),
                                    ("hourminute", -6.397762641520038),
                                    ("<time-of-day> am|pmtomorrow", -5.299150352851928),
                                    ("Yom Kippuryear (latent)", -6.397762641520038),
                                    ("<part-of-day> of <time>year (latent)", -6.397762641520038),
                                    ("minutehour", -5.299150352851928),
                                    ...
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.382859620977774),
                                    ("for <duration> from <time>December", -6.397762641520038),
                                    ...
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.397762641520038),
                                    ("Mondayin|during the <part-of-day>", -6.397762641520038),
                                    ...
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.9922975334118735),
                                    ("Februaryyear (latent)", -6.397762641520038),
                                    ...
                                    ("Juneyear (latent)", -5.9922975334118735),
                                    ...
                                    ("Mothering Sundayyear (latent)", -5.9922975334118735),
                                    ...
                                    ("February<time> <part-of-day>", -6.397762641520038),
                                    ...
                                    ("August Bank Holidayyear (latent)", -5.704615460960093),
                               ...
                               n = 469},
                   koData =
                     ClassData{prior = -1.1447171081168428, unseen = -6.553933404025811,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.355283309698371),
                                    ("hourday", -4.760748417806535),
                                    ("dayhour", -3.3744540566866443),
                                    ("<time> timezoneyear (latent)", -5.166213525914699),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.94306997460049),
                                    ("after <time><time-of-day> am|pm", -5.859360706474645),
                                    ("daymonth", -3.4170136711054404),
                                    ("monthday", -4.94306997460049),
                                    ("monthyear", -4.606597737979277),
                                    ("<time-of-day> am|pmyear (latent)", -5.166213525914699),
                                    ("Thai Pongalyear (latent)", -5.166213525914699),
                                    ("intersecthh:mm", -5.859360706474645),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.45389559836648),
                                    ("houryear", -4.94306997460049),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.859360706474645),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.166213525914699),
                                    ("<time-of-day> am|pmintersect", -4.606597737979277),
                                    ("Octoberyear (latent)", -5.859360706474645),
                                    ("Good Fridayyear (latent)", -5.45389559836648),
                                    ("until <time>on <day>", -5.166213525914699),
                                    ("todayin <number> (implicit minutes)", -5.859360706474645),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -5.859360706474645),
                                    ("hh:mmon <day>", -4.606597737979277),
                                    ("hhhmmintersect", -5.45389559836648),
                                    ("absorption of , after named dayJuly", -4.94306997460049),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.94306997460049),
                                    ("Clean Mondayyear (latent)", -5.859360706474645),
                                    ("monthhour", -5.859360706474645),
                                    ("hourmonth", -4.94306997460049),
                                    ("todayat <time-of-day>", -5.859360706474645),
                                    ("since <time>until <time>", -5.859360706474645),
                                    ("Bank Holidayyear (latent)", -5.166213525914699),
                                    ("hhhmmyear (latent)", -4.606597737979277),
                                    ("<time-of-day> am|pmon <day>", -4.606597737979277),
                                    ("Mondayyear (latent)", -5.166213525914699),
                                    ("dayday", -5.859360706474645),
                                    ("dd/mmat <time-of-day>", -5.45389559836648),
                                    ("on <day>September", -5.166213525914699),
                                    ("hourhour", -4.606597737979277),
                                    ("Thursdaydd/mm", -5.859360706474645),
                                    ("dayyear", -2.838935820330282),
                                    ("New Year's Dayyear (latent)", -4.94306997460049),
                                    ("Thursdayat <time-of-day>", -4.249922794040544),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.859360706474645),
                                    ("Aprilyear (latent)", -5.859360706474645),
                                    ("monthminute", -5.859360706474645),
                                    ("<time-of-day> am|pmtomorrow", -5.45389559836648),
                                    ("Thursdayhh:mm", -4.94306997460049),
                                    ("minutemonth", -3.779919164794809),
                                    ("Augustyear (latent)", -5.45389559836648),
                                    ("week-endin|during <named-month>|year", -5.859360706474645),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.859360706474645),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.45389559836648),
                                    ("Sundayyear (latent)", -4.94306997460049),
                                    ("Christmasat <time-of-day>", -5.859360706474645),
                                    ("dd/mmyear (latent)", -5.859360706474645),
                                    ("the last <cycle> of <time>year (latent)", -5.45389559836648),
                                    ("hhhmmon <day>", -4.94306997460049),
                                    ("Julyuntil <time>", -5.45389559836648),
                                    ("yesterday<time-of-day> am|pm", -5.859360706474645),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.859360706474645),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.859360706474645),
                                    ("at <time-of-day>intersect", -4.94306997460049),
                                    ("hh:mmyear (latent)", -4.473066345354754),
                                    ("Holiyear (latent)", -5.859360706474645),
                                    ("until <time><time-of-day> am|pm", -5.859360706474645),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.45389559836648),
                                    ("dayminute", -3.2203033768593863),
                                    ("yyyy-mm-ddhh:mm", -5.45389559836648),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -5.859360706474645),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -5.859360706474645),
                                    ("intersectSeptember", -3.9875585295730533),
                                    ("minuteday", -2.7913077713410277),
                                    ("absorption of , after named dayintersect",
                                     -5.859360706474645),
                                    ("Februaryin|during the <part-of-day>", -5.859360706474645),
                                    ("<duration> after|before|from|past <time>December",
                                     -5.859360706474645),
                                    ("Saturdayyear (latent)", -5.859360706474645),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.859360706474645),
                                    ("at <time-of-day>on <day>", -4.94306997460049),
                                    ("absorption of , after named daySeptember",
                                     -4.606597737979277),
                                    ("Naraka Chaturdashiyear (latent)", -5.859360706474645),
                                    ("Easter Sundayyear (latent)", -5.45389559836648),
                                    ("Thursday<time-of-day> am|pm", -4.760748417806535),
                                    ("weekyear", -5.45389559836648),
                                    ("after <time>year (latent)", -5.45389559836648),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.166213525914699),
                                    ("absorption of , after named dayFebruary", -4.94306997460049),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.859360706474645),
                                    ("tomorrowat <time-of-day>", -5.859360706474645),
                                    ("Fridayin|during <named-month>|year", -5.859360706474645),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.45389559836648),
                                    ("tomorrow<time-of-day> am|pm", -5.859360706474645),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.45389559836648),
                                    ("Diwaliyear (latent)", -5.45389559836648),
                                    ("this <part-of-day>at <time-of-day>", -4.94306997460049),
                                    ("Fridayyear (latent)", -4.94306997460049),
                                    ("minuteyear", -3.719294542978374)],
                               n = 219}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
