...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5936794338692698, unseen = -6.156978985585555,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 470},
                   koData =
                     ClassData{prior = -0.8036127534466732, unseen = -5.948034989180646,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46201492550483225,
                               unseen = -7.150701457592526,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.456769655572163),
                                    ("Father's Dayyear (latent)", -6.456769655572163),
                                    ("Karva Chauthyear (latent)", -6.456769655572163),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.456769655572163),
                                    ("Maha Shivaratriyear (latent)", -6.456769655572163),
                                    ("Ramadanyear (latent)", -5.204006687076795),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.358157366904054),
                                    ("Bhai Doojyear (latent)", -6.456769655572163),
                                    ("hourday", -4.441866635029898),
                                    ("dayhour", -3.5389989234878843),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.358157366904054),
                                    ("Martin Luther King's Dayyear (latent)", -6.0513045474639995),
                                    ("Shemini Atzeretyear (latent)", -6.456769655572163),
                                    ("daymonth", -4.665010186344109),
                                    ("monthyear", -4.665010186344109),
                                    ("Yom Ha'atzmautyear (latent)", -6.456769655572163),
                                    ("Vijayadashamiyear (latent)", -6.456769655572163),
                                    ("Thanksgiving Dayyear (latent)", -5.358157366904054),
                                    ("Thai Pongalyear (latent)", -5.763622475012218),
                                    ("Thiru Onamyear (latent)", -5.763622475012218),
                                    ("hhhmmabsorption of , after named day", -6.456769655572163),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.540478923698008),
                                    ("<day-of-month> (ordinal)Wednesday", -6.456769655572163),
                                    ("Krishna Janmashtamiyear (latent)", -6.0513045474639995),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.456769655572163),
                                    ("houryear", -5.540478923698008),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.456769655572163),
                                    ("Christmas<time-of-day> am|pm", -6.456769655572163),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.456769655572163),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.763622475012218),
                                    ("intersectin|during <named-month>|year", -6.456769655572163),
                                    ("<time-of-day> am|pmintersect", -5.204006687076795),
                                    ("Earth Houryear (latent)", -6.456769655572163),
                                    ("Ganesh Chaturthiyear (latent)", -6.456769655572163),
                                    ("Octoberyear (latent)", -4.9526922587958895),
                                    ("intersect<time-of-day> am|pm", -6.456769655572163),
                                    ("Mattu Pongalyear (latent)", -6.456769655572163),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.456769655572163),
                                    ("Shavuotyear (latent)", -6.456769655572163),
                                    ("Parsi New Yearyear (latent)", -5.540478923698008),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.456769655572163),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.456769655572163),
                                    ("todayin|within|after <duration>", -6.456769655572163),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.0513045474639995),
                                    ("Marchyear (latent)", -6.456769655572163),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0513045474639995),
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.456769655572163),
                                    ("Sukkotyear (latent)", -6.0513045474639995),
                                    ("hhhmmintersect", -6.0513045474639995),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0513045474639995),
                                    ("Clean Mondayyear (latent)", -6.0513045474639995),
                                    ("monthhour", -6.0513045474639995),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.763622475012218),
                                    ("todayat <time-of-day>", -6.456769655572163),
                                    ("Thursday<time> timezone", -4.0588743827737925),
                                    ("tonight<time-of-day> am|pm", -6.456769655572163),
                                    ("time-of-day (latent)tonight", -6.0513045474639995),
                                    ("dd/mm<time-of-day> am|pm", -6.456769655572163),
                                    ("<time-of-day> am|pmon <day>", -4.441866635029898),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.456769655572163),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0513045474639995),
                                    ("dayday", -3.7826210061456345),
                                    ("dd/mmat <time-of-day>", -6.456769655572163),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0513045474639995),
                                    ("tonightat <time-of-day>", -5.358157366904054),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.763622475012218),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.456769655572163),
                                    ("today<time-of-day> am|pm", -6.456769655572163),
                                    ("at <time-of-day><time> <part-of-day>", -6.456769655572163),
                                    ("<day-of-month> (ordinal)intersect", -6.0513045474639995),
                                    ("hourhour", -3.4863551900024623),
                                    ("Mahavir Jayantiyear (latent)", -6.0513045474639995),
                                    ("Navaratriin|during <named-month>|year", -6.456769655572163),
                                    ("Wednesdaythis|last|next <cycle>", -6.456769655572163),
                                    ("Lentyear (latent)", -6.456769655572163),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.584967478670572),
                                    ("Boghiyear (latent)", -6.456769655572163),
                                    ("dayyear", -1.8566120114076163),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.456769655572163),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.456769655572163),
                                    ("Thursdayat <time-of-day>", -5.763622475012218),
                                    ("Islamic New Yearyear (latent)", -6.0513045474639995),
                                    ("Laylat al-Qadryear (latent)", -5.540478923698008),
                                    ("part of days<time-of-day> am|pm", -6.456769655572163),
                                    ("Shrove Tuesdayyear (latent)", -6.456769655572163),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.763622475012218),
                                    ("hourminute", -6.0513045474639995),
                                    ("<time-of-day> am|pmtomorrow", -5.763622475012218),
                                    ("Yom Kippuryear (latent)", -6.456769655572163),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0513045474639995),
                                    ("<part-of-day> of <time>year (latent)", -6.456769655572163),
                                    ("minutehour", -5.204006687076795),
                                    ("Kaanum Pongalyear (latent)", -6.0513045474639995),
                                    ("Maha Saptamiyear (latent)", -6.456769655572163),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.763622475012218),
                                    ("time-of-day (latent)tomorrow", -5.540478923698008),
                                    ("part of daysat <time-of-day>", -4.847331743138063),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.441866635029898),
                                    ("for <duration> from <time>December", -6.456769655572163),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.456769655572163),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.204006687076795),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.204006687076795),
                                    ("time-of-day (latent)this <part-of-day>", -6.456769655572163),
                                    ("Pentecostyear (latent)", -6.456769655572163),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.204006687076795),
                                    ("<day-of-month> (ordinal)February", -6.456769655572163),
                                    ("Eid al-Fitryear (latent)", -5.070475294452272),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.456769655572163),
                                    ("Mondayin|during the <part-of-day>", -6.456769655572163),
                                    ("Chhathin|during <named-month>|year", -6.456769655572163),
                                    ("Diwaliin|during <named-month>|year", -6.456769655572163),
                                    ("this <part-of-day><time-of-day> am|pm", -6.456769655572163),
                                    ("Vaisakhiin|during <named-month>|year", -6.456769655572163),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.204006687076795),
                                    ("Raksha Bandhanyear (latent)", -6.456769655572163),
                                    ("daysecond", -6.0513045474639995),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0513045474639995),
                                    ("Ratha-Yatrayear (latent)", -6.456769655572163),
                                    ("Ashurayear (latent)", -6.456769655572163),
                                    ("Tuesdayin|during <named-month>|year", -6.456769655572163),
                                    ("Chinese New Yearyear (latent)", -6.456769655572163),
                                    ("tomorrowintersect", -6.456769655572163),
                                    ("Lag BaOmeryear (latent)", -6.456769655572163),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.456769655572163),
                                    ("Eid al-Adhayear (latent)", -4.316703492075892),
                                    ("Palm Sundayyear (latent)", -6.456769655572163),
                                    ("Christmasat <time-of-day>", -6.456769655572163),
                                    ("Passoveryear (latent)", -6.456769655572163),
                                    ("Lazarus Saturdayyear (latent)", -6.456769655572163),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.456769655572163),
                                    ("the last <cycle> of <time>year (latent)", -5.763622475012218),
                                    ("hhhmmon <day>", -5.540478923698008),
                                    ("Yom HaShoahyear (latent)", -6.0513045474639995),
                                    ("Septemberyear (latent)", -6.0513045474639995),
                                    ("Halloweenyear (latent)", -6.456769655572163),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.456769655572163),
                                    ("at <time-of-day>intersect", -5.540478923698008),
                                    ("Rosh Hashanahyear (latent)", -5.763622475012218),
                                    ("Dhanterasyear (latent)", -6.456769655572163),
                                    ("Tu BiShvatyear (latent)", -6.456769655572163),
                                    ("<day-of-month> (ordinal)December", -5.763622475012218),
                                    ("Holiyear (latent)", -5.763622475012218),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.456769655572163),
                                    ("Holika Dahanyear (latent)", -5.763622475012218),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0513045474639995),
                                    ("dayminute", -3.258096538021482),
                                    ("Mawlidyear (latent)", -6.456769655572163),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0513045474639995),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.456769655572163),
                                    ("Jumu'atul-Widayear (latent)", -5.540478923698008),
                                    ("minuteday", -2.767890201458227),
                                    ("absorption of , after named dayintersect",
                                     -5.763622475012218),
                                    ("intersectyear (latent)", -6.456769655572163),
                                    ("Orthodox Easter Sundayyear (latent)", -6.456769655572163),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.456769655572163),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.456769655572163),
                                    ("intersecthhhmm", -6.0513045474639995),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.456769655572163),
                                    ("Mothering Sundayyear (latent)", -6.0513045474639995),
                                    ("Boss's Dayyear (latent)", -6.0513045474639995),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.456769655572163),
                                    ("Global Youth Service Dayyear (latent)", -6.456769655572163),
                                    ("Dhanterasin|during <named-month>|year", -6.456769655572163),
                                    ("tonight<time-of-day> o'clock", -6.456769655572163),
                                    ("Tisha B'Avyear (latent)", -6.456769655572163),
                                    ("Isra and Mi'rajyear (latent)", -5.540478923698008),
                                    ("at <time-of-day>on <day>", -4.847331743138063),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0513045474639995),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.763622475012218),
                                    ("Christmasyear (latent)", -6.0513045474639995),
                                    ("Saturdayintersect", -6.456769655572163),
                                    ("Naraka Chaturdashiyear (latent)", -6.0513045474639995),
                                    ("Thai Pongalin|during <named-month>|year", -6.456769655572163),
                                    ("dayweek", -6.456769655572163),
                                    ("Easter Sundayyear (latent)", -5.763622475012218),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0513045474639995),
                                    ("weekyear", -5.204006687076795),
                                    ("King's Dayyear (latent)", -4.9526922587958895),
                                    ("hh:mmin|during the <part-of-day>", -5.540478923698008),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0513045474639995),
                                    ("Hanukkahyear (latent)", -5.763622475012218),
                                    ("Rama Navamiyear (latent)", -6.456769655572163),
                                    ("February<time> <part-of-day>", -6.456769655572163),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.763622475012218),
                                    ("Great Lentyear (latent)", -6.456769655572163),
                                    ("tomorrowat <time-of-day>", -5.763622475012218),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.456769655572163),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.0513045474639995),
                                    ("Ugadiyear (latent)", -5.070475294452272),
                                    ("Vaisakhiyear (latent)", -5.763622475012218),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.763622475012218),
                                    ("last <cycle> of <time>year (latent)", -5.763622475012218),
                                    ("at <time-of-day>tomorrow", -6.0513045474639995),
                                    ("tomorrow<time-of-day> am|pm", -6.456769655572163),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.456769655572163),
                                    ("Diwaliyear (latent)", -6.456769655572163),
                                    ("between <time> and <time>on <day>", -6.0513045474639995),
                                    ("Black Fridayyear (latent)", -6.0513045474639995),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.456769655572163),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.456769655572163),
                                    ("Chhathyear (latent)", -6.0513045474639995),
                                    ("Vasant Panchamiyear (latent)", -6.456769655572163),
                                    ("Rabindra Jayantiyear (latent)", -5.204006687076795),
                                    ("this <part-of-day>at <time-of-day>", -5.204006687076795),
                                    ("St Patrick's Dayyear (latent)", -6.456769655572163),
                                    ("Thursday<time> (timezone)", -6.456769655572163),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.456769655572163),
                                    ("Pargat Diwasyear (latent)", -5.204006687076795),
                                    ("August Bank Holidayyear (latent)", -5.763622475012218),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.763622475012218),
                                    ("Februaryintersect", -6.456769655572163),
                                    ("Simchat Torahyear (latent)", -6.456769655572163),
                                    ("minuteyear", -6.456769655572163)],
                               n = 487},
                   koData =
                     ClassData{prior = -0.9942872377675694, unseen = -6.771935555839602,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.5735648465727605),
                                    ("time-of-day (latent)<time-of-day> - <time-of-day> (interval)",
                                     -5.67217713524087),
                                    ("hourday", -3.592735593561034),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.077642243349034),
                                    ("<day-of-month> (ordinal)August", -6.077642243349034),
                                    ("dayhour", -3.592735593561034),
                                    ("<time> timezoneyear (latent)", -5.384495062789089),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.161351511474879),
                                    ("after <time><time-of-day> am|pm", -6.077642243349034),
                                    ("daymonth", -3.369592042246824),
                                    ("hourquarter", -6.077642243349034),
                                    ("monthday", -5.161351511474879),
                                    ("monthyear", -4.979029954680924),
                                    ("<time-of-day> am|pmyear (latent)", -5.384495062789089),
                                    ("time-of-day (latent)qq", -6.077642243349034),
                                    ("Thai Pongalyear (latent)", -5.384495062789089),
                                    ("intersecthh:mm", -6.077642243349034),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.67217713524087),
                                    ("<day-of-month> (ordinal)Wednesday", -6.077642243349034),
                                    ("houryear", -4.824879274853666),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.077642243349034),
                                    ("Julyintersect", -5.384495062789089),
                                    ("<day-of-month> (ordinal)October", -6.077642243349034),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.384495062789089),
                                    ("<time-of-day> am|pmintersect", -4.824879274853666),
                                    ("time-of-day (latent)until <time>", -5.67217713524087),
                                    ("Octoberyear (latent)", -6.077642243349034),
                                    ("early morningat <time-of-day>", -6.077642243349034),
                                    ("until <time>on <day>", -5.384495062789089),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.077642243349034),
                                    ("time-of-day (latent)intersect", -6.077642243349034),
                                    ("todayin <number> (implicit minutes)", -6.077642243349034),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.077642243349034),
                                    ("hh:mmon <day>", -4.824879274853666),
                                    ("hhhmmintersect", -5.67217713524087),
                                    ("absorption of , after named dayJuly", -5.161351511474879),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.161351511474879),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.67217713524087),
                                    ("hourmonth", -4.2058400664474425),
                                    ("todayat <time-of-day>", -6.077642243349034),
                                    ("since <time>until <time>", -6.077642243349034),
                                    ("Bank Holidayyear (latent)", -5.384495062789089),
                                    ("hhhmmyear (latent)", -4.824879274853666),
                                    ("<time-of-day> am|pmon <day>", -4.824879274853666),
                                    ("Mondayyear (latent)", -5.384495062789089),
                                    ("dayday", -4.131732094293721),
                                    ("dd/mmat <time-of-day>", -5.67217713524087),
                                    ("on <day>September", -5.384495062789089),
                                    ("since <time>intersect", -5.384495062789089),
                                    ("time-of-day (latent)September", -5.67217713524087),
                                    ("hourhour", -3.826350444742539),
                                    ("time-of-day (latent)on <day>", -4.5735648465727605),
                                    ("Thursdaydd/mm", -6.077642243349034),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.67217713524087),
                                    ("dayyear", -3.1598715112647553),
                                    ("New Year's Dayyear (latent)", -5.161351511474879),
                                    ("time-of-day (latent)Sunday", -5.67217713524087),
                                    ("Thursdayat <time-of-day>", -4.468204330914934),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.077642243349034),
                                    ("Aprilyear (latent)", -6.077642243349034),
                                    ("the <day-of-month> (ordinal)July", -6.077642243349034),
                                    ("the <day-of-month> (number)July", -6.077642243349034),
                                    ("monthminute", -6.077642243349034),
                                    ("hourminute", -5.384495062789089),
                                    ("<time-of-day> am|pmtomorrow", -6.077642243349034),
                                    ("Thursdayhh:mm", -5.161351511474879),
                                    ("<day-of-month> (ordinal)Tuesday", -5.67217713524087),
                                    ("minutemonth", -3.9982007016691985),
                                    ("time-of-day (latent)Friday", -5.67217713524087),
                                    ("minutehour", -6.077642243349034),
                                    ("part of daysat <time-of-day>", -4.979029954680924),
                                    ("Augustyear (latent)", -5.67217713524087),
                                    ("week-endin|during <named-month>|year", -6.077642243349034),
                                    ("time-of-day (latent)Tuesday", -5.67217713524087),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.077642243349034),
                                    ...
                                    ("dd/mm<time-of-day> - <time-of-day> (interval)",
                                     -5.67217713524087),
                                    ("Sundayyear (latent)", -5.161351511474879),
                                    ("the <day-of-month> (ordinal)Monday", -5.384495062789089),
                                    ("Christmasat <time-of-day>", -6.077642243349034),
                                    ("dd/mmyear (latent)", -6.077642243349034),
                                    ("the last <cycle> of <time>year (latent)", -5.67217713524087),
                                    ("hhhmmon <day>", -5.161351511474879),
                                    ("Julyuntil <time>", -5.67217713524087),
                                    ("yesterday<time-of-day> am|pm", -6.077642243349034),
                                    ("<day-of-month> (ordinal)July", -5.384495062789089),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.077642243349034),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.077642243349034),
                                    ("at <time-of-day>intersect", -5.161351511474879),
                                    ("hh:mmyear (latent)", -4.6913478822291435),
                                    ("Holiyear (latent)", -6.077642243349034),
                                    ("until <time><time-of-day> am|pm", -6.077642243349034),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.67217713524087),
                                    ("dayminute", -3.438584913733776),
                                    ("yyyy-mm-ddhh:mm", -5.67217713524087),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.077642243349034),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -6.077642243349034),
                                    ("intersectSeptember", -4.2058400664474425),
                                    ("minuteday", -3.0095893082154173),
                                    ("absorption of , after named dayintersect",
                                     -6.077642243349034),
                                    ("intersectyear (latent)", -6.077642243349034),
                                    ("Februaryin|during the <part-of-day>", -6.077642243349034),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.077642243349034),
                                    ("time-of-day (latent)July", -5.384495062789089),
                                    ("Saturdayyear (latent)", -6.077642243349034),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.077642243349034),
                                    ("<day-of-month> (ordinal)Monday", -5.161351511474879),
                                    ("at <time-of-day>on <day>", -5.161351511474879),
                                    ("time-of-day (latent)<time-of-day> am|pm", -6.077642243349034),
                                    ("absorption of , after named daySeptember",
                                     -4.824879274853666),
                                    ("Naraka Chaturdashiyear (latent)", -6.077642243349034),
                                    ("Easter Sundayyear (latent)", -5.67217713524087),
                                    ("time-of-day (latent)at <time-of-day>", -5.384495062789089),
                                    ("Thursday<time-of-day> am|pm", -4.979029954680924),
                                    ("weekyear", -5.161351511474879),
                                    ("after <time>year (latent)", -6.077642243349034),
                                    ("time-of-day (latent)Thursday", -5.67217713524087),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.67217713524087),
                                    ("<day-of-month> (ordinal)April", -6.077642243349034),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.67217713524087),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.384495062789089),
                                    ("absorption of , after named dayFebruary", -5.161351511474879),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.67217713524087),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.077642243349034),
                                    ("tomorrowat <time-of-day>", -6.077642243349034),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.67217713524087),
                                    ("last <cycle> of <time>year (latent)", -5.67217713524087),
                                    ("tomorrow<time-of-day> am|pm", -6.077642243349034),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.67217713524087),
                                    ("Diwaliyear (latent)", -5.67217713524087),
                                    ("this <part-of-day>at <time-of-day>", -5.161351511474879),
                                    ("Fridayyear (latent)", -5.67217713524087),
                                    ("time-of-day (latent)<named-month> <day-of-month> (non ordinal)",
                                     -6.077642243349034),
                                    ("time-of-day (latent)April", -6.077642243349034),
                                    ("minuteyear", -3.9375760798527635)],
                               n = 286}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.150282203049338, unseen = -5.424950017481403,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 222},
                   koData =
                     ClassData{prior = -1.9694406464655074, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6039160468320027, unseen = -4.836281906951478,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 123},
                   koData =
                     ClassData{prior = -0.7911275889201491, unseen = -4.653960350157523,
                               likelihoods =
                                 HashMap.fromList
