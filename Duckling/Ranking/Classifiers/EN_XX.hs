...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5511446346683346, unseen = -6.267200548541362,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 525},
                   koData =
                     ClassData{prior = -0.8587055277951275, unseen = -5.961005339623274,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.3852332041365794, unseen = -7.083387847625295,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.3894013887953545),
                                    ("Karva Chauthyear (latent)", -6.3894013887953545),
                                    ("Maha Shivaratriyear (latent)", -6.3894013887953545),
                                    ("Ramadanyear (latent)", -5.136638420299986),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.290789100127245),
                                    ("Bhai Doojyear (latent)", -6.3894013887953545),
                                    ("hourday", -4.443491239740042),
                                    ("dayhour", -3.5561880447391387),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.290789100127245),
                                    ("Martin Luther King's Dayyear (latent)", -5.983936280687191),
                                    ("Shemini Atzeretyear (latent)", -6.3894013887953545),
                                    ("daymonth", -5.136638420299986),
                                    ("monthyear", -3.9915061159969842),
                                    ("Yom Ha'atzmautyear (latent)", -6.3894013887953545),
                                    ("Orthodox Good Fridayyear (latent)", -5.983936280687191),
                                    ("Vijayadashamiyear (latent)", -6.3894013887953545),
                                    ("Thanksgiving Dayyear (latent)", -5.290789100127245),
                                    ("Thai Pongalyear (latent)", -5.69625420823541),
                                    ("Thiru Onamyear (latent)", -5.69625420823541),
                                    ("hhhmmabsorption of , after named day", -6.3894013887953545),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.473110656921199),
                                    ("Krishna Janmashtamiyear (latent)", -5.983936280687191),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.3894013887953545),
                                    ("houryear", -5.69625420823541),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.3894013887953545),
                                    ("Christmas<time-of-day> am|pm", -6.3894013887953545),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.3894013887953545),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69625420823541),
                                    ("<time-of-day> am|pmintersect", -5.136638420299986),
                                    ("Earth Houryear (latent)", -6.3894013887953545),
                                    ("Ganesh Chaturthiyear (latent)", -6.3894013887953545),
                                    ("Octoberyear (latent)", -4.885323992019081),
                                    ("intersect<time-of-day> am|pm", -6.3894013887953545),
                                    ("Mattu Pongalyear (latent)", -6.3894013887953545),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.3894013887953545),
                                    ("Januaryyear (latent)", -5.983936280687191),
                                    ("Shavuotyear (latent)", -6.3894013887953545),
                                    ("Parsi New Yearyear (latent)", -5.473110656921199),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.3894013887953545),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.3894013887953545),
                                    ("todayin|within|after <duration>", -6.3894013887953545),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.3894013887953545),
                                    ("Sukkotyear (latent)", -5.983936280687191),
                                    ("hhhmmintersect", -5.983936280687191),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.3894013887953545),
                                    ("since <time>year (latent)", -6.3894013887953545),
                                    ("<time-of-day> o'clock<time> <part-of-day>",
                                     -5.983936280687191),
                                    ("Clean Mondayyear (latent)", -5.983936280687191),
                                    ("monthhour", -6.3894013887953545),
                                    ("todayat <time-of-day>", -6.3894013887953545),
                                    ("Thursday<time> timezone", -3.9915061159969842),
                                    ("tonight<time-of-day> am|pm", -6.3894013887953545),
                                    ("<time-of-day> am|pmon <day>", -4.37449836825309),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.3894013887953545),
                                    ("yyyy-mm-ddhh:mm:ss", -5.983936280687191),
                                    ("dayday", -4.038026131631877),
                                    ("<time> <part-of-day>at <time-of-day>", -5.983936280687191),
                                    ("mm/ddat <time-of-day>", -5.69625420823541),
                                    ("tonightat <time-of-day>", -5.290789100127245),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.69625420823541),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.3894013887953545),
                                    ("today<time-of-day> am|pm", -6.3894013887953545),
                                    ("at <time-of-day><time> <part-of-day>", -6.3894013887953545),
                                    ("mm/dd<time-of-day> am|pm", -6.3894013887953545),
                                    ("hourhour", -3.9470543534261506),
                                    ("Mahavir Jayantiyear (latent)", -5.983936280687191),
                                    ("Navaratriin|during <named-month>|year", -6.3894013887953545),
                                    ("Wednesdaythis|last|next <cycle>", -6.3894013887953545),
                                    ("Lentyear (latent)", -6.3894013887953545),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.517599211893764),
                                    ("Boghiyear (latent)", -6.3894013887953545),
                                    ("dayyear", -1.7693425903135127),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.3894013887953545),
                                    ("<time-of-day> o'clocktomorrow", -5.983936280687191),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.3894013887953545),
                                    ("Thursdayat <time-of-day>", -5.69625420823541),
                                    ("Islamic New Yearyear (latent)", -5.983936280687191),
                                    ("Laylat al-Qadryear (latent)", -5.473110656921199),
                                    ("Aprilyear (latent)", -6.3894013887953545),
                                    ("<day-of-month> (ordinal or number) of <named-month>year (latent)",
                                     -5.983936280687191),
                                    ("Shrove Tuesdayyear (latent)", -6.3894013887953545),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.69625420823541),
                                    ("hourminute", -6.3894013887953545),
                                    ("<time-of-day> am|pmtomorrow", -5.290789100127245),
                                    ("Yom Kippuryear (latent)", -6.3894013887953545),
                                    ("<part-of-day> of <time>year (latent)", -6.3894013887953545),
                                    ("minutehour", -5.290789100127245),
                                    ("Kaanum Pongalyear (latent)", -5.983936280687191),
                                    ("Maha Saptamiyear (latent)", -6.3894013887953545),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.69625420823541),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.37449836825309),
                                    ("for <duration> from <time>December", -6.3894013887953545),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.3894013887953545),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.136638420299986),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.136638420299986),
                                    ("Pentecostyear (latent)", -6.3894013887953545),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.136638420299986),
                                    ("Eid al-Fitryear (latent)", -5.003107027675465),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.3894013887953545),
                                    ("Mondayin|during the <part-of-day>", -6.3894013887953545),
                                    ("Chhathin|during <named-month>|year", -6.3894013887953545),
                                    ("Diwaliin|during <named-month>|year", -6.3894013887953545),
                                    ("this <part-of-day><time-of-day> am|pm", -6.3894013887953545),
                                    ("Vaisakhiin|during <named-month>|year", -6.3894013887953545),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.136638420299986),
                                    ("Raksha Bandhanyear (latent)", -6.3894013887953545),
                                    ("daysecond", -5.983936280687191),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.983936280687191),
                                    ("Februaryyear (latent)", -6.3894013887953545),
                                    ("Ratha-Yatrayear (latent)", -6.3894013887953545),
                                    ("Ashurayear (latent)", -6.3894013887953545),
                                    ("Tuesdayin|during <named-month>|year", -6.3894013887953545),
                                    ("Chinese New Yearyear (latent)", -6.3894013887953545),
                                    ("Juneyear (latent)", -5.983936280687191),
                                    ("Lag BaOmeryear (latent)", -6.3894013887953545),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.3894013887953545),
                                    ("Eid al-Adhayear (latent)", -4.249335225299084),
                                    ("Palm Sundayyear (latent)", -6.3894013887953545),
                                    ("Christmasat <time-of-day>", -6.3894013887953545),
                                    ("Passoveryear (latent)", -6.3894013887953545),
                                    ("Lazarus Saturdayyear (latent)", -6.3894013887953545),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -5.983936280687191),
                                    ("the last <cycle> of <time>year (latent)", -5.69625420823541),
                                    ("hhhmmon <day>", -5.473110656921199),
                                    ("Yom HaShoahyear (latent)", -5.983936280687191),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.3894013887953545),
                                    ("Septemberyear (latent)", -5.983936280687191),
                                    ("Decemberyear (latent)", -5.983936280687191),
                                    ("Halloweenyear (latent)", -6.3894013887953545),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.3894013887953545),
                                    ("at <time-of-day>intersect", -5.473110656921199),
                                    ("Rosh Hashanahyear (latent)", -5.69625420823541),
                                    ("Dhanterasyear (latent)", -6.3894013887953545),
                                    ("Tu BiShvatyear (latent)", -6.3894013887953545),
                                    ("Holiyear (latent)", -5.69625420823541),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.3894013887953545),
                                    ("Holika Dahanyear (latent)", -5.69625420823541),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.983936280687191),
                                    ("dayminute", -3.150722936630974),
                                    ("Mawlidyear (latent)", -6.3894013887953545),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -5.983936280687191),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.3894013887953545),
                                    ("Jumu'atul-Widayear (latent)", -5.473110656921199),
                                    ("minuteday", -2.688099414682861),
                                    ("absorption of , after named dayintersect", -5.69625420823541),
                                    ("Orthodox Easter Sundayyear (latent)", -6.3894013887953545),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.3894013887953545),
                                    ("intersecthhhmm", -5.983936280687191),
                                    ("Boss's Dayyear (latent)", -5.983936280687191),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.3894013887953545),
                                    ("Global Youth Service Dayyear (latent)", -6.3894013887953545),
                                    ("Dhanterasin|during <named-month>|year", -6.3894013887953545),
                                    ("tonight<time-of-day> o'clock", -6.3894013887953545),
                                    ("Tisha B'Avyear (latent)", -6.3894013887953545),
                                    ("Isra and Mi'rajyear (latent)", -5.473110656921199),
                                    ("at <time-of-day>on <day>", -4.779963476361255),
                                    ("<day-of-month> (ordinal or number) of <month>year (latent)",
                                     -5.983936280687191),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.983936280687191),
                                    ("Christmasyear (latent)", -5.983936280687191),
                                    ("Naraka Chaturdashiyear (latent)", -5.983936280687191),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.3894013887953545),
                                    ("dayweek", -6.3894013887953545),
                                    ("Easter Sundayyear (latent)", -5.69625420823541),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -5.983936280687191),
                                    ("weekyear", -5.290789100127245),
                                    ("King's Dayyear (latent)", -4.885323992019081),
                                    ("hh:mmin|during the <part-of-day>", -5.473110656921199),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.983936280687191),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.69625420823541),
                                    ("Hanukkahyear (latent)", -5.69625420823541),
                                    ("Rama Navamiyear (latent)", -6.3894013887953545),
                                    ("February<time> <part-of-day>", -6.3894013887953545),
                                    ("Great Lentyear (latent)", -6.3894013887953545),
                                    ("tomorrowat <time-of-day>", -5.69625420823541),
                                    ("tomorrow<part-of-day> at <time-of-day>", -5.983936280687191),
                                    ("Ugadiyear (latent)", -5.003107027675465),
                                    ("Vaisakhiyear (latent)", -5.69625420823541),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.69625420823541),
                                    ("at <time-of-day>tomorrow", -5.983936280687191),
                                    ("tomorrow<time-of-day> am|pm", -6.3894013887953545),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.3894013887953545),
                                    ("Diwaliyear (latent)", -6.3894013887953545),
                                    ("between <time> and <time>on <day>", -5.983936280687191),
                                    ("Black Fridayyear (latent)", -5.983936280687191),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.3894013887953545),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.3894013887953545),
                                    ("Chhathyear (latent)", -5.983936280687191),
                                    ("Vasant Panchamiyear (latent)", -6.3894013887953545),
                                    ("Rabindra Jayantiyear (latent)", -5.136638420299986),
                                    ("this <part-of-day>at <time-of-day>", -5.136638420299986),
                                    ("St Patrick's Dayyear (latent)", -6.3894013887953545),
                                    ("Thursday<time> (timezone)", -6.3894013887953545),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.3894013887953545),
                                    ("the <day-of-month> (ordinal or number) of <month>year (latent)",
                                     -5.983936280687191),
                                    ("Pargat Diwasyear (latent)", -5.136638420299986),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.69625420823541),
                                    ("Simchat Torahyear (latent)", -6.3894013887953545),
                                    ("minuteyear", -6.3894013887953545)],
                               n = 466},
                   koData =
                     ClassData{prior = -1.1403471084457244, unseen = -6.548219102762372,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.349560833424304),
                                    ("hourday", -4.755025941532469),
                                    ("dayhour", -3.288688872739042),
                                    ("<time> timezoneyear (latent)", -5.160491049640633),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.937347498326424),
                                    ("after <time><time-of-day> am|pm", -5.853638230200579),
                                    ("daymonth", -3.4112911948313744),
                                    ("monthday", -4.937347498326424),
                                    ("monthyear", -4.467343869080688),
                                    ("<time-of-day> am|pmyear (latent)", -5.160491049640633),
                                    ("Thai Pongalyear (latent)", -5.160491049640633),
                                    ("intersecthh:mm", -5.853638230200579),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.448173122092414),
                                    ("houryear", -4.937347498326424),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.853638230200579),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.160491049640633),
                                    ("<time-of-day> am|pmintersect", -4.600875261705211),
                                    ("Octoberyear (latent)", -5.448173122092414),
                                    ("Good Fridayyear (latent)", -5.448173122092414),
                                    ("until <time>on <day>", -5.160491049640633),
                                    ("todayin <number> (implicit minutes)", -5.853638230200579),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -5.853638230200579),
                                    ("hh:mmon <day>", -4.600875261705211),
                                    ("hhhmmintersect", -5.448173122092414),
                                    ("absorption of , after named dayJuly", -4.937347498326424),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.937347498326424),
                                    ("Clean Mondayyear (latent)", -5.853638230200579),
                                    ("monthhour", -5.853638230200579),
                                    ("hourmonth", -4.937347498326424),
                                    ("todayat <time-of-day>", -5.853638230200579),
                                    ("since <time>until <time>", -5.853638230200579),
                                    ("hhhmmyear (latent)", -4.600875261705211),
                                    ("<time-of-day> am|pmon <day>", -4.600875261705211),
                                    ("Mondayyear (latent)", -5.160491049640633),
                                    ("dayday", -5.853638230200579),
                                    ("mm/ddat <time-of-day>", -4.937347498326424),
                                    ("on <day>September", -5.160491049640633),
                                    ("hourhour", -4.600875261705211),
                                    ("dayyear", -2.909199251034138),
                                    ("Thursdaymm/dd", -5.853638230200579),
                                    ("New Year's Dayyear (latent)", -4.937347498326424),
                                    ("Thursdayat <time-of-day>", -4.244200317766478),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.853638230200579),
                                    ("Aprilyear (latent)", -5.853638230200579),
                                    ("monthminute", -5.853638230200579),
                                    ("<time-of-day> am|pmtomorrow", -5.448173122092414),
                                    ("Thursdayhh:mm", -4.937347498326424),
                                    ("minutemonth", -3.7741966885207425),
                                    ("Augustyear (latent)", -5.448173122092414),
                                    ("week-endin|during <named-month>|year", -5.853638230200579),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -5.853638230200579),
                                    ("Sundayyear (latent)", -4.937347498326424),
                                    ("Christmasat <time-of-day>", -5.853638230200579),
                                    ("the last <cycle> of <time>year (latent)", -5.448173122092414),
                                    ("hhhmmon <day>", -4.937347498326424),
                                    ("Julyuntil <time>", -5.448173122092414),
                                    ("yesterday<time-of-day> am|pm", -5.853638230200579),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.853638230200579),
                                    ("mm/ddyear (latent)", -5.853638230200579),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.853638230200579),
                                    ("at <time-of-day>intersect", -4.937347498326424),
                                    ("hh:mmyear (latent)", -4.467343869080688),
                                    ("Holiyear (latent)", -5.853638230200579),
                                    ("until <time><time-of-day> am|pm", -5.853638230200579),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.448173122092414),
                                    ("dayminute", -3.21458090058532),
                                    ("yyyy-mm-ddhh:mm", -5.448173122092414),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -5.853638230200579),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -5.853638230200579),
                                    ("intersectSeptember", -3.9818360532989874),
                                    ("minuteday", -2.7855852950669613),
                                    ("absorption of , after named dayintersect",
                                     -5.853638230200579),
                                    ("Februaryin|during the <part-of-day>", -5.853638230200579),
                                    ("<duration> after|before|from|past <time>December",
                                     -5.853638230200579),
                                    ("Saturdayyear (latent)", -5.853638230200579),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.853638230200579),
                                    ("at <time-of-day>on <day>", -4.937347498326424),
                                    ("absorption of , after named daySeptember",
                                     -4.600875261705211),
                                    ("Naraka Chaturdashiyear (latent)", -5.853638230200579),
                                    ("Easter Sundayyear (latent)", -5.448173122092414),
                                    ("Thursday<time-of-day> am|pm", -4.755025941532469),
                                    ("weekyear", -5.448173122092414),
                                    ("after <time>year (latent)", -5.448173122092414),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.160491049640633),
                                    ("absorption of , after named dayFebruary", -4.937347498326424),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.853638230200579),
                                    ("tomorrowat <time-of-day>", -5.853638230200579),
                                    ("Fridayin|during <named-month>|year", -5.853638230200579),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.448173122092414),
                                    ("tomorrow<time-of-day> am|pm", -5.853638230200579),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.448173122092414),
                                    ("Diwaliyear (latent)", -5.448173122092414),
                                    ("this <part-of-day>at <time-of-day>", -4.937347498326424),
                                    ("Fridayyear (latent)", -4.937347498326424),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13197416417591631,
                               unseen = -5.5053315359323625,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.4794658613216277e-2),
                                    ("intersect 2 numbers", -4.114963849424837)],
                               n = 241},
                   koData =
                     ClassData{prior = -2.0904105730504097,
                               unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.504405055963068, unseen = -4.852030263919617,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.925999546001116, unseen = -4.442651256490317,
                               likelihoods =
                                 HashMap.fromList
