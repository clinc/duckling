...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5844785333407561, unseen = -6.159095388491933,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 471},
                   koData =
                     ClassData{prior = -0.815080829942642, unseen = -5.929589143389895,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.3232358401924436),
                                    ...
                                    ("<> <unit-of-duration>", -1.6184877479540183)],
                               n = 46},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.917770732084279), ("quarter", -2.917770732084279),
                                    ...
                                    ("<> <unit-of-duration>", -1.6650077635889111)],
                               n = 9}}),
       ("January",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -1.3862943611198906),
                                    ...
                                    ("Thanksgiving Day<> <unit-of-duration>", -1.0986122886681098),
                                    ("Diwali<> <unit-of-duration>", -1.791759469228055)],
                               n = 4},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.6094379124341003,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46508961444330654,
                               unseen = -7.188412736496954,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.494509983555011),
                                    ("Karva Chauthyear (latent)", -6.494509983555011),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.494509983555011),
                                    ("Maha Shivaratriyear (latent)", -6.494509983555011),
                                    ("Ramadanyear (latent)", -5.241747015059643),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.10821562243512),
                                    ("Bhai Doojyear (latent)", -6.494509983555011),
                                    ("hourday", -4.4796069630127455),
                                    ("dayhour", -3.4740850974106476),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.10821562243512),
                                    ("Martin Luther King's Dayyear (latent)", -6.089044875446846),
                                    ("Shemini Atzeretyear (latent)", -6.494509983555011),
                                    ("daymonth", -4.35444382005874),
                                    ("monthday", -6.089044875446846),
                                    ("monthyear", -4.622707806653419),
                                    ("Yom Ha'atzmautyear (latent)", -6.494509983555011),
                                    ("Vijayadashamiyear (latent)", -6.494509983555011),
                                    ("Thanksgiving Dayyear (latent)", -5.395897694886901),
                                    ("Thai Pongalyear (latent)", -5.801362802995065),
                                    ("Thiru Onamyear (latent)", -5.801362802995065),
                                    ("hhhmmabsorption of , after named day", -6.494509983555011),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.494509983555011),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5782192516808555),
                                    ("<day-of-month> (ordinal)Wednesday", -6.494509983555011),
                                    ("Krishna Janmashtamiyear (latent)", -6.089044875446846),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.494509983555011),
                                    ("houryear", -5.5782192516808555),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.494509983555011),
                                    ("Christmas<time-of-day> am|pm", -6.494509983555011),
                                    ("<day-of-month> (ordinal)October", -6.494509983555011),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.494509983555011),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.801362802995065),
                                    ("intersectin|during <named-month>|year", -6.494509983555011),
                                    ("<time-of-day> am|pmintersect", -5.241747015059643),
                                    ("Earth Houryear (latent)", -6.494509983555011),
                                    ("Ganesh Chaturthiyear (latent)", -6.494509983555011),
                                    ("Octoberyear (latent)", -4.88507207112091),
                                    ("intersect<time-of-day> am|pm", -6.494509983555011),
                                    ("Mattu Pongalyear (latent)", -6.494509983555011),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.494509983555011),
                                    ("Shavuotyear (latent)", -6.494509983555011),
                                    ("Parsi New Yearyear (latent)", -5.5782192516808555),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.494509983555011),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.494509983555011),
                                    ("todayin|within|after <duration>", -6.494509983555011),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.089044875446846),
                                    ("Marchyear (latent)", -6.494509983555011),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.089044875446846),
                                    ("Sukkotyear (latent)", -6.089044875446846),
                                    ("hhhmmintersect", -6.089044875446846),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.089044875446846),
                                    ("Clean Mondayyear (latent)", -6.089044875446846),
                                    ("monthhour", -6.089044875446846),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.801362802995065),
                                    ("todayat <time-of-day>", -6.494509983555011),
                                    ("Thursday<time> timezone", -4.09661471075664),
                                    ("tonight<time-of-day> am|pm", -6.494509983555011),
                                    ("time-of-day (latent)tonight", -6.089044875446846),
                                    ("from|since|after <time>December", -6.494509983555011),
                                    ("<time-of-day> am|pmon <day>", -4.4796069630127455),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.494509983555011),
                                    ("yyyy-mm-ddhh:mm:ss", -6.089044875446846),
                                    ("dayday", -3.7864597824528),
                                    ("<time> <part-of-day>at <time-of-day>", -6.089044875446846),
                                    ("mm/ddat <time-of-day>", -5.801362802995065),
                                    ("tonightat <time-of-day>", -5.395897694886901),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.801362802995065),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.494509983555011),
                                    ("today<time-of-day> am|pm", -6.494509983555011),
                                    ("Februarythe <day-of-month> (ordinal)", -6.089044875446846),
                                    ("at <time-of-day><time> <part-of-day>", -6.494509983555011),
                                    ("<day-of-month> (ordinal)intersect", -5.801362802995065),
                                    ("mm/dd<time-of-day> am|pm", -6.494509983555011),
                                    ("hourhour", -3.5240955179853093),
                                    ("Mahavir Jayantiyear (latent)", -6.089044875446846),
                                    ("Navaratriin|during <named-month>|year", -6.494509983555011),
                                    ("Wednesdaythis|last|next <cycle>", -6.494509983555011),
                                    ("Lentyear (latent)", -6.494509983555011),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.622707806653419),
                                    ("Boghiyear (latent)", -6.494509983555011),
                                    ("dayyear", -1.914657605551209),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.494509983555011),
                                    ("Thursdayfrom|since|after <time>", -6.089044875446846),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.494509983555011),
                                    ("Thursdayat <time-of-day>", -5.801362802995065),
                                    ("Islamic New Yearyear (latent)", -6.089044875446846),
                                    ("Laylat al-Qadryear (latent)", -5.5782192516808555),
                                    ("part of days<time-of-day> am|pm", -6.494509983555011),
                                    ("Shrove Tuesdayyear (latent)", -6.494509983555011),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.801362802995065),
                                    ("hourminute", -6.089044875446846),
                                    ("<time-of-day> am|pmtomorrow", -5.801362802995065),
                                    ("Yom Kippuryear (latent)", -6.494509983555011),
                                    ("<day-of-month> (ordinal)Tuesday", -6.089044875446846),
                                    ("<part-of-day> of <time>year (latent)", -6.494509983555011),
                                    ("minutehour", -5.241747015059643),
                                    ("Kaanum Pongalyear (latent)", -6.089044875446846),
                                    ("Maha Saptamiyear (latent)", -6.494509983555011),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.801362802995065),
                                    ("time-of-day (latent)tomorrow", -5.5782192516808555),
                                    ("part of daysat <time-of-day>", -4.88507207112091),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4796069630127455),
                                    ("for <duration> from <time>December", -6.494509983555011),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.494509983555011),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.241747015059643),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.241747015059643),
                                    ("time-of-day (latent)this <part-of-day>", -6.494509983555011),
                                    ("Pentecostyear (latent)", -6.494509983555011),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.241747015059643),
                                    ("<day-of-month> (ordinal)February", -6.494509983555011),
                                    ("Eid al-Fitryear (latent)", -5.10821562243512),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.494509983555011),
                                    ("Mondayin|during the <part-of-day>", -6.494509983555011),
                                    ("Chhathin|during <named-month>|year", -6.494509983555011),
                                    ("Diwaliin|during <named-month>|year", -6.494509983555011),
                                    ("this <part-of-day><time-of-day> am|pm", -6.494509983555011),
                                    ("Vaisakhiin|during <named-month>|year", -6.494509983555011),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.241747015059643),
                                    ("Raksha Bandhanyear (latent)", -6.494509983555011),
                                    ("daysecond", -6.089044875446846),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.089044875446846),
                                    ("Ratha-Yatrayear (latent)", -6.494509983555011),
                                    ("Ashurayear (latent)", -6.494509983555011),
                                    ("Tuesdayin|during <named-month>|year", -6.494509983555011),
                                    ("Chinese New Yearyear (latent)", -6.494509983555011),
                                    ("tomorrowintersect", -6.494509983555011),
                                    ("Lag BaOmeryear (latent)", -6.494509983555011),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.494509983555011),
                                    ("Eid al-Adhayear (latent)", -4.35444382005874),
                                    ("intersectin|during the <part-of-day>", -6.494509983555011),
                                    ("Palm Sundayyear (latent)", -6.494509983555011),
                                    ("Christmasat <time-of-day>", -6.494509983555011),
                                    ("Passoveryear (latent)", -6.494509983555011),
                                    ("Lazarus Saturdayyear (latent)", -6.494509983555011),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.089044875446846),
                                    ("the last <cycle> of <time>year (latent)", -5.801362802995065),
                                    ("hhhmmon <day>", -5.5782192516808555),
                                    ("Yom HaShoahyear (latent)", -6.089044875446846),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.089044875446846),
                                    ("Septemberyear (latent)", -6.089044875446846),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.990432586778736),
                                    ("Halloweenyear (latent)", -6.494509983555011),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.494509983555011),
                                    ("at <time-of-day>intersect", -5.5782192516808555),
                                    ("Rosh Hashanahyear (latent)", -5.801362802995065),
                                    ("Dhanterasyear (latent)", -6.494509983555011),
                                    ("Tu BiShvatyear (latent)", -6.494509983555011),
                                    ("<day-of-month> (ordinal)December", -5.801362802995065),
                                    ("Holiyear (latent)", -5.801362802995065),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.494509983555011),
                                    ("Holika Dahanyear (latent)", -5.801362802995065),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.089044875446846),
                                    ("dayminute", -3.1101197202092363),
                                    ("Mawlidyear (latent)", -6.494509983555011),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.089044875446846),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.494509983555011),
                                    ("Jumu'atul-Widayear (latent)", -5.5782192516808555),
                                    ("minuteday", -2.7568403652716422),
                                    ("absorption of , after named dayintersect",
                                     -5.801362802995065),
                                    ("intersectyear (latent)", -6.089044875446846),
                                    ("Orthodox Easter Sundayyear (latent)", -6.494509983555011),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.494509983555011),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.494509983555011),
                                    ("intersecthhhmm", -6.089044875446846),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.494509983555011),
                                    ("Boss's Dayyear (latent)", -6.089044875446846),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.494509983555011),
                                    ("Global Youth Service Dayyear (latent)", -6.494509983555011),
                                    ("Dhanterasin|during <named-month>|year", -6.494509983555011),
                                    ("tonight<time-of-day> o'clock", -6.494509983555011),
                                    ("Tisha B'Avyear (latent)", -6.494509983555011),
                                    ("Isra and Mi'rajyear (latent)", -5.5782192516808555),
                                    ("at <time-of-day>on <day>", -4.88507207112091),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.089044875446846),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.801362802995065),
                                    ("Christmasyear (latent)", -6.089044875446846),
                                    ("Saturdayintersect", -6.494509983555011),
                                    ("Naraka Chaturdashiyear (latent)", -6.089044875446846),
                                    ("Thai Pongalin|during <named-month>|year", -6.494509983555011),
                                    ("dayweek", -6.494509983555011),
                                    ("Easter Sundayyear (latent)", -5.801362802995065),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.089044875446846),
                                    ("weekyear", -5.241747015059643),
                                    ("King's Dayyear (latent)", -4.990432586778736),
                                    ("hh:mmin|during the <part-of-day>", -5.5782192516808555),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.089044875446846),
                                    ("Hanukkahyear (latent)", -5.801362802995065),
                                    ("Rama Navamiyear (latent)", -6.494509983555011),
                                    ("February<time> <part-of-day>", -6.494509983555011),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.801362802995065),
                                    ("Great Lentyear (latent)", -6.494509983555011),
                                    ("tomorrowat <time-of-day>", -5.801362802995065),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.494509983555011),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.089044875446846),
                                    ("Ugadiyear (latent)", -5.10821562243512),
                                    ("Vaisakhiyear (latent)", -5.801362802995065),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.801362802995065),
                                    ("last <cycle> of <time>year (latent)", -5.801362802995065),
                                    ("at <time-of-day>tomorrow", -6.089044875446846),
                                    ("tomorrow<time-of-day> am|pm", -6.494509983555011),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.494509983555011),
                                    ("Diwaliyear (latent)", -6.494509983555011),
                                    ("between <time> and <time>on <day>", -6.089044875446846),
                                    ("Black Fridayyear (latent)", -6.089044875446846),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.494509983555011),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.494509983555011),
                                    ("Chhathyear (latent)", -6.089044875446846),
                                    ("Vasant Panchamiyear (latent)", -6.494509983555011),
                                    ("Rabindra Jayantiyear (latent)", -5.241747015059643),
                                    ("this <part-of-day>at <time-of-day>", -5.241747015059643),
                                    ("St Patrick's Dayyear (latent)", -6.494509983555011),
                                    ("Thursday<time> (timezone)", -6.494509983555011),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.494509983555011),
                                    ("Pargat Diwasyear (latent)", -5.241747015059643),
                                    ("<datetime> - <datetime> (interval)July", -6.089044875446846),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.801362802995065),
                                    ("Februaryintersect", -6.494509983555011),
                                    ("Simchat Torahyear (latent)", -6.494509983555011),
                                    ("minuteyear", -6.494509983555011)],
                               n = 510},
                   koData =
                     ClassData{prior = -0.9890733227868084, unseen = -6.811244378601293,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.612917872778917),
                                    ...
                                    ("Mondayyear (latent)", -5.423848088995246),
                                    ("dayday", -4.102092249012927),
                                    ("mm/ddat <time-of-day>", -5.200704537681037),
                                    ...
                                    ("the last <cycle> of <time>year (latent)", -5.711530161447027),
                                    ...
                                    ("weekyear", -5.200704537681037),
                                    ("after <time>year (latent)", -6.116995269555192),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15283920422944755,
                               unseen = -5.407171771460119,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.7398974188114388e-2),
                                    ("intersect 2 numbers", -4.0163830207523885)],
                               n = 218},
                   koData =
                     ClassData{prior = -1.9538153285624267, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6317782341836533, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.758529939822797, unseen = -4.736198448394496,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.34274685548172e-2),
                                    ("integer (0..19)", -2.6479462770325046)],
                               n = 111}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("a <unit-of-duration>now", -3.4965075614664802),
                                    ...
                                    ("<> <unit-of-duration>time-of-day (latent)",
                                     -2.3978952727983707),
                                    ("<> <unit-of-duration>today", -3.4965075614664802),
                                    ("<> <unit-of-duration>Easter Sunday", -3.4965075614664802),
                                    ("<> <unit-of-duration>Christmas", -3.4965075614664802)],
                               n = 19},
                   koData =
                     ClassData{prior = -0.6021754023542185, unseen = -4.31748811353631,
                               likelihoods =
                                 HashMap.fromList
                                   [("<> <unit-of-duration>intersect", -3.6109179126442243),
                                    ...
                                    ("a <unit-of-duration>noon|midnight|EOD|end of day",
                                     -3.20545280453606),
                                    ("<> <unit-of-duration>now", -3.6109179126442243),
                                    ("<> <unit-of-duration>time-of-day (latent)",
                                     -3.6109179126442243)],
                               n = 23}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -2.3025850929940455),
                                    ...
                                    ("Vijayadashami<> <unit-of-duration>", -2.3025850929940455),
                                    ("Thanksgiving Day<> <unit-of-duration>", -1.8971199848858813),
                                    ("March<> <unit-of-duration>", -2.3025850929940455)],
                               n = 6},
                   koData =
                     ClassData{prior = -infinity, unseen = -2.1972245773362196,
                               likelihoods = HashMap.fromList [], n = 0}}),
