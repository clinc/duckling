...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5532848315377822, unseen = -6.214608098422191,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 498},
                   koData =
                     ClassData{prior = -0.8558019703935043, unseen = -5.91350300563827,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.1400661634962708), ("year", -1.4469189829363254),
                                    ("<> <unit-of-duration>", -1.2237754316221157)],
                               n = 4}}),
       ...
       ("<day> <duration> hence|ago",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.0794415416798357,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tax Day<> <unit-of-duration>", -1.252762968495368),
                                    ("dayyear", -0.8472978603872037),
                                    ("Diwali<> <unit-of-duration>", -1.252762968495368)],
                               n = 2},
                   koData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.44688393941128113,
                                 ...
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.543911845564792),
                                    ...
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.157617484444901),
                                    ("Military Spouse Dayyear (latent)", -6.543911845564792),
                                    ("Bhai Doojyear (latent)", -6.543911845564792),
                                    ("hourday", -4.529008825022527),
                                    ("dayhour", -3.5234869594204294),
                                    ...
                                    ("daymonth", -4.529008825022527),
                                    ("monthday", -6.138446737456627),
                                    ("monthyear", -4.7521523763367375),
                                    ...
                                    ("hhhmmabsorption of , after named day", -6.543911845564792),
                                    ...
                                    ("houryear", -5.627621113690637),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.543911845564792),
                                    ("Christmas<time-of-day> am|pm", -6.543911845564792),
                                    ...
                                    ("<time-of-day> am|pmintersect", -5.291148877069424),
                                    ("Earth Houryear (latent)", -6.543911845564792),
                                    ("Ganesh Chaturthiyear (latent)", -6.543911845564792),
                                    ("Octoberyear (latent)", -5.039834448788518),
                                    ("intersect<time-of-day> am|pm", -6.543911845564792),
                                    ("Mattu Pongalyear (latent)", -6.543911845564792),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.543911845564792),
                                    ("Daylight Saving Start Dayyear (latent)", -5.627621113690637),
                                    ("Shavuotyear (latent)", -6.543911845564792),
                                    ("Parsi New Yearyear (latent)", -5.627621113690637),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.543911845564792),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.543911845564792),
                                    ("todayin|within|after <duration>", -6.543911845564792),
                                    ...
                                    ("hhhmmintersect", -6.138446737456627),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.138446737456627),
                                    ("Daylight Saving End Dayyear (latent)", -5.627621113690637),
                                    ("Clean Mondayyear (latent)", -6.138446737456627),
                                    ("monthhour", -6.138446737456627),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.850764665004847),
                                    ("todayat <time-of-day>", -6.543911845564792),
                                    ("Thursday<time> timezone", -4.146016572766421),
                                    ("tonight<time-of-day> am|pm", -6.543911845564792),
                                    ("time-of-day (latent)tonight", -6.138446737456627),
                                    ("from|since|after <time>December", -6.543911845564792),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.543911845564792),
                                    ("<time-of-day> am|pmon <day>", -4.529008825022527),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.543911845564792),
                                    ("yyyy-mm-ddhh:mm:ss", -6.138446737456627),
                                    ("Tax Daythis|last|next <cycle>", -6.543911845564792),
                                    ("dayday", -3.835861644462582),
                                    ("<time> <part-of-day>at <time-of-day>", -6.138446737456627),
                                    ("mm/ddat <time-of-day>", -6.543911845564792),
                                    ("tonightat <time-of-day>", -5.445299556896683),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.850764665004847),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.543911845564792),
                                    ("today<time-of-day> am|pm", -6.543911845564792),
                                    ("Februarythe <day-of-month> (ordinal)", -6.138446737456627),
                                    ("at <time-of-day><time> <part-of-day>", -6.543911845564792),
                                    ("<day-of-month> (ordinal)intersect", -6.138446737456627),
                                    ("mm/dd<time-of-day> am|pm", -6.543911845564792),
                                    ("hourhour", -3.573497379995091),
                                    ("Mahavir Jayantiyear (latent)", -6.138446737456627),
                                    ("Navaratriin|during <named-month>|year", -6.543911845564792),
                                    ...
                                    ("dayyear", -1.8165240268524516),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.543911845564792),
                                    ("Thursdayfrom|since|after <time>", -6.138446737456627),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.543911845564792),
                                    ("Thursdayat <time-of-day>", -5.850764665004847),
                                    ("Islamic New Yearyear (latent)", -6.138446737456627),
                                    ("Laylat al-Qadryear (latent)", -5.627621113690637),
                                    ("part of days<time-of-day> am|pm", -6.543911845564792),
                                    ("Shrove Tuesdayyear (latent)", -6.543911845564792),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.850764665004847),
                                    ("hourminute", -6.138446737456627),
                                    ("<time-of-day> am|pmtomorrow", -5.850764665004847),
                                    ("Yom Kippuryear (latent)", -6.543911845564792),
                                    ("<day-of-month> (ordinal)Tuesday", -6.138446737456627),
                                    ("<part-of-day> of <time>year (latent)", -6.543911845564792),
                                    ("minutehour", -5.291148877069424),
                                    ("Kaanum Pongalyear (latent)", -6.138446737456627),
                                    ("Maha Saptamiyear (latent)", -6.543911845564792),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.850764665004847),
                                    ("time-of-day (latent)tomorrow", -5.627621113690637),
                                    ("part of daysat <time-of-day>", -4.9344739331306915),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.529008825022527),
                                    ("for <duration> from <time>December", -6.543911845564792),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.543911845564792),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.291148877069424),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.291148877069424),
                                    ("time-of-day (latent)this <part-of-day>", -6.543911845564792),
                                    ...
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.543911845564792),
                                    ("Mondayin|during the <part-of-day>", -6.543911845564792),
                                    ("Chhathin|during <named-month>|year", -6.543911845564792),
                                    ("Diwaliin|during <named-month>|year", -6.543911845564792),
                                    ("this <part-of-day><time-of-day> am|pm", -6.543911845564792),
                                    ("Vaisakhiin|during <named-month>|year", -6.543911845564792),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.291148877069424),
                                    ("Raksha Bandhanyear (latent)", -6.543911845564792),
                                    ("daysecond", -6.138446737456627),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.138446737456627),
                                    ("Emancipation Dayyear (latent)", -5.850764665004847),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.543911845564792),
                                    ("the last <cycle> of <time>year (latent)", -5.850764665004847),
                                    ("Cyber Mondayyear (latent)", -6.138446737456627),
                                    ("hhhmmon <day>", -5.627621113690637),
                                    ...
                                    ("minuteday", -2.8062422272814236),
                                    ("absorption of , after named dayintersect",
                                     -5.850764665004847),
                                    ("intersectyear (latent)", -6.543911845564792),
                                    ...
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.543911845564792),
                                    ("intersecthhhmm", -6.138446737456627),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.543911845564792),
                                    ...
                                    ("February<time> <part-of-day>", -6.543911845564792),
                                    ("National Grandparents Dayyear (latent)", -6.543911845564792),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.850764665004847),
                                    ("Great Lentyear (latent)", -6.543911845564792),
                                    ("tomorrowat <time-of-day>", -5.850764665004847),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.543911845564792),
                                    ("Labor Dayyear (latent)", -6.543911845564792),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.138446737456627),
                                    ...
                                    ("at <time-of-day>tomorrow", -6.138446737456627),
                                    ("tomorrow<time-of-day> am|pm", -6.543911845564792),
                                    ("President's Dayyear (latent)", -6.543911845564792),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.543911845564792),
                                    ("Diwaliyear (latent)", -6.543911845564792),
                                    ("between <time> and <time>on <day>", -6.138446737456627),
                                    ...
                                    ("Tax Dayyear (latent)", -5.627621113690637),
                                    ("Rabindra Jayantiyear (latent)", -5.291148877069424),
                                    ("this <part-of-day>at <time-of-day>", -5.291148877069424),
                                    ("St Patrick's Dayyear (latent)", -6.543911845564792),
                                    ("Thursday<time> (timezone)", -6.543911845564792),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.543911845564792),
                                    ("Pargat Diwasyear (latent)", -5.291148877069424),
                                    ("<datetime> - <datetime> (interval)July", -6.138446737456627),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.850764665004847),
                                    ("Februaryintersect", -6.543911845564792),
                                    ("Mother's Dayyear (latent)", -6.543911845564792),
                                    ("Simchat Torahyear (latent)", -6.543911845564792),
                                    ("minuteyear", -6.543911845564792)],
                               n = 536},
                   koData =
                     ClassData{prior = -1.0205910831072134, unseen = -6.827629234502853,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.629320646220375),
                                    ("hourday", -3.735502770198278),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.133398042996649),
                                    ("<day-of-month> (ordinal)August", -6.133398042996649),
                                    ("dayhour", -3.4253478418944385),
                                    ("<time> timezoneyear (latent)", -5.440250862436703),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.2171073111224935),
                                    ("after <time><time-of-day> am|pm", -6.133398042996649),
                                    ("Tuesdayfrom|since|after <time>", -5.440250862436703),
                                    ("daymonth", -3.45924939357012),
                                    ("hourquarter", -6.133398042996649),
                                    ("monthyear", -4.8806350745012805),
                                    ("<time-of-day> am|pmyear (latent)", -5.440250862436703),
                                    ("time-of-day (latent)qq", -6.133398042996649),
                                    ("Thai Pongalyear (latent)", -5.440250862436703),
                                    ("intersecthh:mm", -6.133398042996649),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.727932934888484),
                                    ("<day-of-month> (ordinal)Wednesday", -6.133398042996649),
                                    ("houryear", -4.747103681876758),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.133398042996649),
                                    ("<day-of-month> (ordinal)October", -6.133398042996649),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.440250862436703),
                                    ...
                                    ("the <day-of-month> (ordinal)July", -6.133398042996649),
                                    ("the <day-of-month> (number)July", -6.133398042996649),
                                    ("monthminute", -6.133398042996649),
                                    ("<time-of-day> am|pmtomorrow", -6.133398042996649),
                                    ("Thursdayhh:mm", -5.2171073111224935),
                                    ("<day-of-month> (ordinal)Tuesday", -5.727932934888484),
                                    ...
                                    ("Februaryin|during the <part-of-day>", -6.133398042996649),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.133398042996649),
                                    ("<day-of-month> (ordinal)Monday", -5.2171073111224935),
                                    ...
                                    ("weekyear", -5.2171073111224935),
                                    ("after <time>year (latent)", -6.133398042996649),
                                    ("time-of-day (latent)Thursday", -5.727932934888484),
                                    ("<day-of-month> (ordinal)April", -6.133398042996649),
                                    ...
                                    ("Fridayyear (latent)", -5.727932934888484),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13453089295760612,
                               unseen = -5.541263545158426,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.3905520853554366e-2),
                                    ("intersect 2 numbers", -4.151039905898646)],
                               n = 250},
                   koData =
                     ClassData{prior = -2.0724728723637424, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -1.540445040947149),
                                    ...
                                    ("Tax Day<> <unit-of-duration>", -1.9459101490553135),
