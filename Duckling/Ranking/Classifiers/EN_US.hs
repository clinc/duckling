...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.43359995617968294,
                               unseen = -7.198183577101943,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.504288173536645),
                                    ("Father's Dayyear (latent)", -6.504288173536645),
                                    ("Karva Chauthyear (latent)", -6.504288173536645),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.504288173536645),
                                    ("Maha Shivaratriyear (latent)", -6.504288173536645),
                                    ("Ramadanyear (latent)", -5.251525205041278),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.405675884868536),
                                    ("Military Spouse Dayyear (latent)", -6.504288173536645),
                                    ("Bhai Doojyear (latent)", -6.504288173536645),
                                    ("hourday", -4.489385152994381),
                                    ("dayhour", -3.5865174414523664),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.405675884868536),
                                    ("Martin Luther King's Dayyear (latent)", -6.098823065428482),
                                    ("Shemini Atzeretyear (latent)", -6.504288173536645),
                                    ("daymonth", -4.712528704308591),
                                    ("monthyear", -4.712528704308591),
                                    ("Yom Ha'atzmautyear (latent)", -6.504288173536645),
                                    ("Vijayadashamiyear (latent)", -6.504288173536645),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.117993812416755),
                                    ("Thanksgiving Dayyear (latent)", -5.405675884868536),
                                    ("Thai Pongalyear (latent)", -5.8111409929767),
                                    ("Thiru Onamyear (latent)", -5.8111409929767),
                                    ("hhhmmabsorption of , after named day", -6.504288173536645),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.58799744166249),
                                    ("<day-of-month> (ordinal)Wednesday", -6.504288173536645),
                                    ("Krishna Janmashtamiyear (latent)", -6.098823065428482),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.504288173536645),
                                    ("houryear", -5.58799744166249),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.504288173536645),
                                    ("Christmas<time-of-day> am|pm", -6.504288173536645),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.504288173536645),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8111409929767),
                                    ("intersectin|during <named-month>|year", -6.504288173536645),
                                    ("<time-of-day> am|pmintersect", -5.251525205041278),
                                    ("Earth Houryear (latent)", -6.504288173536645),
                                    ("Ganesh Chaturthiyear (latent)", -6.504288173536645),
                                    ("Octoberyear (latent)", -5.000210776760372),
                                    ("intersect<time-of-day> am|pm", -6.504288173536645),
                                    ("Mattu Pongalyear (latent)", -6.504288173536645),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.504288173536645),
                                    ("Daylight Saving Start Dayyear (latent)", -5.58799744166249),
                                    ("Shavuotyear (latent)", -6.504288173536645),
                                    ("Parsi New Yearyear (latent)", -5.58799744166249),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.504288173536645),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.504288173536645),
                                    ("todayin|within|after <duration>", -6.504288173536645),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.098823065428482),
                                    ("Marchyear (latent)", -6.504288173536645),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.098823065428482),
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.504288173536645),
                                    ("Sukkotyear (latent)", -6.098823065428482),
                                    ("hhhmmintersect", -6.098823065428482),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.098823065428482),
                                    ("Daylight Saving End Dayyear (latent)", -5.58799744166249),
                                    ("Clean Mondayyear (latent)", -6.098823065428482),
                                    ("monthhour", -6.098823065428482),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.8111409929767),
                                    ("todayat <time-of-day>", -6.504288173536645),
                                    ("Thursday<time> timezone", -4.106392900738275),
                                    ("tonight<time-of-day> am|pm", -6.504288173536645),
                                    ("time-of-day (latent)tonight", -6.098823065428482),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.504288173536645),
                                    ("<time-of-day> am|pmon <day>", -4.489385152994381),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.504288173536645),
                                    ("yyyy-mm-ddhh:mm:ss", -6.098823065428482),
                                    ("Tax Daythis|last|next <cycle>", -6.504288173536645),
                                    ("dayday", -3.830139524110117),
                                    ("<time> <part-of-day>at <time-of-day>", -6.098823065428482),
                                    ("mm/ddat <time-of-day>", -6.504288173536645),
                                    ("tonightat <time-of-day>", -5.405675884868536),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.8111409929767),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.504288173536645),
                                    ("today<time-of-day> am|pm", -6.504288173536645),
                                    ("at <time-of-day><time> <part-of-day>", -6.504288173536645),
                                    ("<day-of-month> (ordinal)intersect", -6.098823065428482),
                                    ("mm/dd<time-of-day> am|pm", -6.504288173536645),
                                    ("hourhour", -3.5338737079669444),
                                    ("Mahavir Jayantiyear (latent)", -6.098823065428482),
                                    ("Navaratriin|during <named-month>|year", -6.504288173536645),
                                    ("Wednesdaythis|last|next <cycle>", -6.504288173536645),
                                    ("Lentyear (latent)", -6.504288173536645),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.6324859966350544),
                                    ("Boghiyear (latent)", -6.504288173536645),
                                    ("dayyear", -1.7769003548243052),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.504288173536645),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.504288173536645),
                                    ("Thursdayat <time-of-day>", -5.8111409929767),
                                    ("Islamic New Yearyear (latent)", -6.098823065428482),
                                    ("Laylat al-Qadryear (latent)", -5.58799744166249),
                                    ("part of days<time-of-day> am|pm", -6.504288173536645),
                                    ("Shrove Tuesdayyear (latent)", -6.504288173536645),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.8111409929767),
                                    ("hourminute", -6.098823065428482),
                                    ("<time-of-day> am|pmtomorrow", -5.8111409929767),
                                    ("Yom Kippuryear (latent)", -6.504288173536645),
                                    ("<day-of-month> (ordinal)Tuesday", -6.098823065428482),
                                    ("<part-of-day> of <time>year (latent)", -6.504288173536645),
                                    ("minutehour", -5.251525205041278),
                                    ("Kaanum Pongalyear (latent)", -6.098823065428482),
                                    ("Maha Saptamiyear (latent)", -6.504288173536645),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.8111409929767),
                                    ("time-of-day (latent)tomorrow", -5.58799744166249),
                                    ("part of daysat <time-of-day>", -4.894850261102546),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.489385152994381),
                                    ("for <duration> from <time>December", -6.504288173536645),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.504288173536645),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.251525205041278),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.251525205041278),
                                    ("time-of-day (latent)this <part-of-day>", -6.504288173536645),
                                    ("Pentecostyear (latent)", -6.504288173536645),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.251525205041278),
                                    ("<day-of-month> (ordinal)February", -6.504288173536645),
                                    ("Eid al-Fitryear (latent)", -5.117993812416755),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.504288173536645),
                                    ("Mondayin|during the <part-of-day>", -6.504288173536645),
                                    ("Chhathin|during <named-month>|year", -6.504288173536645),
                                    ("Diwaliin|during <named-month>|year", -6.504288173536645),
                                    ("this <part-of-day><time-of-day> am|pm", -6.504288173536645),
                                    ("Vaisakhiin|during <named-month>|year", -6.504288173536645),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.251525205041278),
                                    ("Raksha Bandhanyear (latent)", -6.504288173536645),
                                    ("daysecond", -6.098823065428482),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.098823065428482),
                                    ("Emancipation Dayyear (latent)", -5.8111409929767),
                                    ("Ratha-Yatrayear (latent)", -6.504288173536645),
                                    ("Ashurayear (latent)", -6.504288173536645),
                                    ("Tuesdayin|during <named-month>|year", -6.504288173536645),
                                    ("Chinese New Yearyear (latent)", -6.504288173536645),
                                    ("tomorrowintersect", -6.504288173536645),
                                    ("Lag BaOmeryear (latent)", -6.504288173536645),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.504288173536645),
                                    ("Eid al-Adhayear (latent)", -4.364222010040375),
                                    ("Palm Sundayyear (latent)", -6.504288173536645),
                                    ("Christmasat <time-of-day>", -6.504288173536645),
                                    ("Passoveryear (latent)", -6.504288173536645),
                                    ("Lazarus Saturdayyear (latent)", -6.504288173536645),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.504288173536645),
                                    ("the last <cycle> of <time>year (latent)", -5.8111409929767),
                                    ("Cyber Mondayyear (latent)", -6.098823065428482),
                                    ("hhhmmon <day>", -5.58799744166249),
                                    ("Yom HaShoahyear (latent)", -6.098823065428482),
                                    ("Septemberyear (latent)", -6.098823065428482),
                                    ("Halloweenyear (latent)", -6.504288173536645),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.504288173536645),
                                    ("at <time-of-day>intersect", -5.58799744166249),
                                    ("Rosh Hashanahyear (latent)", -5.8111409929767),
                                    ("Dhanterasyear (latent)", -6.504288173536645),
                                    ("Tu BiShvatyear (latent)", -6.504288173536645),
                                    ("<day-of-month> (ordinal)December", -5.8111409929767),
                                    ("Holiyear (latent)", -5.8111409929767),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.504288173536645),
                                    ("Holika Dahanyear (latent)", -5.8111409929767),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.098823065428482),
                                    ("dayminute", -3.3056150559859643),
                                    ("Mawlidyear (latent)", -6.504288173536645),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.098823065428482),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.504288173536645),
                                    ("Jumu'atul-Widayear (latent)", -5.58799744166249),
                                    ("minuteday", -2.8154087194227095),
                                    ("absorption of , after named dayintersect", -5.8111409929767),
                                    ("intersectyear (latent)", -6.504288173536645),
                                    ("Orthodox Easter Sundayyear (latent)", -6.504288173536645),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.504288173536645),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.504288173536645),
                                    ("intersecthhhmm", -6.098823065428482),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.504288173536645),
                                    ("Boss's Dayyear (latent)", -6.098823065428482),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.504288173536645),
                                    ("Global Youth Service Dayyear (latent)", -6.504288173536645),
                                    ("Dhanterasin|during <named-month>|year", -6.504288173536645),
                                    ("tonight<time-of-day> o'clock", -6.504288173536645),
                                    ("Tisha B'Avyear (latent)", -6.504288173536645),
                                    ("Isra and Mi'rajyear (latent)", -5.58799744166249),
                                    ("at <time-of-day>on <day>", -4.894850261102546),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.098823065428482),
                                    ("time-of-day (latent)<time> <part-of-day>", -5.8111409929767),
                                    ("Christmasyear (latent)", -6.098823065428482),
                                    ("Saturdayintersect", -6.504288173536645),
                                    ("Naraka Chaturdashiyear (latent)", -6.098823065428482),
                                    ("Thai Pongalin|during <named-month>|year", -6.504288173536645),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.504288173536645),
                                    ("dayweek", -6.504288173536645),
                                    ("Easter Sundayyear (latent)", -5.8111409929767),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.098823065428482),
                                    ("weekyear", -5.251525205041278),
                                    ("King's Dayyear (latent)", -5.000210776760372),
                                    ("hh:mmin|during the <part-of-day>", -5.58799744166249),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.098823065428482),
                                    ("Hanukkahyear (latent)", -5.8111409929767),
                                    ("Rama Navamiyear (latent)", -6.504288173536645),
                                    ("February<time> <part-of-day>", -6.504288173536645),
                                    ("National Grandparents Dayyear (latent)", -6.504288173536645),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.8111409929767),
                                    ("Great Lentyear (latent)", -6.504288173536645),
                                    ("tomorrowat <time-of-day>", -5.8111409929767),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.504288173536645),
                                    ("Labor Dayyear (latent)", -6.504288173536645),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.098823065428482),
                                    ("Ugadiyear (latent)", -5.117993812416755),
                                    ("Vaisakhiyear (latent)", -5.8111409929767),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.8111409929767),
                                    ("last <cycle> of <time>year (latent)", -5.8111409929767),
                                    ("at <time-of-day>tomorrow", -6.098823065428482),
                                    ("tomorrow<time-of-day> am|pm", -6.504288173536645),
                                    ("President's Dayyear (latent)", -6.504288173536645),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.504288173536645),
                                    ("Diwaliyear (latent)", -6.504288173536645),
                                    ("between <time> and <time>on <day>", -6.098823065428482),
                                    ("Black Fridayyear (latent)", -6.098823065428482),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.504288173536645),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.504288173536645),
                                    ("Chhathyear (latent)", -6.098823065428482),
                                    ("Vasant Panchamiyear (latent)", -6.504288173536645),
                                    ("Tax Dayyear (latent)", -5.58799744166249),
                                    ("Rabindra Jayantiyear (latent)", -5.251525205041278),
                                    ("this <part-of-day>at <time-of-day>", -5.251525205041278),
                                    ("St Patrick's Dayyear (latent)", -6.504288173536645),
                                    ("Thursday<time> (timezone)", -6.504288173536645),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.504288173536645),
                                    ("Pargat Diwasyear (latent)", -5.251525205041278),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.8111409929767),
                                    ("Februaryintersect", -6.504288173536645),
                                    ("Mother's Dayyear (latent)", -6.504288173536645),
                                    ("Simchat Torahyear (latent)", -6.504288173536645),
                                    ("minuteyear", -6.504288173536645)],
                               n = 514},
                   koData =
                     ClassData{prior = -1.0446114398134825,
                               unseen = -6.7650389767805414,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.566660331226216),
                                    ("hourday", -3.5858310782144893),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.07073772800249),
                                    ("<day-of-month> (ordinal)August", -6.07073772800249),
                                    ("dayhour", -3.5858310782144893),
                                    ("<time> timezoneyear (latent)", -5.377590547442544),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.154446996128335),
                                    ("after <time><time-of-day> am|pm", -6.07073772800249),
                                    ("daymonth", -3.36268752690028),
                                    ("hourquarter", -6.07073772800249),
                                    ("monthday", -5.154446996128335),
                                    ("monthyear", -4.97212543933438),
                                    ("<time-of-day> am|pmyear (latent)", -5.377590547442544),
                                    ("time-of-day (latent)qq", -6.07073772800249),
                                    ("Thai Pongalyear (latent)", -5.377590547442544),
                                    ("intersecthh:mm", -6.07073772800249),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.665272619894325),
                                    ("<day-of-month> (ordinal)Wednesday", -6.07073772800249),
                                    ("houryear", -4.817974759507122),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.07073772800249),
                                    ("Julyintersect", -5.377590547442544),
                                    ("<day-of-month> (ordinal)October", -6.07073772800249),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.377590547442544),
                                    ("<time-of-day> am|pmintersect", -4.817974759507122),
                                    ("time-of-day (latent)until <time>", -5.665272619894325),
                                    ("Octoberyear (latent)", -6.07073772800249),
                                    ("early morningat <time-of-day>", -6.07073772800249),
                                    ("until <time>on <day>", -5.377590547442544),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.07073772800249),
                                    ("time-of-day (latent)intersect", -6.07073772800249),
                                    ("todayin <number> (implicit minutes)", -6.07073772800249),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.07073772800249),
                                    ("hh:mmon <day>", -4.817974759507122),
                                    ("hhhmmintersect", -5.665272619894325),
                                    ("absorption of , after named dayJuly", -5.154446996128335),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.154446996128335),
                                    ("Clean Mondayyear (latent)", -6.07073772800249),
                                    ("monthhour", -4.684443366882599),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.665272619894325),
                                    ("hourmonth", -4.198935551100899),
                                    ("todayat <time-of-day>", -6.07073772800249),
                                    ("since <time>until <time>", -6.07073772800249),
                                    ("hhhmmyear (latent)", -4.817974759507122),
                                    ("<time-of-day> am|pmon <day>", -4.817974759507122),
                                    ("Mondayyear (latent)", -4.97212543933438),
                                    ("dayday", -4.124827578947176),
                                    ("mm/ddat <time-of-day>", -5.665272619894325),
                                    ("on <day>September", -5.377590547442544),
                                    ("since <time>intersect", -5.377590547442544),
                                    ("time-of-day (latent)September", -5.665272619894325),
                                    ("hourhour", -3.991296186322654),
                                    ("time-of-day (latent)on <day>", -4.566660331226216),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.665272619894325),
                                    ("dayyear", -3.180365970106325),
                                    ("Thursdaymm/dd", -6.07073772800249),
                                    ("New Year's Dayyear (latent)", -5.154446996128335),
                                    ("time-of-day (latent)Sunday", -5.665272619894325),
                                    ("Thursdayat <time-of-day>", -4.461299815568389),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.07073772800249),
                                    ("Aprilyear (latent)", -6.07073772800249),
                                    ("the <day-of-month> (ordinal)July", -6.07073772800249),
                                    ("the <day-of-month> (number)July", -6.07073772800249),
                                    ("monthminute", -6.07073772800249),
                                    ("<time-of-day> am|pmtomorrow", -6.07073772800249),
                                    ("Thursdayhh:mm", -5.154446996128335),
                                    ("<day-of-month> (ordinal)Tuesday", -5.665272619894325),
                                    ("minutemonth", -3.991296186322654),
                                    ("time-of-day (latent)Friday", -5.665272619894325),
                                    ("minutehour", -6.07073772800249),
                                    ("part of daysat <time-of-day>", -4.97212543933438),
                                    ("Augustyear (latent)", -5.665272619894325),
                                    ("week-endin|during <named-month>|year", -6.07073772800249),
                                    ("time-of-day (latent)Tuesday", -5.665272619894325),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.07073772800249),
                                    ("Sundayyear (latent)", -5.154446996128335),
                                    ("the <day-of-month> (ordinal)Monday", -5.377590547442544),
                                    ("Christmasat <time-of-day>", -6.07073772800249),
                                    ("the last <cycle> of <time>year (latent)", -5.665272619894325),
                                    ("hhhmmon <day>", -5.154446996128335),
                                    ("Julyuntil <time>", -5.665272619894325),
                                    ("yesterday<time-of-day> am|pm", -6.07073772800249),
                                    ("<day-of-month> (ordinal)July", -5.377590547442544),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.07073772800249),
                                    ("mm/ddyear (latent)", -6.07073772800249),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.07073772800249),
                                    ("at <time-of-day>intersect", -5.154446996128335),
                                    ("hh:mmyear (latent)", -4.684443366882599),
                                    ("Holiyear (latent)", -6.07073772800249),
                                    ("until <time><time-of-day> am|pm", -6.07073772800249),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.665272619894325),
                                    ("dayminute", -3.4316803983872313),
                                    ("yyyy-mm-ddhh:mm", -5.665272619894325),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.07073772800249),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -6.07073772800249),
                                    ("intersectSeptember", -4.198935551100899),
                                    ("minuteday", -3.0026847928688727),
                                    ("absorption of , after named dayintersect", -6.07073772800249),
                                    ("intersectyear (latent)", -6.07073772800249),
                                    ("Februaryin|during the <part-of-day>", -6.07073772800249),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.07073772800249),
                                    ("time-of-day (latent)July", -5.377590547442544),
                                    ("Saturdayyear (latent)", -6.07073772800249),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.07073772800249),
                                    ("<day-of-month> (ordinal)Monday", -5.154446996128335),
                                    ("at <time-of-day>on <day>", -5.154446996128335),
                                    ("absorption of , after named daySeptember",
                                     -4.817974759507122),
                                    ("Naraka Chaturdashiyear (latent)", -6.07073772800249),
                                    ("Easter Sundayyear (latent)", -5.665272619894325),
                                    ("Thursday<time-of-day> am|pm", -4.97212543933438),
                                    ("weekyear", -5.154446996128335),
                                    ("after <time>year (latent)", -6.07073772800249),
                                    ("time-of-day (latent)Thursday", -5.665272619894325),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.665272619894325),
                                    ("<day-of-month> (ordinal)April", -6.07073772800249),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.665272619894325),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.377590547442544),
                                    ("absorption of , after named dayFebruary", -5.154446996128335),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.665272619894325),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.07073772800249),
                                    ("tomorrowat <time-of-day>", -6.07073772800249),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.665272619894325),
                                    ("last <cycle> of <time>year (latent)", -5.665272619894325),
                                    ("tomorrow<time-of-day> am|pm", -6.07073772800249),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.665272619894325),
                                    ("Diwaliyear (latent)", -5.665272619894325),
                                    ("this <part-of-day>at <time-of-day>", -5.154446996128335),
                                    ("Fridayyear (latent)", -5.665272619894325),
                                    ("time-of-day (latent)<named-month> <day-of-month> (non ordinal)",
                                     -6.07073772800249),
                                    ("time-of-day (latent)April", -6.07073772800249),
                                    ("minuteyear", -3.930671564506219)],
                               n = 279}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13503628380394286,
                               ...
                               n = 249},
                   koData =
                     ClassData{prior = -2.0689702418125404, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5077439572285826, unseen = -5.262690188904886,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.564348191467836),
                                    ("dayhour", -4.1588830833596715),
                                    ("daymonth", -2.4849066497880004),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.564348191467836),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.311585222972468),
                                    ("Wednesdayintersect", -4.564348191467836),
                                    ("Labor Daythis|last|next <cycle>", -4.564348191467836),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.1780538303479458),
                                    ("Black Fridaythis|last|next <cycle>", -4.564348191467836),
                                    ("<part-of-day> of <time>February", -4.564348191467836),
                                    ("Saturday<time-of-day> am|pm", -4.564348191467836),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.1588830833596715),
                                    ("hourmonth", -4.564348191467836),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -3.871201010907891),
                                    ("dayday", -2.3130563928613412),
                                    ("WednesdayOctober", -4.564348191467836),
                                    ("Wednesdaythis|last|next <cycle>", -4.1588830833596715),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.311585222972468),
                                    ("dayyear", -3.311585222972468),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.564348191467836),
                                    ("Thursdayhh:mm", -4.1588830833596715),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.564348191467836),
                                    ("Memorial Daythis|last|next <cycle>", -4.564348191467836),
                                    ("TuesdayOctober", -4.564348191467836),
                                    ("Mondaythis|last|next <cycle>", -4.1588830833596715),
                                    ("Fridayintersect", -3.871201010907891),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.1588830833596715),
                                    ("intersectOctober", -4.1588830833596715),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.648057459593681),
                                    ("Tuesdaythis|last|next <cycle>", -4.564348191467836),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.564348191467836),
                                    ("dayminute", -2.772588722239781),
                                    ("minuteday", -3.311585222972468),
                                    ("this|last|next <cycle>Sunday", -4.564348191467836),
                                    ("Sundaythis|last|next <cycle>", -4.564348191467836),
                                    ("on <day><time-of-day> am|pm", -4.564348191467836),
                                    ("intersectintersect", -4.564348191467836),
                                    ("weekday", -4.564348191467836),
                                    ("dayweek", -3.4657359027997265),
                                    ("between <time> and <time>July", -4.564348191467836),
                               ...
                               n = 65},
                   koData =
                     ClassData{prior = -0.9209311114306573, unseen = -5.003946305945459,
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.304065093204169),
                                    ("week-endOctober", -3.6109179126442243),
                                    ("daymonth", -1.8191584434161694),
                                    ("TuesdaySeptember", -4.304065093204169),
                                    ...
                                    ("Fridaythis|last|next <cycle>", -4.304065093204169),
                                    ("SundayFebruary", -4.304065093204169),
                                    ("on <day>September", -3.6109179126442243),
                                    ("WednesdayOctober", -4.304065093204169),
                                    ("week-endintersect", -4.304065093204169),
                                    ("dayyear", -4.304065093204169),
                                    ("FridayJuly", -3.3877743613300146),
                                    ("FridaySeptember", -3.898599985096005),
                                    ("WednesdayFebruary", -4.304065093204169),
                                    ("minutemonth", -2.917770732084279),
                                    ("SundayMarch", -4.304065093204169),
                                    ("MondayFebruary", -3.898599985096005),
                                    ("Fridayintersect", -4.304065093204169),
                                    ("intersectOctober", -4.304065093204169),
                                    ("dayminute", -4.304065093204169),
                                    ("SaturdaySeptember", -4.304065093204169),
                                    ("intersectSeptember", -2.917770732084279),
                                    ("MondayMarch", -4.304065093204169),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -4.304065093204169),
                                    ("Tuesdayintersect", -4.304065093204169),
                                    ("Sundayintersect", -4.304065093204169)],
                               n = 43}}),
       ("last <time>",
        Classifier{okData =
