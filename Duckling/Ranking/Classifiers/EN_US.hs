...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.37802946291397677,
                               unseen = -7.168579897264035,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.474662003756499),
                                    ("Father's Dayyear (latent)", -6.474662003756499),
                                    ("Karva Chauthyear (latent)", -6.474662003756499),
                                    ("Maha Shivaratriyear (latent)", -6.474662003756499),
                                    ("Ramadanyear (latent)", -5.2218990352611305),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.376049715088389),
                                    ("Military Spouse Dayyear (latent)", -6.474662003756499),
                                    ("Bhai Doojyear (latent)", -6.474662003756499),
                                    ("hourday", -4.528751854701185),
                                    ("dayhour", -3.6414486597002824),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.376049715088389),
                                    ("Martin Luther King's Dayyear (latent)", -6.069196895648334),
                                    ("Shemini Atzeretyear (latent)", -6.474662003756499),
                                    ("daymonth", -5.2218990352611305),
                                    ("monthyear", -4.076766730958128),
                                    ("Yom Ha'atzmautyear (latent)", -6.474662003756499),
                                    ("Orthodox Good Fridayyear (latent)", -6.069196895648334),
                                    ("Vijayadashamiyear (latent)", -6.474662003756499),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.088367642636608),
                                    ("Thanksgiving Dayyear (latent)", -5.376049715088389),
                                    ("Thai Pongalyear (latent)", -5.781514823196553),
                                    ("Thiru Onamyear (latent)", -5.781514823196553),
                                    ("hhhmmabsorption of , after named day", -6.474662003756499),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5583712718823435),
                                    ("Krishna Janmashtamiyear (latent)", -6.069196895648334),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.474662003756499),
                                    ("houryear", -5.781514823196553),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.474662003756499),
                                    ("Christmas<time-of-day> am|pm", -6.474662003756499),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.474662003756499),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.781514823196553),
                                    ("<time-of-day> am|pmintersect", -5.2218990352611305),
                                    ("Earth Houryear (latent)", -6.474662003756499),
                                    ("Ganesh Chaturthiyear (latent)", -6.474662003756499),
                                    ("Octoberyear (latent)", -4.970584606980225),
                                    ("intersect<time-of-day> am|pm", -6.474662003756499),
                                    ("Mattu Pongalyear (latent)", -6.474662003756499),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.474662003756499),
                                    ("Daylight Saving Start Dayyear (latent)", -5.5583712718823435),
                                    ("Januaryyear (latent)", -6.069196895648334),
                                    ("Shavuotyear (latent)", -6.474662003756499),
                                    ("Parsi New Yearyear (latent)", -5.5583712718823435),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.474662003756499),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.474662003756499),
                                    ("todayin|within|after <duration>", -6.474662003756499),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.069196895648334),
                                    ("Marchyear (latent)", -6.069196895648334),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.069196895648334),
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.474662003756499),
                                    ("Sukkotyear (latent)", -6.069196895648334),
                                    ("hhhmmintersect", -6.069196895648334),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.474662003756499),
                                    ("since <time>year (latent)", -6.474662003756499),
                                    ("Daylight Saving End Dayyear (latent)", -5.5583712718823435),
                                    ("<time-of-day> o'clock<time> <part-of-day>",
                                     -6.069196895648334),
                                    ("Clean Mondayyear (latent)", -6.069196895648334),
                                    ("monthhour", -6.474662003756499),
                                    ("todayat <time-of-day>", -6.474662003756499),
                                    ("Thursday<time> timezone", -4.076766730958128),
                                    ("tonight<time-of-day> am|pm", -6.474662003756499),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.474662003756499),
                                    ("<time-of-day> am|pmon <day>", -4.4597589832142335),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.474662003756499),
                                    ("yyyy-mm-ddhh:mm:ss", -6.069196895648334),
                                    ("Tax Daythis|last|next <cycle>", -6.474662003756499),
                                    ("dayday", -4.1232867465930205),
                                    ("<time> <part-of-day>at <time-of-day>", -6.069196895648334),
                                    ("mm/ddat <time-of-day>", -6.474662003756499),
                                    ("tonightat <time-of-day>", -5.376049715088389),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.781514823196553),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.474662003756499),
                                    ("today<time-of-day> am|pm", -6.474662003756499),
                                    ("at <time-of-day><time> <part-of-day>", -6.474662003756499),
                                    ("mm/dd<time-of-day> am|pm", -6.474662003756499),
                                    ("hourhour", -4.032314968387294),
                                    ("Mahavir Jayantiyear (latent)", -6.069196895648334),
                                    ("Navaratriin|during <named-month>|year", -6.474662003756499),
                                    ("Wednesdaythis|last|next <cycle>", -6.474662003756499),
                                    ("Lentyear (latent)", -6.474662003756499),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.602859826854907),
                                    ("Boghiyear (latent)", -6.474662003756499),
                                    ("dayyear", -1.6706409590232418),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.474662003756499),
                                    ("<time-of-day> o'clocktomorrow", -6.069196895648334),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.474662003756499),
                                    ("Thursdayat <time-of-day>", -5.781514823196553),
                                    ("Islamic New Yearyear (latent)", -6.069196895648334),
                                    ("Laylat al-Qadryear (latent)", -5.5583712718823435),
                                    ("Aprilyear (latent)", -6.474662003756499),
                                    ("<day-of-month> (ordinal or number) of <named-month>year (latent)",
                                     -6.069196895648334),
                                    ("Shrove Tuesdayyear (latent)", -6.474662003756499),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.781514823196553),
                                    ("hourminute", -6.474662003756499),
                                    ("<time-of-day> am|pmtomorrow", -5.376049715088389),
                                    ("Yom Kippuryear (latent)", -6.474662003756499),
                                    ("<part-of-day> of <time>year (latent)", -6.474662003756499),
                                    ("minutehour", -5.376049715088389),
                                    ("Kaanum Pongalyear (latent)", -6.069196895648334),
                                    ("Maha Saptamiyear (latent)", -6.474662003756499),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.781514823196553),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.4597589832142335),
                                    ("for <duration> from <time>December", -6.474662003756499),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.474662003756499),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.2218990352611305),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.2218990352611305),
                                    ("Pentecostyear (latent)", -6.474662003756499),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.2218990352611305),
                                    ("Eid al-Fitryear (latent)", -5.088367642636608),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.474662003756499),
                                    ("Mini-Tuesday<duration> hence|ago", -6.474662003756499),
                                    ("Mondayin|during the <part-of-day>", -6.474662003756499),
                                    ("Chhathin|during <named-month>|year", -6.474662003756499),
                                    ("Diwaliin|during <named-month>|year", -6.474662003756499),
                                    ("this <part-of-day><time-of-day> am|pm", -6.474662003756499),
                                    ("Vaisakhiin|during <named-month>|year", -6.474662003756499),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.2218990352611305),
                                    ("Raksha Bandhanyear (latent)", -6.474662003756499),
                                    ("daysecond", -6.069196895648334),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.069196895648334),
                                    ("Februaryyear (latent)", -6.474662003756499),
                                    ("Emancipation Dayyear (latent)", -5.781514823196553),
                                    ("Ratha-Yatrayear (latent)", -6.474662003756499),
                                    ("Ashurayear (latent)", -6.474662003756499),
                                    ("Tuesdayin|during <named-month>|year", -6.474662003756499),
                                    ("Chinese New Yearyear (latent)", -6.474662003756499),
                                    ("Juneyear (latent)", -6.069196895648334),
                                    ("Lag BaOmeryear (latent)", -6.474662003756499),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.474662003756499),
                                    ("Eid al-Adhayear (latent)", -4.334595840260228),
                                    ("Palm Sundayyear (latent)", -6.474662003756499),
                                    ("Christmasat <time-of-day>", -6.474662003756499),
                                    ("Passoveryear (latent)", -6.474662003756499),
                                    ("Lazarus Saturdayyear (latent)", -6.474662003756499),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.474662003756499),
                                    ("the last <cycle> of <time>year (latent)", -5.781514823196553),
                                    ("Cyber Mondayyear (latent)", -6.069196895648334),
                                    ("hhhmmon <day>", -5.5583712718823435),
                                    ("Yom HaShoahyear (latent)", -6.069196895648334),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.474662003756499),
                                    ("Septemberyear (latent)", -6.069196895648334),
                                    ("Decemberyear (latent)", -6.069196895648334),
                                    ("Halloweenyear (latent)", -6.474662003756499),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.474662003756499),
                                    ("at <time-of-day>intersect", -5.5583712718823435),
                                    ("Rosh Hashanahyear (latent)", -5.781514823196553),
                                    ("Super Tuesdayyear (latent)", -5.5583712718823435),
                                    ("Dhanterasyear (latent)", -6.474662003756499),
                                    ("Tu BiShvatyear (latent)", -6.474662003756499),
                                    ("Holiyear (latent)", -5.781514823196553),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.474662003756499),
                                    ("Holika Dahanyear (latent)", -5.781514823196553),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.069196895648334),
                                    ("dayminute", -3.2759888862058175),
                                    ("Mawlidyear (latent)", -6.474662003756499),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.069196895648334),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.474662003756499),
                                    ("Jumu'atul-Widayear (latent)", -5.5583712718823435),
                                    ("minuteday", -2.7733600296440053),
                                    ("absorption of , after named dayintersect",
                                     -5.781514823196553),
                                    ("Orthodox Easter Sundayyear (latent)", -6.474662003756499),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.474662003756499),
                                    ("Mini-Tuesdayyear (latent)", -6.474662003756499),
                                    ("intersecthhhmm", -6.069196895648334),
                                    ("Boss's Dayyear (latent)", -6.069196895648334),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.474662003756499),
                                    ("Global Youth Service Dayyear (latent)", -6.474662003756499),
                                    ("Dhanterasin|during <named-month>|year", -6.474662003756499),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.474662003756499),
                                    ("tonight<time-of-day> o'clock", -6.474662003756499),
                                    ("Tisha B'Avyear (latent)", -6.474662003756499),
                                    ("Isra and Mi'rajyear (latent)", -5.5583712718823435),
                                    ("at <time-of-day>on <day>", -4.865224091322398),
                                    ("<day-of-month> (ordinal or number) of <month>year (latent)",
                                     -6.069196895648334),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.069196895648334),
                                    ("Christmasyear (latent)", -6.069196895648334),
                                    ("Naraka Chaturdashiyear (latent)", -6.069196895648334),
                                    ("Thai Pongalin|during <named-month>|year", -6.474662003756499),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.474662003756499),
                                    ("dayweek", -6.474662003756499),
                                    ("Easter Sundayyear (latent)", -5.781514823196553),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.069196895648334),
                                    ("weekyear", -5.376049715088389),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.474662003756499),
                                    ("King's Dayyear (latent)", -4.970584606980225),
                                    ("hh:mmin|during the <part-of-day>", -5.5583712718823435),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.069196895648334),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.781514823196553),
                                    ("Hanukkahyear (latent)", -5.781514823196553),
                                    ("Rama Navamiyear (latent)", -6.474662003756499),
                                    ("February<time> <part-of-day>", -6.474662003756499),
                                    ("National Grandparents Dayyear (latent)", -6.474662003756499),
                                    ("Great Lentyear (latent)", -6.474662003756499),
                                    ("tomorrowat <time-of-day>", -5.781514823196553),
                                    ("Labor Dayyear (latent)", -6.474662003756499),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.069196895648334),
                                    ("Ugadiyear (latent)", -5.088367642636608),
                                    ("Vaisakhiyear (latent)", -5.781514823196553),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.781514823196553),
                                    ("at <time-of-day>tomorrow", -6.069196895648334),
                                    ("tomorrow<time-of-day> am|pm", -6.474662003756499),
                                    ("President's Dayyear (latent)", -6.474662003756499),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.474662003756499),
                                    ("Diwaliyear (latent)", -6.474662003756499),
                                    ("between <time> and <time>on <day>", -6.069196895648334),
                                    ("Black Fridayyear (latent)", -6.069196895648334),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.474662003756499),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.474662003756499),
                                    ("Chhathyear (latent)", -6.069196895648334),
                                    ("Vasant Panchamiyear (latent)", -6.474662003756499),
                                    ("Tax Dayyear (latent)", -5.376049715088389),
                                    ("Rabindra Jayantiyear (latent)", -5.2218990352611305),
                                    ("this <part-of-day>at <time-of-day>", -5.2218990352611305),
                                    ("St Patrick's Dayyear (latent)", -6.474662003756499),
                                    ("Thursday<time> (timezone)", -6.474662003756499),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.474662003756499),
                                    ("the <day-of-month> (ordinal or number) of <month>year (latent)",
                                     -6.069196895648334),
                                    ("Pargat Diwasyear (latent)", -5.2218990352611305),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.781514823196553),
                                    ("Mother's Dayyear (latent)", -6.474662003756499),
                                    ("Simchat Torahyear (latent)", -6.474662003756499),
                                    ("minuteyear", -6.474662003756499)],
                               n = 505},
                   koData =
                     ClassData{prior = -1.1558505205230267, unseen = -6.62273632394984,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.424181074427915),
                                    ("hourday", -4.82964618253608), ("dayhour", -3.443351821416189),
                                    ("<time> timezoneyear (latent)", -5.235111290644244),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.011967739330035),
                                    ("after <time><time-of-day> am|pm", -5.928258471204189),
                                    ("daymonth", -3.485911435834985),
                                    ("monthday", -5.011967739330035),
                                    ...
                                    ("Good Fridayyear (latent)", -5.522793363096025),
                                    ("until <time>on <day>", -5.235111290644244),
                                    ("todayin <number> (implicit minutes)", -5.928258471204189),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -5.928258471204189),
                                    ("hh:mmon <day>", -4.675495502708821),
                                    ("hhhmmintersect", -5.522793363096025),
                                    ("absorption of , after named dayJuly", -5.011967739330035),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.011967739330035),
                                    ("Clean Mondayyear (latent)", -5.928258471204189),
                                    ("monthhour", -5.928258471204189),
                                    ("hourmonth", -5.011967739330035),
                                    ("todayat <time-of-day>", -5.928258471204189),
                                    ("since <time>until <time>", -5.928258471204189),
                                    ("hhhmmyear (latent)", -4.675495502708821),
                                    ("<time-of-day> am|pmon <day>", -4.675495502708821),
                                    ("Mondayyear (latent)", -4.82964618253608),
                                    ("dayday", -5.928258471204189),
                                    ("mm/ddat <time-of-day>", -5.522793363096025),
                                    ("on <day>September", -5.235111290644244),
                                    ("hourhour", -4.675495502708821),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -5.928258471204189),
                                    ("dayyear", -2.651113738212013),
                                    ("Thursdaymm/dd", -5.928258471204189),
                                    ("New Year's Dayyear (latent)", -5.011967739330035),
                                    ("Tuesdayyear (latent)", -4.82964618253608),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -5.522793363096025),
                                    ("Thursdayhh:mm", -5.011967739330035),
                                    ("minutemonth", -3.8488169295243533),
                                    ("Tuesdayin <number> (implicit minutes)", -5.928258471204189),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -5.928258471204189),
                                    ("Tuesdayin|during <named-month>|year", -5.928258471204189),
                                    ("Sundayyear (latent)", -5.011967739330035),
                                    ("Christmasat <time-of-day>", -5.928258471204189),
                                    ("the last <cycle> of <time>year (latent)", -5.522793363096025),
                                    ("hhhmmon <day>", -5.011967739330035),
                                    ("Julyuntil <time>", -5.522793363096025),
                                    ("yesterday<time-of-day> am|pm", -5.928258471204189),
                                    ("Tuesday<duration> hence|ago", -5.928258471204189),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.928258471204189),
                                    ("mm/ddyear (latent)", -5.928258471204189),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.928258471204189),
                                    ("Tuesdaythis|last|next <cycle>", -5.928258471204189),
                                    ("at <time-of-day>intersect", -5.011967739330035),
                                    ("hh:mmyear (latent)", -4.541964110084299),
                                    ("Holiyear (latent)", -5.928258471204189),
                                    ("until <time><time-of-day> am|pm", -5.928258471204189),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.522793363096025),
                                    ("dayminute", -3.2541098217776607),
                                    ...
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -5.928258471204189),
                                    ("intersectSeptember", -4.056456294302598),
                                    ("minuteday", -2.8602055360705725),
                                    ("absorption of , after named dayintersect",
                                     -5.928258471204189),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.928258471204189),
                                    ("Tuesdayafter <time>", -5.522793363096025),
                                    ("at <time-of-day>on <day>", -5.011967739330035),
                                    ...
                                    ("Thursday<time-of-day> am|pm", -4.82964618253608),
                                    ("weekyear", -5.522793363096025),
                                    ("after <time>year (latent)", -5.522793363096025),
                                    ...
                                    ("Fridayin|during <named-month>|year", -5.928258471204189),
                                    ...
                                    ("this <part-of-day>at <time-of-day>", -5.011967739330035),
                                    ("Fridayyear (latent)", -5.011967739330035),
                                    ("Tuesdayin|within|after <duration>", -5.928258471204189),
                                    ("Super Tuesdayafter <time>", -5.928258471204189),
                                    ("minuteyear", -3.7881923077079187)],
                               n = 232}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("the <cycle> of <time>",
        Classifier{okData =
                     ClassData{prior = -0.45198512374305727,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("yearyear", -2.5649493574615367),
                                    ("monthmonth", -2.5649493574615367),
                                    ("week (grain)<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -2.159484249353372),
                                    ("weekmonth", -2.5649493574615367),
                                    ("week (grain)October", -2.5649493574615367),
                                    ("month (grain)March", -2.5649493574615367),
                                    ("year (grain)year (latent)", -2.5649493574615367),
                                    ("week (grain)<named-month> <day-of-month> (non ordinal)",
                                     -2.159484249353372),
                                    ("weekday", -1.6486586255873816)],
                               n = 7},
                   koData =
                     ClassData{prior = -1.0116009116784799, unseen = -3.044522437723423,
                               likelihoods =
                                 HashMap.fromList
                                   [("second (grain) March", -2.3025850929940455),
                                    ("weekmonth", -2.3025850929940455),
                                    ("week (grain)October", -2.3025850929940455),
                                    ("secondmonth", -1.6094379124341003),
                                    ("second (grain) this|last|next <cycle>", -1.8971199848858813)],
                               n = 4}}),
       ("number.number hours",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
