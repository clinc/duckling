...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5171883175538194, unseen = -6.338594078203183,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 564},
                   koData =
                     ClassData{prior = -0.906821960445303, unseen = -5.950642552587727,
       ...
       ("in|during <named-month>|year",
        Classifier{okData =
                     ClassData{prior = -0.2076393647782445, unseen = -4.07753744390572,
                               likelihoods =
                                 HashMap.fromList
                                   [("<year> (bc|ad)", -2.268683541318364),
                                    ("October", -3.367295829986474),
                                    ("year (latent)", -1.2272296664902034),
                                    ("year", -0.9694005571881036), ("March", -2.451005098112319),
                                    ("month", -2.268683541318364)],
                               n = 26},
                   koData =
       ...
       ("from <datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.7975071958841881, unseen = -5.117993812416755,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -3.7256934272366524),
                                    ("monthday", -3.16607763930123),
                                    ("at the beginning|end of <named-month>June",
                                     -3.7256934272366524),
                                    ("hh:mmtime-of-day (latent)", -4.013375499688434),
                                    ("the <day-of-month> (ordinal or number) of <month>the <day-of-month> (number)",
                                     -4.418840607796598),
                                    ("minuteminute", -3.5025498759224427),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)<day-of-month> (ordinal)",
                                     -4.418840607796598),
                                    ("monthmonth", -4.013375499688434),
                                    ("<time-of-day> am|pmtime-of-day (latent)", -4.418840607796598),
                                    ("hourhour", -4.013375499688434),
                                    ...
                                    ("the <day-of-month> (ordinal or number) of <month>the <day-of-month> (ordinal)",
                                     -4.418840607796598),
                                    ("at the beginning|end of <named-month>at the beginning|end of <named-month>",
                                     -3.16607763930123),
                                    ("<time-of-day> am|pm<time-of-day> am|pm", -4.418840607796598),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)<named-month> <day-of-month> (non ordinal)",
                                     -4.418840607796598),
                                    ("yearday", -3.5025498759224427),
                                    ("the <day-of-month> (ordinal or number) of <named-month>the <day-of-month> (ordinal)",
                                     -4.418840607796598),
                                    ("year (latent)at the beginning|end of <named-month>",
                                     -3.5025498759224427),
                                    ("Mayat the beginning|end of <named-month>", -3.16607763930123),
                                    ("MayJune", -4.013375499688434),
                                    ("<day-of-month> (ordinal)the <day-of-month> (number)",
                                     -4.418840607796598)],
                               n = 50},
                   koData =
                     ClassData{prior = -0.5986563371390228, unseen = -5.241747015059643,
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> (ordinal)the <day-of-month> (ordinal or number) of <month>",
                                     -4.137829674161839),
                                    ("hourday", -2.597384633214691),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -3.8501476017100584),
                                    ("dayhour", -3.2905318137746358),
                                    ("daymonth", -3.6270040503958487),
                                    ...
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -4.543294782270004),
                                    ("hh:mmtime-of-day (latent)", -3.6270040503958487),
                                    ("hh:mm<time-of-day> am|pm", -4.137829674161839),
                                    ("minuteminute", -3.6270040503958487),
                                    ("time-of-day (latent)time-of-day (latent)",
                                     -3.6270040503958487),
                                    ("hh:mmhh:mm", -4.543294782270004),
                                    ("dayday", -2.0583881324820035),
                                    ("the <day-of-month> (ordinal)the <day-of-month> (number)",
                                     -4.137829674161839),
                                    ("the <day-of-month> (number)the <day-of-month> (number)",
                                     -4.543294782270004),
                                    ...
                                    ("<day-of-month> (ordinal)<day-of-month> (ordinal or number) of <month>",
                                     -4.137829674161839),
                                    ("time-of-day (latent)<time-of-day> am|pm", -4.543294782270004),
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.11307714461897077,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.105340919783238e-2),
                                    ("intersect 2 numbers", -4.276666119016055)],
                               n = 284},
                   koData =
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -1.6094379124341003,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("at the beginning|end of <year>", -1.6094379124341003),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.49469624183610705,
                               ...
                               n = 125},
                   koData =
                     ClassData{prior = -0.9409833444645266, unseen = -4.418840607796598,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -5.001042057466142e-2),
                                    ("integer (0..19)", -3.0204248861443626)],
                               n = 80}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
       ...
       ("<time-of-day> am|pm",
        Classifier{okData =
                     ClassData{prior = -0.25050306921002685,
                               unseen = -5.683579767338681,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer after|past <hour-of-day>", -4.293878247897177),
                                    ("at <time-of-day>", -2.3479680988418634),
                                    ("<time-of-day> o'clock", -4.581560320348958),
                                    ("half after|past <hour-of-day>", -4.581560320348958),
                                    ("second", -4.581560320348958),
                                    ("hh:mm:ss", -4.581560320348958),
                                    ("<hour-of-day> <integer>", -4.070734696582967),
                                    ("<integer> minutes to|till|before <hour-of-day>",
                                     -4.987025428457122),
                                    ("time-of-day (latent)", -1.691188562452793),
                                    ("hhmm (latent)", -4.581560320348958),
                                    ("hh:mm", -2.3479680988418634),
                                    ("quarter after|past <hour-of-day>", -3.482948031680848),
                                    ("until <time>", -4.581560320348958),
                                    ("about|exactly <time-of-day>", -4.581560320348958),
                                    ("since <time>", -4.987025428457122),
                                    ("hour", -1.2981459743431856),
                                    ("<time-of-day> sharp|exactly", -4.987025428457122),
                                    ("minute", -1.6371213411825172)],
                               n = 137},
                   koData =
                     ClassData{prior = -1.5069223489085053, unseen = -4.584967478670572,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.188416617383492),
                                    ("at <time-of-day>", -3.4760986898352733),
                                    ("time-of-day (latent)", -1.1089750757036563),
                                    ("hh:mm", -3.4760986898352733),
                                    ("until <time>", -3.8815637979434374),
                                    ("hour", -1.019362917013969), ("minute", -2.782951509275328)],
                               n = 39}}),
       ("Yom Ha'atzmaut",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("year (latent)", -1.0986122886681098),
                                    ("this|last|next <cycle>", -1.6582280766035324),
                                    ("year", -0.7419373447293773)],
                               n = 9},
                   koData =
       ...
       ("until <time>",
        Classifier{okData =
                     ClassData{prior = -2.0794415416798357, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                                   [("year (latent)", -2.6026896854443837),
                                    ("time-of-day (latent)", -2.6026896854443837),
                                    ("year", -2.6026896854443837),
                                    ("<time-of-day> am|pm", -2.1972245773362196),
                                    ("hh:mm", -2.6026896854443837), ("hour", -2.1972245773362196),
                   ...
                   koData =
                     ClassData{prior = -0.13353139262452263,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("July", -3.7727609380946383),
                                    ("intersect", -2.856470206220483),
                                    ("yesterday", -3.367295829986474), ("day", -1.6933193964148026),
                                    ("the <day-of-month> (ordinal)", -3.7727609380946383),
                                    ("the <day-of-month> (number)", -3.7727609380946383),
                                    ("June", -3.079613757534693),
                                    ("time-of-day (latent)", -2.386466576974748),
                                    ("<time-of-day> am|pm", -3.7727609380946383),
                                    ("hh:mm", -2.856470206220483), ("hour", -2.1633230256605382),
                                    ("month", -2.856470206220483),
                                    ("at the beginning|end of <named-month>", -2.068012845856213),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -3.7727609380946383),
                                    ("minute", -2.386466576974748)],
                               n = 35}}),
       ...
       ("<datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.8132914924020085, unseen = -4.976733742420574,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -3.58351893845611),
                                    ("monthday", -2.667228206581955),
                                    ("at the beginning|end of <named-month>June",
                                     -3.58351893845611),
                                    ("minuteminute", -2.0794415416798357),
                                    ("<time> timezone<time> timezone", -3.58351893845611),
                                    ("hh:mmhh:mm", -2.772588722239781),
                                    ("dayday", -2.404863942114464),
                                    ("monthmonth", -3.871201010907891),
                                    ("hhhmmhhhmm", -3.3603753871419),
                                    ("hourhour", -3.871201010907891),
                                    ("<named-month> <day-of-month> (non ordinal)<named-month> <day-of-month> (non ordinal)",
                                     -3.1780538303479458),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -3.871201010907891),
                                    ("<time-of-day> am|pmhh:mm:ss", -4.276666119016055),
                                    ("at the beginning|end of <named-month>at the beginning|end of <named-month>",
                                     -3.0239031505206873),
                                    ("hoursecond", -3.871201010907891),
                                    ("<time-of-day> am|pm<time-of-day> am|pm", -3.58351893845611),
                                    ("since <time><named-month> <day-of-month> (non ordinal)",
                                     -4.276666119016055),
                                    ("Mayat the beginning|end of <named-month>",
                                     -2.667228206581955),
                                    ("MayJune", -3.871201010907891)],
                               n = 47},
                   koData =
                     ClassData{prior = -0.5859016502063478,
                               unseen = -5.1298987149230735,
                               likelihoods =
                                 HashMap.fromList
                                   [("hhhmm<time> timezone", -4.02535169073515),
                                    ("<time> timezonehhhmm", -4.02535169073515),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -3.5145260669691587),
                                    ("daymonth", -2.7260687066048885),
                                    ("<time-of-day> am|pm<time-of-day> - <time-of-day> (interval)",
                                     -4.02535169073515),
                                    ("monthday", -3.7376696182833684),
                                    ("Super TuesdayMarch", -4.430816798843313),
                                    ("TuesdayTax Day", -4.430816798843313),
                                    ("<time-of-day> am|pmintersect", -4.430816798843313),
                                    ("MondayOctober", -4.02535169073515),
                                    ("hh:mm<time-of-day> am|pm", -3.332204510175204),
                                    ("hhhmmintersect", -4.430816798843313),
                                    ("minuteminute", -2.1795250002368185),
                                    ("hh:mmhh:mm", -3.7376696182833684),
                                    ("dayday", -2.1795250002368185),
                                    ("monthmonth", -3.7376696182833684),
                                    ("hhhmmhhhmm", -4.02535169073515),
                                    ("hourhour", -4.430816798843313),
                                    ("Super Tuesdayintersect by \",\", \"of\", \"from\" for year",
                                     -4.430816798843313),
                                    ("hourminute", -3.7376696182833684),
                                    ("TuesdayMarch", -4.430816798843313),
                                    ("minutehour", -3.7376696182833684),
                                    ("<time> timezonehh:mm", -4.430816798843313),
                                    ("hh:mm<time> timezone", -4.430816798843313),
                                    ("Super Tuesday<named-month> <day-of-month> (non ordinal)",
                                     -4.430816798843313),
                                    ("hh:mmintersect", -3.5145260669691587),
                                    ("since <time>July", -4.430816798843313),
                                    ("Super Tuesdayintersect", -4.430816798843313),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -4.430816798843313),
                                    ("Christmastoday", -3.7376696182833684),
                                    ("Super TuesdayMini-Tuesday", -3.7376696182833684),
                                    ...
                                    ("Tuesday<named-month> <day-of-month> (non ordinal)",
                                     -4.430816798843313),
                                    ("Super Tuesdaythe nth <time> of <time>", -4.430816798843313),
                                    ("Super TuesdayTax Day", -4.430816798843313),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.430816798843313),
                                    ("Mayat the beginning|end of <named-month>",
                                     -3.7376696182833684),
                                    ("MayJune", -3.7376696182833684),
                                    ("Tuesdaythe nth <time> of <time>", -4.430816798843313)],
                               n = 59}}),
       ("Tuesday",
        Classifier{okData =
       ...
       ("at the beginning|end of <named-month>",
        Classifier{okData =
                     ClassData{prior = -2.6668247082161294e-2,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("January", -3.283414346005772), ("May", -1.817077277212345),
                                    ("April", -3.283414346005772), ("June", -1.2909841813155656),
                                    ("month", -0.7444404749474959)],
                               n = 37},
                   koData =
                     ClassData{prior = -3.6375861597263857,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("October", -1.3862943611198906),
                                    ("month", -1.3862943611198906)],
                               n = 1}}),
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -1.1700712526502546, unseen = -4.406719247264253,
                               likelihoods =
                                 HashMap.fromList
                   ...
                   koData =
                     ClassData{prior = -0.37156355643248296,
                               unseen = -4.997212273764115,
                               likelihoods =
                                 HashMap.fromList
                                   [("hhhmm<time> timezone", -3.891820298110627),
                                    ("<time> timezonehhhmm", -3.891820298110627),
                                    ("until <time>time-of-day (latent)", -3.1986731175506815),
                                    ("hh:mmtime-of-day (latent)", -2.2178438645389553),
                                    ("hh:mm<time-of-day> am|pm", -2.9109910450989003),
                                    ("minuteminute", -2.3513752571634776),
                                    ("hh:mmhh:mm", -3.6041382256588457),
                                    ("<time-of-day> am|pmtime-of-day (latent)", -3.891820298110627),
                                    ("hhhmmhhhmm", -3.891820298110627),
                                    ("at <time-of-day><time-of-day> am|pm", -4.297285406218791),
                                    ("hourhour", -2.1572192427225203),
                                    ("hourminute", -4.297285406218791),
                                    ("minutehour", -1.55644538229359),
                                    ("<time> timezonehh:mm", -4.297285406218791),
                                    ("hh:mm<time> timezone", -4.297285406218791),
                                    ("hhhmmtime-of-day (latent)", -3.6041382256588457),
                                    ("until <time><time-of-day> am|pm", -4.297285406218791),
                                    ("<time-of-day> am|pmhh:mm", -4.297285406218791),
                                    ("<part-of-day> at <time-of-day>time-of-day (latent)",
                                     -3.6041382256588457),
                                    ("at <time-of-day>time-of-day (latent)", -3.380994674344636),
                                    ("<time> timezonetime-of-day (latent)", -3.6041382256588457),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -3.2771447329921766),
                                    ...
                                    ("at the beginning|end of <named-month>June",
                                     -3.2771447329921766),
                                    ("minuteminute", -2.871679624884012),
                                    ("hh:mmhh:mm", -3.2771447329921766),
                                    ("dayday", -2.3608540011180215),
                                    ("monthmonth", -3.2771447329921766),
                                    ("<time-of-day> am|pmtime-of-day (latent)",
                                     -3.2771447329921766),
                                    ("hhhmmhhhmm", -3.2771447329921766),
                                    ("<named-month> <day-of-month> (non ordinal)<named-month> <day-of-month> (non ordinal)",
                                     -3.2771447329921766),
                                    ...
                                    ("at the beginning|end of <named-month>at the beginning|end of <named-month>",
                                     -2.871679624884012),
                                    ("<time-of-day> am|pm<time-of-day> am|pm", -3.2771447329921766),
                                    ("yearday", -3.2771447329921766),
                                    ("year (latent)at the beginning|end of <named-month>",
                                     -3.2771447329921766),
                                    ("Mayat the beginning|end of <named-month>",
                                     -2.871679624884012),
                                    ("MayJune", -3.2771447329921766)],
                               n = 13},
                   koData =
                     ClassData{prior = -0.9650808960435872, unseen = -3.784189633918261,
                               likelihoods =
                                 HashMap.fromList
                                   [("<named-month> <day-of-month> (non ordinal)July",
                                     -3.068052935133617),
                                    ...
                                    ("the <day-of-month> (ordinal)<day-of-month> (ordinal or number) of <named-month>",
                                     -3.068052935133617),
                                    ("hh:mmtime-of-day (latent)", -3.068052935133617),
                                    ("hhhmmintersect", -3.068052935133617),
                                    ("minuteminute", -2.662587827025453),
                                    ("dayday", -2.662587827025453),
                                    ("the <day-of-month> (ordinal)time-of-day (latent)",
                                     -3.068052935133617),
                                    ("minutehour", -2.662587827025453),
                                    ("hh:mmintersect", -3.068052935133617),
                                    ("hhhmmtime-of-day (latent)", -3.068052935133617)],
                               n = 8}}),
        ...
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.1823215567939546, unseen = -2.772588722239781,
                               likelihoods =
                                 HashMap.fromList
                                   [("hh:mm:ssintersect", -2.0149030205422647),
                                    ("minuteminute", -1.0986122886681098),
                                    ("secondsecond", -2.0149030205422647),
