...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5530583873892636, unseen = -6.133398042996649,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 459},
                   koData =
                     ClassData{prior = -0.8561084900693585, unseen = -5.831882477283517,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.7346010553881064), ("second", -3.2386784521643803),
                                    ...
                                    ("<> <unit-of-duration>", -1.0986122886681098)],
                               n = 21},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.0149030205422647), ("year", -1.6094379124341003),
                                    ("<> <unit-of-duration>", -1.3217558399823195)],
                               n = 3}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -1.3862943611198906),
                                    ...
                                    ("<> <unit-of-duration><time-of-day> am|pm",
                                     -0.9808292530117262)],
                               n = 2},
                   koData =
                     ClassData{prior = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -1.3862943611198906),
                                    ("yearhour", -1.3862943611198906),
                                    ("<> <unit-of-duration>time-of-day (latent)",
                                     -0.9808292530117262)],
                               n = 2}}),
       ("Maha Shivaratri",
        Classifier{okData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.456735772821304), ("second", -2.639057329615259),
                                    ...
                                    ("<> <unit-of-duration>", -0.7827593392496325)],
                               n = 31},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hour", -1.6094379124341003),
                                    ("<> <unit-of-duration>", -1.6094379124341003)],
                               n = 1}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.70805020110221), ("quarter", -2.70805020110221),
                                    ...
                                    ("<> <unit-of-duration>", -1.791759469228055)],
                               n = 6}}),
       ("January",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("dayyear", -0.6931471805599453),
                                    ("Diwali<> <unit-of-duration>", -0.6931471805599453)],
                               n = 1},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.0986122886681098,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.46672204104272635,
                               unseen = -7.1631723908466425,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.4692503167957724),
                                    ("Karva Chauthyear (latent)", -6.4692503167957724),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4692503167957724),
                                    ("Maha Shivaratriyear (latent)", -6.4692503167957724),
                                    ("Ramadanyear (latent)", -5.216487348300404),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.082955955675882),
                                    ("Bhai Doojyear (latent)", -6.4692503167957724),
                                    ("hourday", -4.454347296253507), ("dayhour", -3.44882543065141),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.082955955675882),
                                    ("Martin Luther King's Dayyear (latent)", -6.063785208687608),
                                    ("Shemini Atzeretyear (latent)", -6.4692503167957724),
                                    ("daymonth", -4.454347296253507),
                                    ("monthday", -6.063785208687608),
                                    ("monthyear", -4.677490847567718),
                                    ("Yom Ha'atzmautyear (latent)", -6.4692503167957724),
                                    ("Vijayadashamiyear (latent)", -6.4692503167957724),
                                    ("Thai Pongalyear (latent)", -5.776103136235827),
                                    ("Thiru Onamyear (latent)", -5.776103136235827),
                                    ("hhhmmabsorption of , after named day", -6.4692503167957724),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.4692503167957724),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.552959584921617),
                                    ("<day-of-month> (ordinal)Wednesday", -6.4692503167957724),
                                    ("Krishna Janmashtamiyear (latent)", -6.063785208687608),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.4692503167957724),
                                    ("houryear", -5.552959584921617),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.4692503167957724),
                                    ("Christmas<time-of-day> am|pm", -6.4692503167957724),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.4692503167957724),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.776103136235827),
                                    ("intersectin|during <named-month>|year", -6.4692503167957724),
                                    ("<time-of-day> am|pmintersect", -5.216487348300404),
                                    ("Earth Houryear (latent)", -6.4692503167957724),
                                    ("Ganesh Chaturthiyear (latent)", -6.4692503167957724),
                                    ("Octoberyear (latent)", -4.965172920019499),
                                    ("intersect<time-of-day> am|pm", -6.4692503167957724),
                                    ("Mattu Pongalyear (latent)", -6.4692503167957724),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.4692503167957724),
                                    ("Shavuotyear (latent)", -6.4692503167957724),
                                    ("Parsi New Yearyear (latent)", -5.552959584921617),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.4692503167957724),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.4692503167957724),
                                    ("todayin|within|after <duration>", -6.4692503167957724),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.063785208687608),
                                    ("Marchyear (latent)", -6.4692503167957724),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.063785208687608),
                                    ("Sukkotyear (latent)", -6.063785208687608),
                                    ("hhhmmintersect", -6.063785208687608),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.063785208687608),
                                    ("Clean Mondayyear (latent)", -6.063785208687608),
                                    ("monthhour", -6.063785208687608),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.776103136235827),
                                    ("todayat <time-of-day>", -6.4692503167957724),
                                    ("Thursday<time> timezone", -4.071355043997402),
                                    ("tonight<time-of-day> am|pm", -6.4692503167957724),
                                    ("time-of-day (latent)tonight", -6.063785208687608),
                                    ("from|since|after <time>December", -6.4692503167957724),
                                    ("<time-of-day> am|pmon <day>", -4.454347296253507),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.4692503167957724),
                                    ("yyyy-mm-ddhh:mm:ss", -6.063785208687608),
                                    ("dayday", -3.7612001156935624),
                                    ("<time> <part-of-day>at <time-of-day>", -6.063785208687608),
                                    ("tonightat <time-of-day>", -5.3706380281276624),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.776103136235827),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.4692503167957724),
                                    ("today<time-of-day> am|pm", -6.4692503167957724),
                                    ("Februarythe <day-of-month> (ordinal)", -6.063785208687608),
                                    ("at <time-of-day><time> <part-of-day>", -6.4692503167957724),
                                    ("<day-of-month> (ordinal)intersect", -6.063785208687608),
                                    ("hourhour", -3.4988358512260715),
                                    ("Mahavir Jayantiyear (latent)", -6.063785208687608),
                                    ("Navaratriin|during <named-month>|year", -6.4692503167957724),
                                    ("Wednesdaythis|last|next <cycle>", -6.4692503167957724),
                                    ("Lentyear (latent)", -6.4692503167957724),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.597448139894181),
                                    ("Boghiyear (latent)", -6.4692503167957724),
                                    ("dayyear", -1.9259555345257686),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.4692503167957724),
                                    ("Thursdayfrom|since|after <time>", -6.063785208687608),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.4692503167957724),
                                    ("Thursdayat <time-of-day>", -5.776103136235827),
                                    ("Islamic New Yearyear (latent)", -6.063785208687608),
                                    ("Laylat al-Qadryear (latent)", -5.552959584921617),
                                    ("part of days<time-of-day> am|pm", -6.4692503167957724),
                                    ("Shrove Tuesdayyear (latent)", -6.4692503167957724),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.776103136235827),
                                    ("hourminute", -6.063785208687608),
                                    ("<time-of-day> am|pmtomorrow", -5.776103136235827),
                                    ("Yom Kippuryear (latent)", -6.4692503167957724),
                                    ("<day-of-month> (ordinal)Tuesday", -6.063785208687608),
                                    ("<part-of-day> of <time>year (latent)", -6.4692503167957724),
                                    ("minutehour", -5.216487348300404),
                                    ("Kaanum Pongalyear (latent)", -6.063785208687608),
                                    ("Maha Saptamiyear (latent)", -6.4692503167957724),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.776103136235827),
                                    ("time-of-day (latent)tomorrow", -5.552959584921617),
                                    ("part of daysat <time-of-day>", -4.859812404361672),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.454347296253507),
                                    ("for <duration> from <time>December", -6.4692503167957724),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.4692503167957724),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.216487348300404),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.216487348300404),
                                    ("time-of-day (latent)this <part-of-day>", -6.4692503167957724),
                                    ("Pentecostyear (latent)", -6.4692503167957724),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.216487348300404),
                                    ("<day-of-month> (ordinal)February", -6.4692503167957724),
                                    ("Eid al-Fitryear (latent)", -5.082955955675882),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.4692503167957724),
                                    ("Mondayin|during the <part-of-day>", -6.4692503167957724),
                                    ("Chhathin|during <named-month>|year", -6.4692503167957724),
                                    ("Diwaliin|during <named-month>|year", -6.4692503167957724),
                                    ("this <part-of-day><time-of-day> am|pm", -6.4692503167957724),
                                    ("Vaisakhiin|during <named-month>|year", -6.4692503167957724),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.216487348300404),
                                    ("Raksha Bandhanyear (latent)", -6.4692503167957724),
                                    ("daysecond", -6.063785208687608),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.063785208687608),
                                    ("Ratha-Yatrayear (latent)", -6.4692503167957724),
                                    ("Ashurayear (latent)", -6.4692503167957724),
                                    ("Tuesdayin|during <named-month>|year", -6.4692503167957724),
                                    ("Chinese New Yearyear (latent)", -6.4692503167957724),
                                    ("tomorrowintersect", -6.4692503167957724),
                                    ("Lag BaOmeryear (latent)", -6.4692503167957724),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.4692503167957724),
                                    ("Eid al-Adhayear (latent)", -4.329184153299502),
                                    ("intersectin|during the <part-of-day>", -6.4692503167957724),
                                    ("Palm Sundayyear (latent)", -6.4692503167957724),
                                    ("Christmasat <time-of-day>", -6.4692503167957724),
                                    ("Passoveryear (latent)", -6.4692503167957724),
                                    ("Lazarus Saturdayyear (latent)", -6.4692503167957724),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.4692503167957724),
                                    ("the last <cycle> of <time>year (latent)", -5.776103136235827),
                                    ("hhhmmon <day>", -5.552959584921617),
                                    ("Yom HaShoahyear (latent)", -6.063785208687608),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.063785208687608),
                                    ("Septemberyear (latent)", -6.063785208687608),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.965172920019499),
                                    ("Halloweenyear (latent)", -6.4692503167957724),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.4692503167957724),
                                    ("at <time-of-day>intersect", -5.552959584921617),
                                    ("Rosh Hashanahyear (latent)", -5.776103136235827),
                                    ("Dhanterasyear (latent)", -6.4692503167957724),
                                    ("Tu BiShvatyear (latent)", -6.4692503167957724),
                                    ("<day-of-month> (ordinal)December", -5.776103136235827),
                                    ("Holiyear (latent)", -5.776103136235827),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.4692503167957724),
                                    ("Holika Dahanyear (latent)", -5.776103136235827),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.063785208687608),
                                    ("dayminute", -3.1550643121232467),
                                    ("Mawlidyear (latent)", -6.4692503167957724),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.063785208687608),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.4692503167957724),
                                    ("Jumu'atul-Widayear (latent)", -5.552959584921617),
                                    ("minuteday", -2.731580698512404),
                                    ("absorption of , after named dayintersect",
                                     -5.776103136235827),
                                    ("intersectyear (latent)", -6.4692503167957724),
                                    ("Orthodox Easter Sundayyear (latent)", -6.4692503167957724),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.4692503167957724),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.4692503167957724),
                                    ("intersecthhhmm", -6.063785208687608),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.4692503167957724),
                                    ("Boss's Dayyear (latent)", -6.063785208687608),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.4692503167957724),
                                    ("Global Youth Service Dayyear (latent)", -6.4692503167957724),
                                    ("Dhanterasin|during <named-month>|year", -6.4692503167957724),
                                    ("tonight<time-of-day> o'clock", -6.4692503167957724),
                                    ("Tisha B'Avyear (latent)", -6.4692503167957724),
                                    ("Isra and Mi'rajyear (latent)", -5.552959584921617),
                                    ("at <time-of-day>on <day>", -4.859812404361672),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.063785208687608),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.776103136235827),
                                    ("Christmasyear (latent)", -6.063785208687608),
                                    ("Saturdayintersect", -6.4692503167957724),
                                    ("Naraka Chaturdashiyear (latent)", -6.063785208687608),
                                    ("Thai Pongalin|during <named-month>|year",
                                     -6.4692503167957724),
                                    ("dayweek", -6.4692503167957724),
                                    ("Easter Sundayyear (latent)", -5.776103136235827),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.063785208687608),
                                    ("weekyear", -5.216487348300404),
                                    ("King's Dayyear (latent)", -4.965172920019499),
                                    ("hh:mmin|during the <part-of-day>", -5.552959584921617),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.063785208687608),
                                    ("Hanukkahyear (latent)", -5.776103136235827),
                                    ("Rama Navamiyear (latent)", -6.4692503167957724),
                                    ("February<time> <part-of-day>", -6.4692503167957724),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.776103136235827),
                                    ("Great Lentyear (latent)", -6.4692503167957724),
                                    ("tomorrowat <time-of-day>", -5.776103136235827),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.4692503167957724),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.063785208687608),
                                    ("Ugadiyear (latent)", -5.082955955675882),
                                    ("Vaisakhiyear (latent)", -5.776103136235827),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.776103136235827),
                                    ("last <cycle> of <time>year (latent)", -5.776103136235827),
                                    ("at <time-of-day>tomorrow", -6.063785208687608),
                                    ("tomorrow<time-of-day> am|pm", -6.4692503167957724),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.4692503167957724),
                                    ("Diwaliyear (latent)", -6.4692503167957724),
                                    ("between <time> and <time>on <day>", -6.063785208687608),
                                    ("Black Fridayyear (latent)", -6.063785208687608),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.4692503167957724),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.4692503167957724),
                                    ("Chhathyear (latent)", -6.063785208687608),
                                    ("Vasant Panchamiyear (latent)", -6.4692503167957724),
                                    ("Rabindra Jayantiyear (latent)", -5.216487348300404),
                                    ("this <part-of-day>at <time-of-day>", -5.216487348300404),
                                    ("St Patrick's Dayyear (latent)", -6.4692503167957724),
                                    ("Thursday<time> (timezone)", -6.4692503167957724),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.4692503167957724),
                                    ("Pargat Diwasyear (latent)", -5.216487348300404),
                                    ("<datetime> - <datetime> (interval)July", -6.063785208687608),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.776103136235827),
                                    ("Februaryintersect", -6.4692503167957724),
                                    ("Simchat Torahyear (latent)", -6.4692503167957724),
                                    ("minuteyear", -6.4692503167957724)],
                               n = 496},
                   koData =
                     ClassData{prior = -0.986322611427834, unseen = -6.790097235513905,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.591747165655951),
                                    ("hourday", -3.697929289633854),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.095824562432225),
                                    ("<day-of-month> (ordinal)August", -6.095824562432225),
                                    ("dayhour", -3.493134876987841),
                                    ("<time> timezoneyear (latent)", -5.402677381872279),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.17953383055807),
                                    ("after <time><time-of-day> am|pm", -6.095824562432225),
                                    ("Tuesdayfrom|since|after <time>", -5.402677381872279),
                                    ("daymonth", -3.421675913005696),
                                    ("hourquarter", -6.095824562432225),
                                    ("monthyear", -4.843061593936857),
                                    ("<time-of-day> am|pmyear (latent)", -5.402677381872279),
                                    ("time-of-day (latent)qq", -6.095824562432225),
                                    ("Thai Pongalyear (latent)", -5.402677381872279),
                                    ("intersecthh:mm", -6.095824562432225),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.69035945432406),
                                    ("<day-of-month> (ordinal)Wednesday", -6.095824562432225),
                                    ("houryear", -4.709530201312334),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.095824562432225),
                                    ("<day-of-month> (ordinal)October", -6.095824562432225),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.402677381872279),
                                    ("hournograin", -4.843061593936857),
                                    ("<time-of-day> am|pmintersect", -4.843061593936857),
                                    ("Octoberyear (latent)", -6.095824562432225),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69035945432406),
                                    ("early morningat <time-of-day>", -6.095824562432225),
                                    ("until <time>on <day>", -5.402677381872279),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.095824562432225),
                                    ("time-of-day (latent)intersect", -5.402677381872279),
                                    ("todayin <number> (implicit minutes)", -6.095824562432225),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.402677381872279),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.095824562432225),
                                    ("hh:mmon <day>", -4.843061593936857),
                                    ("hhhmmintersect", -5.69035945432406),
                                    ("absorption of , after named dayJuly", -5.17953383055807),
                                    ("from|since|after <time>July", -5.69035945432406),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.17953383055807),
                                    ("Clean Mondayyear (latent)", -6.095824562432225),
                                    ("monthhour", -6.095824562432225),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69035945432406),
                                    ("hourmonth", -4.224022385530633),
                                    ("todayat <time-of-day>", -6.095824562432225),
                                    ("hhhmmyear (latent)", -4.843061593936857),
                                    ("from|since|after <time>December", -6.095824562432225),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.095824562432225),
                                    ("<time-of-day> am|pmon <day>", -4.843061593936857),
                                    ("Mondayyear (latent)", -5.402677381872279),
                                    ("dayday", -4.08092154188996),
                                    ("on <day>September", -5.402677381872279),
                                    ("time-of-day (latent)September", -5.69035945432406),
                                    ("hourhour", -4.0163830207523885),
                                    ("time-of-day (latent)on <day>", -4.591747165655951),
                                    ("Thursdaydd/mm", -6.095824562432225),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.69035945432406),
                                    ("dayyear", -3.1513855832657844),
                                    ("New Year's Dayyear (latent)", -5.17953383055807),
                                    ("time-of-day (latent)Sunday", -5.69035945432406),
                                    ("Thursdayfrom|since|after <time>", -4.391076470193799),
                                    ("Thursdayat <time-of-day>", -4.486386649998124),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.095824562432225),
                                    ("Aprilyear (latent)", -6.095824562432225),
                                    ("the <day-of-month> (ordinal)July", -6.095824562432225),
                                    ("the <day-of-month> (number)July", -6.095824562432225),
                                    ("monthminute", -6.095824562432225),
                                    ("<time-of-day> am|pmtomorrow", -6.095824562432225),
                                    ("Thursdayhh:mm", -5.17953383055807),
                                    ("<day-of-month> (ordinal)Tuesday", -5.69035945432406),
                                    ("minutemonth", -3.955758398935954),
                                    ("time-of-day (latent)Friday", -5.69035945432406),
                                    ("minutehour", -6.095824562432225),
                                    ("part of daysat <time-of-day>", -4.997212273764115),
                                    ("Augustyear (latent)", -5.69035945432406),
                                    ("week-endin|during <named-month>|year", -6.095824562432225),
                                    ("time-of-day (latent)Tuesday", -5.69035945432406),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.095824562432225),
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.095824562432225),
                                    ("Sundayyear (latent)", -5.17953383055807),
                                    ("the <day-of-month> (ordinal)Monday", -5.402677381872279),
                                    ("Christmasat <time-of-day>", -6.095824562432225),
                                    ("from|since|after <time>year (latent)", -4.997212273764115),
                                    ("the last <cycle> of <time>year (latent)", -5.69035945432406),
                                    ("hhhmmon <day>", -5.17953383055807),
                                    ("yesterday<time-of-day> am|pm", -6.095824562432225),
                                    ("<day-of-month> (ordinal)July", -5.402677381872279),
                                    ...
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.095824562432225),
                                    ("at <time-of-day>intersect", -5.17953383055807),
                                    ("hh:mmyear (latent)", -4.709530201312334),
                                    ("Holiyear (latent)", -6.095824562432225),
                                    ("until <time><time-of-day> am|pm", -6.095824562432225),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.69035945432406),
                                    ("dayminute", -3.2626112183760085),
                                    ("yyyy-mm-ddhh:mm", -5.69035945432406),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.095824562432225),
                                    ("intersectfrom|since|after <time>", -5.69035945432406),
                                    ("intersectSeptember", -4.224022385530633),
                                    ("minuteday", -2.9388241412821117),
                                    ("absorption of , after named dayintersect",
                                     -6.095824562432225),
                                    ("intersectyear (latent)", -6.095824562432225),
                                    ("Februaryin|during the <part-of-day>", -6.095824562432225),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.095824562432225),
                                    ("time-of-day (latent)July", -5.402677381872279),
                                    ("Saturdayyear (latent)", -6.095824562432225),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.095824562432225),
                                    ("<day-of-month> (ordinal)Monday", -5.17953383055807),
                                    ("at <time-of-day>on <day>", -5.17953383055807),
                                    ("absorption of , after named daySeptember",
                                     -4.843061593936857),
                                    ("Naraka Chaturdashiyear (latent)", -6.095824562432225),
                                    ("from|since|after <time>on <day>", -5.17953383055807),
                                    ("dayweek", -6.095824562432225),
                                    ("Easter Sundayyear (latent)", -5.69035945432406),
                                    ("Thursday<time-of-day> am|pm", -4.843061593936857),
                                    ("weekyear", -5.17953383055807),
                                    ("after <time>year (latent)", -6.095824562432225),
                                    ("time-of-day (latent)Thursday", -5.69035945432406),
                                    ("<day-of-month> (ordinal)April", -6.095824562432225),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.69035945432406),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.402677381872279),
                                    ("Sundayfrom|since|after <time>", -6.095824562432225),
                                    ("absorption of , after named dayFebruary", -5.17953383055807),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.69035945432406),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.095824562432225),
                                    ("tomorrowat <time-of-day>", -6.095824562432225),
                                    ("daynograin", -5.69035945432406),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.69035945432406),
                                    ("last <cycle> of <time>year (latent)", -5.69035945432406),
                                    ("tomorrow<time-of-day> am|pm", -6.095824562432225),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.402677381872279),
                                    ("Diwaliyear (latent)", -5.69035945432406),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.095824562432225),
                                    ("this <part-of-day>at <time-of-day>", -5.17953383055807),
                                    ("Fridayyear (latent)", -5.69035945432406),
                                    ("time-of-day (latent)April", -6.095824562432225),
                                    ("minuteyear", -3.898599985096005)],
                               n = 295}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.15280206195596474, unseen = -5.37989735354046,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 212},
                   koData =
                     ClassData{prior = -1.9540402751385635,
                               unseen = -3.6888794541139363,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.466337068793427),
                                    ("negative numbers", -0.44468582126144557),
       ...
       ("<time> for <duration>",
        Classifier{okData =
                     ClassData{prior = -0.15415067982725836,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect<> <unit-of-duration>", -2.1400661634962708),
                                    ("minuteminute", -2.833213344056216),
                                    ("dayday", -1.4469189829363254),
                                    ("hourminute", -1.916922612182061),
                                    ("<time-of-day> am|pm<> <unit-of-duration>",
                                     -2.1400661634962708),
                                    ("<day-of-month> (ordinal or number) <named-month><> <unit-of-duration>",
                                     -2.4277482359480516),
                                    ("from|since|after <time><> <unit-of-duration>",
                                     -2.1400661634962708),
                                    ("hhhmm<> <unit-of-duration>", -2.833213344056216)],
                               n = 12},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("monthday", -1.540445040947149),
                                    ("December<> <unit-of-duration>", -1.540445040947149)],
                               n = 2}}),
       ("hhhmm",
        Classifier{okData =
       ...
       ("from <time> for <duration>",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.4849066497880004,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect<> <unit-of-duration>", -1.7047480922384253),
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.25131442828090605,
                               ...
                               n = 84},
                   koData =
                     ClassData{prior = -1.5040773967762742, unseen = -4.110873864173311,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.6147565466142225, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 126},
                   koData =
                     ClassData{prior = -0.7782096191037944, unseen = -4.700480365792417,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -7.622736538788426e-2),
                                    ("integer (0..19)", -2.6119063405493077)],
                               n = 107}}),
       ("beginning of year",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("a <unit-of-duration>now", -3.481240089335692),
                                    ...
                                    ("<> <unit-of-duration>hhhmm", -3.481240089335692),
                                    ("daysecond", -3.481240089335692),
                                    ("a <unit-of-duration>right now", -3.481240089335692),
                                    ("minutenograin", -3.481240089335692),
                                    ("<> <unit-of-duration>now", -3.0757749812275272),
                                    ("secondnograin", -3.481240089335692),
                                    ("<> <unit-of-duration>noon|midnight|EOD|end of day",
                                     -3.481240089335692),
                                    ("yearday", -2.7880929087757464),
                                    ("daynograin", -3.481240089335692),
                                    ("<> <unit-of-duration>time-of-day (latent)",
                                     -2.382627800667582),
                                    ("<> <unit-of-duration>today", -3.481240089335692),
                                    ("<> <unit-of-duration>Easter Sunday", -3.481240089335692),
                                    ("<> <unit-of-duration>Christmas", -3.481240089335692)],
                               n = 19},
                   koData =
                     ClassData{prior = -0.6225296133459919, unseen = -4.276666119016055,
                               likelihoods =
                                 HashMap.fromList
                                   [("<> <unit-of-duration>intersect", -3.56953269648137),
                                    ("quarterhour", -1.318240897874875),
                                    ("<> <unit-of-duration><day-of-month> (ordinal)",
                                     -3.56953269648137),
                                    ...
                                    ("<> <unit-of-duration><day-of-month> (ordinal or number) <named-month>",
                                     -3.56953269648137),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -1.2992829841302609),
                                    ...
                                    ("Vijayadashami<> <unit-of-duration>", -1.7047480922384253),
                                    ("March<> <unit-of-duration>", -1.7047480922384253)],
                               n = 3},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.791759469228055,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ...
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -1.0986122886681098, unseen = -4.672828834461907,
                               likelihoods =
                                 HashMap.fromList
                   ...
                   koData =
                     ClassData{prior = -0.40546510810816444,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hhhmm<time> timezone", -4.0943445622221),
                                    ("<time> timezonehhhmm", -4.0943445622221),
                                    ("about|exactly <time-of-day>time-of-day (latent)",
                                     -4.499809670330265),
                                    ("until <time>time-of-day (latent)", -3.4011973816621555),
                                    ("from|since|after <time>hh:mm", -4.499809670330265),
                                    ("hh:mmtime-of-day (latent)", -2.4849066497880004),
                                    ("hh:mm<time-of-day> am|pm", -3.247046701834897),
                                    ("minuteminute", -2.4203681286504293),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -3.58351893845611),
                                    ("hh:mmhh:mm", -3.8066624897703196),
                                    ("<time-of-day> am|pmtime-of-day (latent)", -4.0943445622221),
                                    ("hhhmmhhhmm", -4.0943445622221),
                                    ("hourhour", -2.1019143975318944),
                                    ("from|since|after <time><integer> to|till|before <hour-of-day>",
                                     -3.8066624897703196),
                                    ("hourminute", -3.4011973816621555),
                                    ("minutehour", -1.666596326274049),
                                    ("<time> timezonehh:mm", -4.499809670330265),
                                    ("hh:mm<time> timezone", -4.499809670330265),
                                    ("hhhmmtime-of-day (latent)", -3.8066624897703196),
                                    ("until <time><time-of-day> am|pm", -4.499809670330265),
                                    ("about|exactly <time-of-day><time-of-day> am|pm",
                                     -4.499809670330265),
                                    ("<time-of-day> am|pmhh:mm", -4.499809670330265),
                                    ("<part-of-day> at <time-of-day>time-of-day (latent)",
                                     -3.8066624897703196),
                                    ("from|since|after <time>time-of-day (latent)",
                                     -2.995732273553991),
                                    ("at <time-of-day>time-of-day (latent)", -3.8066624897703196),
                                    ("<time> timezonetime-of-day (latent)", -3.8066624897703196),
       ...
       ("for <duration> from <time>",
        Classifier{okData =
                     ClassData{prior = -0.3364722366212129, unseen = -2.995732273553991,
                               likelihoods =
                                 HashMap.fromList
                                   [("<> <unit-of-duration>intersect", -2.2512917986064953),
                                    ("<> <unit-of-duration><day-of-month> (ordinal)",
                                     -2.2512917986064953),
