                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.6094379124341003), ("day", -1.8971199848858813),
                                    ("year", -2.3025850929940455), ("month", -2.3025850929940455),
                                    ("<> <unit-of-duration>", -0.916290731874155)],
                               n = 7},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("hour", -1.3862943611198906),
                                    ("<> <unit-of-duration>", -1.3862943611198906)],
                               n = 1}}),
       ("evening|night",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.3025850929940455,
       ...
       ("<duration> from now",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.0794415416798357,
                               likelihoods =
                                 HashMap.fromList
                                   [("year", -1.252762968495368), ("minute", -1.252762968495368),
                                    ("<> <unit-of-duration>", -0.8472978603872037)],
                               n = 2},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.3862943611198906,
                               likelihoods = HashMap.fromList [], n = 0}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.9704144655697013),
                                    ...
                                    ("year", -3.6635616461296463), ("hour", -2.4107986776342782),
                                    ("month", -3.6635616461296463), ("minute", -1.5234954826333758),
                                    ("about <duration>", -3.6635616461296463),
                                    ("<> <unit-of-duration>", -1.221214610760442)],
                               n = 33},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("quarter of an hourtime-of-day (latent)", -2.0149030205422647),
                                    ...
                                    ("<> <unit-of-duration>now", -2.0149030205422647),
                                    ("quarter of an hour<time> <part-of-day>", -2.0149030205422647),
                                    ("yearday", -2.0149030205422647),
                                    ("<> <unit-of-duration>christmas", -2.0149030205422647)],
                               n = 4},
                   koData =
                     ClassData{prior = -infinity, unseen = -2.0794415416798357,
                               likelihoods = HashMap.fromList [], n = 0}}),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.9444389791664407),
                                    ...
                                    ("year", -3.6375861597263857), ("hour", -2.384823191231018),
                                    ("month", -3.6375861597263857), ("minute", -1.55814461804655),
                                    ("about <duration>", -3.6375861597263857),
                                    ("<> <unit-of-duration>", -1.2396908869280152)],
                               n = 32},
                   koData =
