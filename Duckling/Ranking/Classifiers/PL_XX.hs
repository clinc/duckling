...
classifiers
  = HashMap.fromList
      [("five",
       ...
       ("<time> <part-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.8292793548845253,
                               ...
                               n = 48},
                   koData =
                     ClassData{prior = -0.5733459807473247, unseen = -5.117993812416755,
                               likelihoods =
                                 HashMap.fromList
                                   [("<ordinal> (as hour)after <time-of-day>", -4.418840607796598),
                                    ("dayhour", -2.020945334998227),
                                    ("yearhour", -2.1162555148025524),
                                    ("year (latent)on <date>", -4.418840607796598),
                                    ("<day-of-month> (ordinal)on <date>", -4.418840607796598),
                                    ("nograinhour", -3.16607763930123),
                                    ("<time-of-day> - <time-of-day> (interval)morning",
                                     -4.418840607796598),
                                    ("<day-of-month> (ordinal)evening|night", -2.7140925155581725),
                                    ("by the end of <time>morning", -4.418840607796598),
                                    ("year (latent)evening|night", -3.16607763930123),
                                    ("hourhour", -2.278774444300327),
                                    ("after <time-of-day>after <time-of-day>", -4.013375499688434),
                                    ("<day-of-month> (ordinal)morning", -4.013375499688434),
                                    ("<day-of-month> (ordinal)after <time-of-day>",
                                     -3.3202283191284883),
                                    ("until <time-of-day>morning", -4.418840607796598),
                                    ("about <time-of-day>after <time-of-day>", -4.418840607796598),
                                    ("by <time>morning", -4.418840607796598),
                                    ("<integer> (latent time-of-day)after <time-of-day>",
                                     -4.013375499688434),
                                    ("<integer> (latent time-of-day)morning", -3.3202283191284883),
                                    ("intersectmorning", -3.16607763930123),
                                    ("from <datetime> - <datetime> (interval)morning",
                                     -3.7256934272366524),
                                    ("year (latent)morning", -2.7140925155581725),
                                    ("year (latent)after <time-of-day>", -4.013375499688434),
                                    ("at <time-of-day>after <time-of-day>", -4.418840607796598)],
                               n = 62}}),
       ("today",
        Classifier{okData =
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.3051171342738824, unseen = -6.278521424165844,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 199},
                   koData =
                     ClassData{prior = -1.3357420819570593,
                               unseen = -5.6240175061873385,
                               likelihoods =
                                 HashMap.fromList
                                   [("Tuesdayon <date>", -4.927253685157205),
                                    ("<time-of-day> ranoby <time>", -4.5217885770490405),
                                    ("Julyrelative minutes to|till|before <integer> (hour-of-day)",
                                     -4.927253685157205),
                                    ("dayhour", -3.4231762883809305),
                                    ("daymonth", -2.624668592163159),
                                    ("monthyear", -4.01096295328305),
                                    ("Wednesdayintersect", -4.5217885770490405),
                                    ("<time> <part-of-day>until <time-of-day>",
                                     -4.5217885770490405),
                                    ("hournograin", -3.0554515082556133),
                                    ("Marchyear", -4.23410650459726),
                                    ("Wednesdayon <date>", -4.927253685157205),
                                    ("absorption of , after named dayJuly", -4.927253685157205),
                                    ("<time> <part-of-day><time> <part-of-day>", -4.23410650459726),
                                    ("mm/ddat <time-of-day>", -4.927253685157205),
                                    ("hourhour", -4.01096295328305),
                                    ("<time> <part-of-day>by <time>", -4.5217885770490405),
                                    ("dayyear", -3.6744907166618366),
                                    ("<time-of-day> ranoby the end of <time>", -4.5217885770490405),
                                    ("Thursday<time> <part-of-day>", -4.927253685157205),
                                    ("<named-month> <day-of-month> (non ordinal)until <time-of-day>",
                                     -4.927253685157205),
                                    ("monthminute", -4.927253685157205),
                                    ("minutemonth", -4.23410650459726),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.5217885770490405),
                                    ("Aprilyear", -4.927253685157205),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect by \",\"",
                                     -4.5217885770490405),
                                    ("after <time-of-day>at <time-of-day>", -4.927253685157205),
                                    ("SundayMarch", -4.927253685157205),
                                    ("hh:mmby the end of <time>", -4.927253685157205),
                                    ("minutenograin", -4.5217885770490405),
                                    ("<time> <part-of-day>by the end of <time>",
                                     -4.5217885770490405),
                                    ("<time> <part-of-day><time-of-day> rano", -4.927253685157205),
                                    ("<time-of-day> rano<time> <part-of-day>", -4.5217885770490405),
                                    ("at <time-of-day>intersect", -4.927253685157205),
                                    ("<named-month> <day-of-month> (non ordinal)by <time>",
                                     -4.927253685157205),
                                    ("intersectyear", -3.6744907166618366),
                                    ("intersectSeptember", -4.23410650459726),
                                    ("minuteday", -3.2225055929187794),
                                    ("hh:mmon <date>", -4.5217885770490405),
                                    ("at <time-of-day>intersect by \",\"", -4.927253685157205),
                                    ("MondayMarch", -4.927253685157205),
                                    ("<named-month> <day-of-month> (non ordinal)by the end of <time>",
                                     -4.927253685157205),
                                    ("tomorrowexactly <time-of-day>", -4.927253685157205),
                                    ("absorption of , after named daySeptember",
                                     -4.927253685157205),
                                    ("hh:mmon a named-day", -4.5217885770490405),
                                    ("Sundayon <date>", -4.5217885770490405),
                                    ("absorption of , after named dayFebruary", -3.828641396489095),
                                    ("hh:mmby <time>", -4.927253685157205),
                                    ("tomorrowat <time-of-day>", -4.927253685157205),
                                    ("daynograin", -4.5217885770490405),
                                    ("<time-of-day> popo\322udniu/wieczorem/w nocyintersect",
                                     -4.5217885770490405),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("minuteminute", -2.0794415416798357),
                                    ("<time-of-day> rano<time-of-day> rano", -2.4849066497880004),
                                    ...
                                    ("<time-of-day> rano<integer> (latent time-of-day)",
                                     -2.4849066497880004),
                                    ("hh:mm<integer> (latent time-of-day)", -2.4849066497880004)],
                               n = 5},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<time> <part-of-day><integer> (latent time-of-day)",
                                     -2.538973871058276),
                                    ("houryear", -2.9444389791664407),
                                    ("minuteminute", -2.538973871058276),
                                    ("<time> <part-of-day><time> <part-of-day>",
                                     -2.2512917986064953),
                                    ("hourhour", -1.4403615823901665),
                                    ("minutehour", -2.9444389791664407),
                                    ("hh:mmintersect", -2.538973871058276),
                                    ("<time> <part-of-day>year (latent)", -2.9444389791664407),
                                    ("<time> <part-of-day><time-of-day> rano", -2.538973871058276),
                                    ("<time-of-day> rano<time> <part-of-day>", -2.9444389791664407),
                                    ("hh:mm<integer> (latent time-of-day)", -2.9444389791664407)],
                               n = 12}}),
       ("Saturday",
        Classifier{okData =
       ...
       ("<datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -1.3437347467010947, unseen = -3.367295829986474,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<named-month> <day-of-month> (non ordinal)July",
                                     -3.2188758248682006),
                                    ("daymonth", -2.8134107167600364),
                                    ("about <time-of-day>noon", -3.2188758248682006),
                                    ("minuteminute", -2.120263536200091),
                                    ("<time> <part-of-day><time> <part-of-day>",
                                     -2.5257286443082556),
                                    ("<time-of-day> rano<time-of-day> rano", -3.2188758248682006),
                                    ("until <time-of-day>noon", -3.2188758248682006),
                                    ("hh:mmhh:mm", -3.2188758248682006),
                                    ("hourhour", -1.5141277326297755),
                                    ("hh:mmintersect", -2.3025850929940455),
                                    ("<time> <part-of-day><time-of-day> rano", -2.8134107167600364),
                                    ("at <time-of-day>noon", -3.2188758248682006),
                                    ("<time-of-day> rano<time> <part-of-day>", -3.2188758248682006),
