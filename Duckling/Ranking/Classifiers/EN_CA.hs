...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5459303348501685, unseen = -6.248042874508429,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 515},
                   koData =
                     ClassData{prior = -0.8658414380993726, unseen = -5.929589143389895,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4670810748031337, unseen = -7.201170883281678,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.507277712385012),
                                    ("Father's Dayyear (latent)", -6.507277712385012),
                                    ("Karva Chauthyear (latent)", -6.507277712385012),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("Maha Shivaratriyear (latent)", -6.507277712385012),
                                    ("Ramadanyear (latent)", -5.254514743889644),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.408665423716902),
                                    ("Bhai Doojyear (latent)", -6.507277712385012),
                                    ("hourday", -4.492374691842747),
                                    ("dayhour", -3.5628387332185714),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.408665423716902),
                                    ("Martin Luther King's Dayyear (latent)", -6.101812604276847),
                                    ("Shemini Atzeretyear (latent)", -6.507277712385012),
                                    ("daymonth", -4.715518243156957),
                                    ("monthyear", -4.204692619390966),
                                    ("Yom Ha'atzmautyear (latent)", -6.507277712385012),
                                    ("Orthodox Good Fridayyear (latent)", -6.101812604276847),
                                    ("Vijayadashamiyear (latent)", -6.507277712385012),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.101812604276847),
                                    ("Thanksgiving Dayyear (latent)", -5.408665423716902),
                                    ("Thai Pongalyear (latent)", -5.814130531825066),
                                    ("Thiru Onamyear (latent)", -5.814130531825066),
                                    ("hhhmmabsorption of , after named day", -6.507277712385012),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5909869805108565),
                                    ("<day-of-month> (ordinal)Wednesday", -6.507277712385012),
                                    ("Krishna Janmashtamiyear (latent)", -6.101812604276847),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.507277712385012),
                                    ("houryear", -5.5909869805108565),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.507277712385012),
                                    ("Christmas<time-of-day> am|pm", -6.507277712385012),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.507277712385012),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.814130531825066),
                                    ("intersectin|during <named-month>|year", -6.507277712385012),
                                    ("<time-of-day> am|pmintersect", -5.254514743889644),
                                    ("Earth Houryear (latent)", -6.507277712385012),
                                    ("Ganesh Chaturthiyear (latent)", -6.507277712385012),
                                    ("Family Dayyear (latent)", -5.5909869805108565),
                                    ("Octoberyear (latent)", -5.003200315608738),
                                    ("intersect<time-of-day> am|pm", -6.507277712385012),
                                    ("Mattu Pongalyear (latent)", -6.507277712385012),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.507277712385012),
                                    ("Januaryyear (latent)", -6.507277712385012),
                                    ("Shavuotyear (latent)", -6.507277712385012),
                                    ("Parsi New Yearyear (latent)", -5.5909869805108565),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.507277712385012),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.507277712385012),
                                    ("todayin|within|after <duration>", -6.507277712385012),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.101812604276847),
                                    ("Marchyear (latent)", -6.101812604276847),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.101812604276847),
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("Sukkotyear (latent)", -6.101812604276847),
                                    ("hhhmmintersect", -6.101812604276847),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.101812604276847),
                                    ("since <time>year (latent)", -6.507277712385012),
                                    ("Clean Mondayyear (latent)", -6.101812604276847),
                                    ("monthhour", -6.101812604276847),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.5909869805108565),
                                    ("todayat <time-of-day>", -6.507277712385012),
                                    ("Thursday<time> timezone", -4.109382439586641),
                                    ("tonight<time-of-day> am|pm", -6.507277712385012),
                                    ("time-of-day (latent)tonight", -6.101812604276847),
                                    ("<time-of-day> am|pmon <day>", -4.492374691842747),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.507277712385012),
                                    ("yyyy-mm-ddhh:mm:ss", -6.101812604276847),
                                    ("dayday", -3.7664376884598108),
                                    ("<time> <part-of-day>at <time-of-day>", -6.101812604276847),
                                    ("mm/ddat <time-of-day>", -6.507277712385012),
                                    ("tonightat <time-of-day>", -5.408665423716902),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.814130531825066),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.507277712385012),
                                    ("today<time-of-day> am|pm", -6.507277712385012),
                                    ("at <time-of-day><time> <part-of-day>", -6.507277712385012),
                                    ("<day-of-month> (ordinal)intersect", -6.101812604276847),
                                    ("mm/dd<time-of-day> am|pm", -6.507277712385012),
                                    ("hourhour", -3.5368632468153107),
                                    ("Mahavir Jayantiyear (latent)", -6.101812604276847),
                                    ("Navaratriin|during <named-month>|year", -6.507277712385012),
                                    ("National Patriots' Dayyear (latent)", -5.814130531825066),
                                    ("Wednesdaythis|last|next <cycle>", -6.507277712385012),
                                    ("Lentyear (latent)", -6.507277712385012),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.635475535483421),
                                    ("Boghiyear (latent)", -6.507277712385012),
                                    ("dayyear", -1.8344488779231054),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.507277712385012),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("Thursdayat <time-of-day>", -5.814130531825066),
                                    ("Islamic New Yearyear (latent)", -6.101812604276847),
                                    ("Laylat al-Qadryear (latent)", -5.5909869805108565),
                                    ("Aprilyear (latent)", -6.507277712385012),
                                    ("part of days<time-of-day> am|pm", -6.507277712385012),
                                    ("Discovery Dayyear (latent)", -6.101812604276847),
                                    ("Shrove Tuesdayyear (latent)", -6.507277712385012),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.814130531825066),
                                    ("hourminute", -6.101812604276847),
                                    ("<time-of-day> am|pmtomorrow", -5.5909869805108565),
                                    ("Yom Kippuryear (latent)", -6.507277712385012),
                                    ("<day-of-month> (ordinal)Tuesday", -5.814130531825066),
                                    ("<part-of-day> of <time>year (latent)", -6.507277712385012),
                                    ("minutehour", -5.254514743889644),
                                    ("Kaanum Pongalyear (latent)", -6.101812604276847),
                                    ("Maha Saptamiyear (latent)", -6.507277712385012),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.814130531825066),
                                    ("time-of-day (latent)tomorrow", -5.5909869805108565),
                                    ("part of daysat <time-of-day>", -4.897839799950911),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.492374691842747),
                                    ("for <duration> from <time>December", -6.507277712385012),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.507277712385012),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.254514743889644),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.254514743889644),
                                    ("time-of-day (latent)this <part-of-day>", -6.507277712385012),
                                    ("Pentecostyear (latent)", -6.507277712385012),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.254514743889644),
                                    ("<day-of-month> (ordinal)February", -6.507277712385012),
                                    ("Eid al-Fitryear (latent)", -5.120983351265121),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.507277712385012),
                                    ("Mondayin|during the <part-of-day>", -6.507277712385012),
                                    ("Chhathin|during <named-month>|year", -6.507277712385012),
                                    ("Diwaliin|during <named-month>|year", -6.507277712385012),
                                    ("this <part-of-day><time-of-day> am|pm", -6.507277712385012),
                                    ("Vaisakhiin|during <named-month>|year", -6.507277712385012),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.254514743889644),
                                    ("Raksha Bandhanyear (latent)", -6.507277712385012),
                                    ("daysecond", -6.101812604276847),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.101812604276847),
                                    ("Ratha-Yatrayear (latent)", -6.507277712385012),
                                    ("Ashurayear (latent)", -6.507277712385012),
                                    ("Tuesdayin|during <named-month>|year", -6.507277712385012),
                                    ("Chinese New Yearyear (latent)", -6.507277712385012),
                                    ("tomorrowintersect", -6.507277712385012),
                                    ("Juneyear (latent)", -6.101812604276847),
                                    ("Lag BaOmeryear (latent)", -6.507277712385012),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.507277712385012),
                                    ("Eid al-Adhayear (latent)", -4.367211548888741),
                                    ("Palm Sundayyear (latent)", -6.507277712385012),
                                    ("Christmasat <time-of-day>", -6.507277712385012),
                                    ("Passoveryear (latent)", -6.507277712385012),
                                    ("Lazarus Saturdayyear (latent)", -6.507277712385012),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.507277712385012),
                                    ("the last <cycle> of <time>year (latent)", -5.814130531825066),
                                    ("hhhmmon <day>", -5.5909869805108565),
                                    ("Yom HaShoahyear (latent)", -6.101812604276847),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("Septemberyear (latent)", -6.101812604276847),
                                    ("Decemberyear (latent)", -6.101812604276847),
                                    ("Halloweenyear (latent)", -6.507277712385012),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.507277712385012),
                                    ("at <time-of-day>intersect", -5.5909869805108565),
                                    ("Rosh Hashanahyear (latent)", -5.814130531825066),
                                    ("Dhanterasyear (latent)", -6.507277712385012),
                                    ("Tu BiShvatyear (latent)", -6.507277712385012),
                                    ("<day-of-month> (ordinal)December", -5.814130531825066),
                                    ("Holiyear (latent)", -5.814130531825066),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.507277712385012),
                                    ("Holika Dahanyear (latent)", -5.814130531825066),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.101812604276847),
                                    ("dayminute", -3.3086045948343306),
                                    ("Mawlidyear (latent)", -6.507277712385012),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.101812604276847),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.507277712385012),
                                    ("Jumu'atul-Widayear (latent)", -5.5909869805108565),
                                    ("minuteday", -2.8059757382725183),
                                    ("absorption of , after named dayintersect",
                                     -5.814130531825066),
                                    ("intersectyear (latent)", -6.507277712385012),
                                    ("Orthodox Easter Sundayyear (latent)", -6.507277712385012),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.507277712385012),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.507277712385012),
                                    ("intersecthhhmm", -6.101812604276847),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("Boss's Dayyear (latent)", -6.101812604276847),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.507277712385012),
                                    ("Global Youth Service Dayyear (latent)", -6.507277712385012),
                                    ("Dhanterasin|during <named-month>|year", -6.507277712385012),
                                    ("tonight<time-of-day> o'clock", -6.507277712385012),
                                    ("Tisha B'Avyear (latent)", -6.507277712385012),
                                    ("Isra and Mi'rajyear (latent)", -5.5909869805108565),
                                    ("at <time-of-day>on <day>", -4.897839799950911),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.101812604276847),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.814130531825066),
                                    ("Christmasyear (latent)", -6.101812604276847),
                                    ("Saturdayintersect", -6.507277712385012),
                                    ("Naraka Chaturdashiyear (latent)", -6.101812604276847),
                                    ("Thai Pongalin|during <named-month>|year", -6.507277712385012),
                                    ("dayweek", -6.507277712385012),
                                    ("Easter Sundayyear (latent)", -5.814130531825066),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.101812604276847),
                                    ("Labour Dayyear (latent)", -6.507277712385012),
                                    ("weekyear", -5.254514743889644),
                                    ("King's Dayyear (latent)", -5.003200315608738),
                                    ("hh:mmin|during the <part-of-day>", -5.5909869805108565),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.101812604276847),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.814130531825066),
                                    ("Hanukkahyear (latent)", -5.814130531825066),
                                    ("Rama Navamiyear (latent)", -6.507277712385012),
                                    ("February<time> <part-of-day>", -6.507277712385012),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.814130531825066),
                                    ("Great Lentyear (latent)", -6.507277712385012),
                                    ("tomorrowat <time-of-day>", -5.814130531825066),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.101812604276847),
                                    ("Ugadiyear (latent)", -5.120983351265121),
                                    ("Vaisakhiyear (latent)", -5.814130531825066),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.814130531825066),
                                    ("last <cycle> of <time>year (latent)", -5.814130531825066),
                                    ("at <time-of-day>tomorrow", -6.101812604276847),
                                    ("tomorrow<time-of-day> am|pm", -6.507277712385012),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.507277712385012),
                                    ("Diwaliyear (latent)", -6.507277712385012),
                                    ("between <time> and <time>on <day>", -6.101812604276847),
                                    ("Black Fridayyear (latent)", -6.101812604276847),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.507277712385012),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.507277712385012),
                                    ("Chhathyear (latent)", -6.101812604276847),
                                    ("Vasant Panchamiyear (latent)", -6.507277712385012),
                                    ("Rabindra Jayantiyear (latent)", -5.254514743889644),
                                    ("this <part-of-day>at <time-of-day>", -5.254514743889644),
                                    ("St Patrick's Dayyear (latent)", -6.507277712385012),
                                    ("Thursday<time> (timezone)", -6.507277712385012),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.507277712385012),
                                    ("Pargat Diwasyear (latent)", -5.254514743889644),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.814130531825066),
                                    ("Februaryintersect", -6.507277712385012),
                                    ("Mother's Dayyear (latent)", -6.507277712385012),
                                    ("Simchat Torahyear (latent)", -6.507277712385012),
                                    ("Victoria Dayyear (latent)", -6.101812604276847),
                                    ("minuteyear", -6.507277712385012)],
                               n = 514},
                   koData =
                     ClassData{prior = -0.985719238305918, unseen = -6.829793737512425,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.631487494305465),
                                    ("hourday", -3.4614162416552103),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.135564891081739),
                                    ("<day-of-month> (ordinal)August", -6.135564891081739),
                                    ("dayhour", -3.6506582412937383),
                                    ("<time> timezoneyear (latent)", -5.442417710521793),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.2192741592075835),
                                    ("after <time><time-of-day> am|pm", -6.135564891081739),
                                    ("daymonth", -3.3947248671565378),
                                    ("hourquarter", -5.0369526024136295),
                                    ("monthday", -5.2192741592075835),
                                    ("monthyear", -4.882801922586371),
                                    ("<time-of-day> am|pmyear (latent)", -5.442417710521793),
                                    ("time-of-day (latent)qq", -6.135564891081739),
                                    ("Thai Pongalyear (latent)", -5.442417710521793),
                                    ("intersecthh:mm", -6.135564891081739),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.730099782973574),
                                    ("<day-of-month> (ordinal)Wednesday", -6.135564891081739),
                                    ("houryear", -4.430816798843313),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.135564891081739),
                                    ("Julyintersect", -5.442417710521793),
                                    ("<day-of-month> (ordinal)October", -6.135564891081739),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.442417710521793),
                                    ("<time-of-day> am|pmintersect", -4.882801922586371),
                                    ("time-of-day (latent)until <time>", -5.730099782973574),
                                    ("Octoberyear (latent)", -6.135564891081739),
                                    ("Good Fridayyear (latent)", -5.730099782973574),
                                    ("early morningat <time-of-day>", -6.135564891081739),
                                    ("until <time>on <day>", -5.442417710521793),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.135564891081739),
                                    ("time-of-day (latent)intersect", -6.135564891081739),
                                    ("todayin <number> (implicit minutes)", -6.135564891081739),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.135564891081739),
                                    ("hh:mmon <day>", -4.882801922586371),
                                    ("hhhmmintersect", -5.730099782973574),
                                    ("absorption of , after named dayJuly", -5.2192741592075835),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.2192741592075835),
                                    ("Clean Mondayyear (latent)", -6.135564891081739),
                                    ("monthhour", -4.749270529961848),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.730099782973574),
                                    ("hourmonth", -3.995498727585468),
                                    ("todayat <time-of-day>", -6.135564891081739),
                                    ("since <time>until <time>", -6.135564891081739),
                                    ("hhhmmyear (latent)", -4.882801922586371),
                                    ("<time-of-day> am|pmon <day>", -4.882801922586371),
                                    ("Mondayyear (latent)", -5.442417710521793),
                                    ("dayday", -4.056123349401903),
                                    ("mm/ddat <time-of-day>", -5.730099782973574),
                                    ("on <day>September", -5.442417710521793),
                                    ("since <time>intersect", -5.442417710521793),
                                    ("time-of-day (latent)September", -5.730099782973574),
                                    ("hourhour", -4.056123349401903),
                                    ("time-of-day (latent)on <day>", -4.631487494305465),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.730099782973574),
                                    ("dayyear", -3.1911259119152984),
                                    ("Thursdaymm/dd", -6.135564891081739),
                                    ("New Year's Dayyear (latent)", -5.2192741592075835),
                                    ("time-of-day (latent)Sunday", -5.730099782973574),
                                    ("Thursdayat <time-of-day>", -4.526126978647638),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.135564891081739),
                                    ("Aprilyear (latent)", -6.135564891081739),
                                    ("the <day-of-month> (ordinal)July", -6.135564891081739),
                                    ("the <day-of-month> (number)July", -6.135564891081739),
                                    ("monthminute", -6.135564891081739),
                                    ("<time-of-day> am|pmtomorrow", -5.730099782973574),
                                    ("Thursdayhh:mm", -5.2192741592075835),
                                    ("<day-of-month> (ordinal)Tuesday", -5.730099782973574),
                                    ("minutemonth", -4.056123349401903),
                                    ("time-of-day (latent)Friday", -5.730099782973574),
                                    ("minutehour", -6.135564891081739),
                                    ("part of daysat <time-of-day>", -5.0369526024136295),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.784189633918261),
                                    ("Augustyear (latent)", -5.730099782973574),
                                    ("week-endin|during <named-month>|year", -6.135564891081739),
                                    ("time-of-day (latent)Tuesday", -5.730099782973574),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.135564891081739),
                                    ("Sundayyear (latent)", -5.2192741592075835),
                                    ("hourweek", -5.2192741592075835),
                                    ("the <day-of-month> (ordinal)Monday", -5.442417710521793),
                                    ("Christmasat <time-of-day>", -6.135564891081739),
                                    ("the last <cycle> of <time>year (latent)", -5.730099782973574),
                                    ("hhhmmon <day>", -5.2192741592075835),
                                    ("Julyuntil <time>", -5.730099782973574),
                                    ("yesterday<time-of-day> am|pm", -6.135564891081739),
                                    ("<day-of-month> (ordinal)July", -5.442417710521793),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.135564891081739),
                                    ("mm/ddyear (latent)", -6.135564891081739),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.135564891081739),
                                    ("at <time-of-day>intersect", -5.2192741592075835),
                                    ("hh:mmyear (latent)", -4.749270529961848),
                                    ("Holiyear (latent)", -6.135564891081739),
                                    ("until <time><time-of-day> am|pm", -6.135564891081739),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.730099782973574),
                                    ("dayminute", -3.4965075614664802),
                                    ("yyyy-mm-ddhh:mm", -5.730099782973574),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.135564891081739),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -6.135564891081739),
                                    ("intersectSeptember", -4.263762714180148),
                                    ("minuteday", -3.0675119559481216),
                                    ("absorption of , after named dayintersect",
                                     -6.135564891081739),
                                    ("intersectyear (latent)", -6.135564891081739),
                                    ("Februaryin|during the <part-of-day>", -6.135564891081739),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.135564891081739),
                                    ("time-of-day (latent)July", -5.442417710521793),
                                    ("Saturdayyear (latent)", -6.135564891081739),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.135564891081739),
                                    ("<day-of-month> (ordinal)Monday", -4.882801922586371),
                                    ("at <time-of-day>on <day>", -5.2192741592075835),
                                    ("absorption of , after named daySeptember",
                                     -4.882801922586371),
                                    ("Naraka Chaturdashiyear (latent)", -6.135564891081739),
                                    ("Easter Sundayyear (latent)", -5.730099782973574),
                                    ("Thursday<time-of-day> am|pm", -5.0369526024136295),
                                    ("weekyear", -5.2192741592075835),
                                    ("after <time>year (latent)", -5.730099782973574),
                                    ("time-of-day (latent)Thursday", -5.730099782973574),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -5.730099782973574),
                                    ("<day-of-month> (ordinal)April", -6.135564891081739),
                                    ...
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.135564891081739),
                                    ("tomorrowat <time-of-day>", -6.135564891081739),
                                    ("Fridayin|during <named-month>|year", -6.135564891081739),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.730099782973574),
                                    ("last <cycle> of <time>year (latent)", -5.730099782973574),
                                    ("tomorrow<time-of-day> am|pm", -6.135564891081739),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.730099782973574),
                                    ("Diwaliyear (latent)", -5.730099782973574),
                                    ("this <part-of-day>at <time-of-day>", -5.2192741592075835),
                                    ("Fridayyear (latent)", -5.2192741592075835),
                                    ("time-of-day (latent)<named-month> <day-of-month> (non ordinal)",
                                     -6.135564891081739),
                                    ("time-of-day (latent)April", -6.135564891081739),
                                    ("minuteyear", -3.995498727585468)],
                               n = 306}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.13095606284679, unseen = -5.5134287461649825,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.4591403137322207e-2),
                                    ("intersect 2 numbers", -4.123093975508087)],
                               n = 243},
                   koData =
                     ClassData{prior = -2.097656981571177, unseen = -3.6635616461296463,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.31237468504215243, unseen = -5.25227342804663,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.2580400255962119),
                                    ("month (grain)", -2.356652314264321),
                                    ("year (grain)", -2.41381072810427),
                                    ("week (grain)", -1.2580400255962119),
                                    ("quarter", -3.6375861597263857), ("year", -2.41381072810427),
                                    ("month", -2.356652314264321),
                                    ("quarter (grain)", -3.6375861597263857)],
                               n = 90},
                   koData =
                     ClassData{prior = -1.3156767939059373, unseen = -4.343805421853684,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5138062519041285, unseen = -5.288267030694535,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersectthis|last|next <cycle>", -4.590056548178043),
                                    ("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.590056548178043),
                                    ("dayhour", -4.1845914400698785),
                                    ("daymonth", -2.3387647495715482),
                                    ("<named-month> <day-of-month> (non ordinal)Friday",
                                     -4.590056548178043),
                                    ("Friday<named-month> <day-of-month> (non ordinal)",
                                     -3.337293579682675),
                                    ("Wednesdayintersect", -4.590056548178043),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -3.2037621870581527),
                                    ("Black Fridaythis|last|next <cycle>", -4.590056548178043),
                                    ("Labour Daythis|last|next <cycle>", -4.590056548178043),
                                    ("<part-of-day> of <time>February", -4.590056548178043),
                                    ("Saturday<time-of-day> am|pm", -4.590056548178043),
                                    ("Martin Luther King's Daythis|last|next <cycle>",
                                     -4.1845914400698785),
                                    ("hourmonth", -4.590056548178043),
                                    ("Fridayintersect by \",\", \"of\", \"from\" for year",
                                     -3.896909367618098),
                                    ("dayday", -2.3387647495715482),
                                    ("WednesdayOctober", -4.590056548178043),
                                    ("Wednesdaythis|last|next <cycle>", -4.1845914400698785),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.337293579682675),
                                    ("dayyear", -3.4914442595099335),
                                    ("Saturday<named-month> <day-of-month> (non ordinal)",
                                     -4.590056548178043),
                                    ("Thursdayhh:mm", -4.1845914400698785),
                                    ("Thanksgiving Daythis|last|next <cycle>", -4.590056548178043),
                                    ("TuesdayOctober", -4.590056548178043),
                                    ("Mondaythis|last|next <cycle>", -3.896909367618098),
                                    ("Fridayintersect", -3.896909367618098),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.1845914400698785),
                                    ("intersectOctober", -4.1845914400698785),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -3.673765816303888),
                                    ("Tuesdaythis|last|next <cycle>", -4.1845914400698785),
                                    ("Sunday<named-month> <day-of-month> (non ordinal)",
                                     -4.590056548178043),
                                    ("dayminute", -2.798297078949988),
                                    ("minuteday", -3.337293579682675),
                                    ("this|last|next <cycle>Sunday", -4.590056548178043),
                                    ("Sundaythis|last|next <cycle>", -4.590056548178043),
                                    ("on <day><time-of-day> am|pm", -4.590056548178043),
                                    ("intersectintersect", -4.590056548178043),
                                    ("weekday", -4.590056548178043),
                                    ("dayweek", -3.4914442595099335),
                                    ("between <time> and <time>July", -4.590056548178043),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.1845914400698785),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -3.896909367618098)],
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week-endJuly", -4.33729074083249),
                                    ...
                                    ("minutemonth", -2.9509963797125995),
