...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5374347324939552, unseen = -6.284134161070802,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 534},
                   koData =
                     ClassData{prior = -0.8776593187337186, unseen = -5.945420608606575,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.37221124815387685,
                               unseen = -7.111512116496157,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.417548942418882),
                                    ("Father's Dayyear (latent)", -6.417548942418882),
                                    ("Karva Chauthyear (latent)", -6.417548942418882),
                                    ("Maha Shivaratriyear (latent)", -6.417548942418882),
                                    ("Ramadanyear (latent)", -5.1647859739235145),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.3189366537507725),
                                    ("Bhai Doojyear (latent)", -6.417548942418882),
                                    ("hourday", -4.471638793363569),
                                    ("dayhour", -3.584335598362666),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.3189366537507725),
                                    ("Martin Luther King's Dayyear (latent)", -6.012083834310718),
                                    ("Shemini Atzeretyear (latent)", -6.417548942418882),
                                    ("daymonth", -5.1647859739235145),
                                    ("monthyear", -4.019653669620512),
                                    ("Yom Ha'atzmautyear (latent)", -6.417548942418882),
                                    ("Orthodox Good Fridayyear (latent)", -6.012083834310718),
                                    ("Vijayadashamiyear (latent)", -6.417548942418882),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.012083834310718),
                                    ("Thanksgiving Dayyear (latent)", -5.3189366537507725),
                                    ("Thai Pongalyear (latent)", -5.724401761858937),
                                    ("Thiru Onamyear (latent)", -5.724401761858937),
                                    ("hhhmmabsorption of , after named day", -6.417548942418882),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.5012582105447265),
                                    ("Krishna Janmashtamiyear (latent)", -6.012083834310718),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.417548942418882),
                                    ("houryear", -5.724401761858937),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.417548942418882),
                                    ("Christmas<time-of-day> am|pm", -6.417548942418882),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.417548942418882),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.724401761858937),
                                    ("<time-of-day> am|pmintersect", -5.1647859739235145),
                                    ("Earth Houryear (latent)", -6.417548942418882),
                                    ("Ganesh Chaturthiyear (latent)", -6.417548942418882),
                                    ("Family Dayyear (latent)", -5.5012582105447265),
                                    ("Octoberyear (latent)", -4.913471545642608),
                                    ("intersect<time-of-day> am|pm", -6.417548942418882),
                                    ("Mattu Pongalyear (latent)", -6.417548942418882),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.417548942418882),
                                    ("Januaryyear (latent)", -6.012083834310718),
                                    ("Shavuotyear (latent)", -6.417548942418882),
                                    ("Parsi New Yearyear (latent)", -5.5012582105447265),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.417548942418882),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.417548942418882),
                                    ("todayin|within|after <duration>", -6.417548942418882),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.012083834310718),
                                    ("Marchyear (latent)", -6.012083834310718),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.012083834310718),
                                    ("<named-month>|<named-day> <day-of-month> the (ordinal)in|during the <part-of-day>",
                                     -6.417548942418882),
                                    ("Sukkotyear (latent)", -6.012083834310718),
                                    ("hhhmmintersect", -6.012083834310718),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.417548942418882),
                                    ("since <time>year (latent)", -6.417548942418882),
                                    ("<time-of-day> o'clock<time> <part-of-day>",
                                     -6.012083834310718),
                                    ("Clean Mondayyear (latent)", -6.012083834310718),
                                    ("monthhour", -6.417548942418882),
                                    ("todayat <time-of-day>", -6.417548942418882),
                                    ("Thursday<time> timezone", -4.019653669620512),
                                    ("tonight<time-of-day> am|pm", -6.417548942418882),
                                    ("<time-of-day> am|pmon <day>", -4.402645921876617),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.417548942418882),
                                    ("yyyy-mm-ddhh:mm:ss", -6.012083834310718),
                                    ("dayday", -4.0661736852554045),
                                    ("<time> <part-of-day>at <time-of-day>", -6.012083834310718),
                                    ("mm/ddat <time-of-day>", -6.417548942418882),
                                    ("tonightat <time-of-day>", -5.3189366537507725),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.724401761858937),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.417548942418882),
                                    ("today<time-of-day> am|pm", -6.417548942418882),
                                    ("at <time-of-day><time> <part-of-day>", -6.417548942418882),
                                    ("mm/dd<time-of-day> am|pm", -6.417548942418882),
                                    ("hourhour", -3.975201907049678),
                                    ("Mahavir Jayantiyear (latent)", -6.012083834310718),
                                    ("Navaratriin|during <named-month>|year", -6.417548942418882),
                                    ("National Patriots' Dayyear (latent)", -5.724401761858937),
                                    ("Wednesdaythis|last|next <cycle>", -6.417548942418882),
                                    ("Lentyear (latent)", -6.417548942418882),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.545746765517291),
                                    ("Boghiyear (latent)", -6.417548942418882),
                                    ("dayyear", -1.7262010601897384),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.417548942418882),
                                    ("<time-of-day> o'clocktomorrow", -6.012083834310718),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.417548942418882),
                                    ("Thursdayat <time-of-day>", -5.724401761858937),
                                    ("Islamic New Yearyear (latent)", -6.012083834310718),
                                    ("Laylat al-Qadryear (latent)", -5.5012582105447265),
                                    ("Aprilyear (latent)", -6.417548942418882),
                                    ("<day-of-month> (ordinal or number) of <named-month>year (latent)",
                                     -6.012083834310718),
                                    ("Discovery Dayyear (latent)", -6.012083834310718),
                                    ("Shrove Tuesdayyear (latent)", -6.417548942418882),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.724401761858937),
                                    ("hourminute", -6.417548942418882),
                                    ("<time-of-day> am|pmtomorrow", -5.3189366537507725),
                                    ("Yom Kippuryear (latent)", -6.417548942418882),
                                    ("<part-of-day> of <time>year (latent)", -6.417548942418882),
                                    ("minutehour", -5.3189366537507725),
                                    ("Kaanum Pongalyear (latent)", -6.012083834310718),
                                    ("Maha Saptamiyear (latent)", -6.417548942418882),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.724401761858937),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.402645921876617),
                                    ("for <duration> from <time>December", -6.417548942418882),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.417548942418882),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.1647859739235145),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.1647859739235145),
                                    ("Pentecostyear (latent)", -6.417548942418882),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.1647859739235145),
                                    ("Eid al-Fitryear (latent)", -5.031254581298992),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.417548942418882),
                                    ("Mondayin|during the <part-of-day>", -6.417548942418882),
                                    ("Chhathin|during <named-month>|year", -6.417548942418882),
                                    ("Diwaliin|during <named-month>|year", -6.417548942418882),
                                    ("this <part-of-day><time-of-day> am|pm", -6.417548942418882),
                                    ("Vaisakhiin|during <named-month>|year", -6.417548942418882),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.1647859739235145),
                                    ("Raksha Bandhanyear (latent)", -6.417548942418882),
                                    ("daysecond", -6.012083834310718),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.012083834310718),
                                    ("Februaryyear (latent)", -6.417548942418882),
                                    ("Ratha-Yatrayear (latent)", -6.417548942418882),
                                    ("Ashurayear (latent)", -6.417548942418882),
                                    ("Tuesdayin|during <named-month>|year", -6.417548942418882),
                                    ("Chinese New Yearyear (latent)", -6.417548942418882),
                                    ("Juneyear (latent)", -6.012083834310718),
                                    ("Lag BaOmeryear (latent)", -6.417548942418882),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.417548942418882),
                                    ("Eid al-Adhayear (latent)", -4.277482778922611),
                                    ("Palm Sundayyear (latent)", -6.417548942418882),
                                    ("Christmasat <time-of-day>", -6.417548942418882),
                                    ("Passoveryear (latent)", -6.417548942418882),
                                    ("Lazarus Saturdayyear (latent)", -6.417548942418882),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.417548942418882),
                                    ("the last <cycle> of <time>year (latent)", -5.724401761858937),
                                    ("hhhmmon <day>", -5.5012582105447265),
                                    ("Yom HaShoahyear (latent)", -6.012083834310718),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.417548942418882),
                                    ("Septemberyear (latent)", -6.012083834310718),
                                    ("Decemberyear (latent)", -6.012083834310718),
                                    ("Halloweenyear (latent)", -6.417548942418882),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.417548942418882),
                                    ("at <time-of-day>intersect", -5.5012582105447265),
                                    ("Rosh Hashanahyear (latent)", -5.724401761858937),
                                    ("Dhanterasyear (latent)", -6.417548942418882),
                                    ("Tu BiShvatyear (latent)", -6.417548942418882),
                                    ("Holiyear (latent)", -5.724401761858937),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.417548942418882),
                                    ("Holika Dahanyear (latent)", -5.724401761858937),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.012083834310718),
                                    ("dayminute", -3.2188758248682006),
                                    ("Mawlidyear (latent)", -6.417548942418882),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.012083834310718),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.417548942418882),
                                    ("Jumu'atul-Widayear (latent)", -5.5012582105447265),
                                    ("minuteday", -2.716246968306389),
                                    ("absorption of , after named dayintersect",
                                     -5.724401761858937),
                                    ("Orthodox Easter Sundayyear (latent)", -6.417548942418882),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.417548942418882),
                                    ("intersecthhhmm", -6.012083834310718),
                                    ("Boss's Dayyear (latent)", -6.012083834310718),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.417548942418882),
                                    ("Global Youth Service Dayyear (latent)", -6.417548942418882),
                                    ("Dhanterasin|during <named-month>|year", -6.417548942418882),
                                    ("tonight<time-of-day> o'clock", -6.417548942418882),
                                    ("Tisha B'Avyear (latent)", -6.417548942418882),
                                    ("Isra and Mi'rajyear (latent)", -5.5012582105447265),
                                    ("at <time-of-day>on <day>", -4.808111029984782),
                                    ("<day-of-month> (ordinal or number) of <month>year (latent)",
                                     -6.012083834310718),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.012083834310718),
                                    ("Christmasyear (latent)", -6.012083834310718),
                                    ("Naraka Chaturdashiyear (latent)", -6.012083834310718),
                                    ("Thai Pongalin|during <named-month>|year", -6.417548942418882),
                                    ("dayweek", -6.417548942418882),
                                    ("Easter Sundayyear (latent)", -5.724401761858937),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.012083834310718),
                                    ("Labour Dayyear (latent)", -6.417548942418882),
                                    ("weekyear", -5.3189366537507725),
                                    ("King's Dayyear (latent)", -4.913471545642608),
                                    ("hh:mmin|during the <part-of-day>", -5.5012582105447265),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.012083834310718),
                                    ("first|second|third|fourth|fifth <day-of-week> of <time>year (latent)",
                                     -5.724401761858937),
                                    ("Hanukkahyear (latent)", -5.724401761858937),
                                    ("Rama Navamiyear (latent)", -6.417548942418882),
                                    ("February<time> <part-of-day>", -6.417548942418882),
                                    ("Great Lentyear (latent)", -6.417548942418882),
                                    ("tomorrowat <time-of-day>", -5.724401761858937),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.012083834310718),
                                    ("Ugadiyear (latent)", -5.031254581298992),
                                    ("Vaisakhiyear (latent)", -5.724401761858937),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.724401761858937),
                                    ("at <time-of-day>tomorrow", -6.012083834310718),
                                    ("tomorrow<time-of-day> am|pm", -6.417548942418882),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.417548942418882),
                                    ("Diwaliyear (latent)", -6.417548942418882),
                                    ("between <time> and <time>on <day>", -6.012083834310718),
                                    ("Black Fridayyear (latent)", -6.012083834310718),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.417548942418882),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.417548942418882),
                                    ("Chhathyear (latent)", -6.012083834310718),
                                    ("Vasant Panchamiyear (latent)", -6.417548942418882),
                                    ("Rabindra Jayantiyear (latent)", -5.1647859739235145),
                                    ("this <part-of-day>at <time-of-day>", -5.1647859739235145),
                                    ("St Patrick's Dayyear (latent)", -6.417548942418882),
                                    ("Thursday<time> (timezone)", -6.417548942418882),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.417548942418882),
                                    ("the <day-of-month> (ordinal or number) of <month>year (latent)",
                                     -6.012083834310718),
                                    ("Pargat Diwasyear (latent)", -5.1647859739235145),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.724401761858937),
                                    ("Mother's Dayyear (latent)", -6.417548942418882),
                                    ("Simchat Torahyear (latent)", -6.417548942418882),
                                    ("Victoria Dayyear (latent)", -6.012083834310718),
                                    ("minuteyear", -6.417548942418882)],
                               n = 479},
                   koData =
                     ClassData{prior = -1.1686334378806271, unseen = -6.551080335043404,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.352426164897591),
                                    ("hourday", -4.757891273005756),
                                    ("dayhour", -3.371596911885865),
                                    ("<time> timezoneyear (latent)", -5.163356381113919),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -4.94021282979971),
                                    ("after <time><time-of-day> am|pm", -5.856503561673865),
                                    ("daymonth", -3.4141565263046605),
                                    ("monthday", -4.94021282979971),
                                    ("monthyear", -4.603740593178497),
                                    ("<time-of-day> am|pmyear (latent)", -5.163356381113919),
                                    ("Thai Pongalyear (latent)", -5.163356381113919),
                                    ("intersecthh:mm", -5.856503561673865),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.4510384535657),
                                    ("houryear", -4.94021282979971),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -5.856503561673865),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.163356381113919),
                                    ("<time-of-day> am|pmintersect", -4.603740593178497),
                                    ("Octoberyear (latent)", -5.856503561673865),
                                    ("Good Fridayyear (latent)", -5.4510384535657),
                                    ("until <time>on <day>", -5.163356381113919),
                                    ("todayin <number> (implicit minutes)", -5.856503561673865),
                                    ...
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -5.856503561673865),
                                    ("hh:mmon <day>", -4.603740593178497),
                                    ("hhhmmintersect", -5.4510384535657),
                                    ("absorption of , after named dayJuly", -4.94021282979971),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -4.94021282979971),
                                    ("Clean Mondayyear (latent)", -5.856503561673865),
                                    ("monthhour", -5.856503561673865),
                                    ("hourmonth", -4.94021282979971),
                                    ("todayat <time-of-day>", -5.856503561673865),
                                    ("since <time>until <time>", -5.856503561673865),
                                    ("hhhmmyear (latent)", -4.603740593178497),
                                    ("<time-of-day> am|pmon <day>", -4.603740593178497),
                                    ("Mondayyear (latent)", -5.163356381113919),
                                    ("dayday", -5.856503561673865),
                                    ("mm/ddat <time-of-day>", -5.4510384535657),
                                    ("on <day>September", -5.163356381113919),
                                    ("hourhour", -4.603740593178497),
                                    ("dayyear", -2.9120645825074245),
                                    ("Thursdaymm/dd", -5.856503561673865),
                                    ("New Year's Dayyear (latent)", -4.94021282979971),
                                    ("Thursdayat <time-of-day>", -4.247065649239764),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -5.856503561673865),
                                    ("Aprilyear (latent)", -5.856503561673865),
                                    ("monthminute", -5.856503561673865),
                                    ("<time-of-day> am|pmtomorrow", -5.4510384535657),
                                    ("Thursdayhh:mm", -4.94021282979971),
                                    ("minutemonth", -3.777062019994029),
                                    ("Augustyear (latent)", -5.4510384535657),
                                    ("week-endin|during <named-month>|year", -5.856503561673865),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -5.856503561673865),
                                    ("Sundayyear (latent)", -4.94021282979971),
                                    ("Christmasat <time-of-day>", -5.856503561673865),
                                    ("the last <cycle> of <time>year (latent)", -5.4510384535657),
                                    ("hhhmmon <day>", -4.94021282979971),
                                    ("Julyuntil <time>", -5.4510384535657),
                                    ("yesterday<time-of-day> am|pm", -5.856503561673865),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -5.856503561673865),
                                    ("mm/ddyear (latent)", -5.856503561673865),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -5.856503561673865),
                                    ("at <time-of-day>intersect", -4.94021282979971),
                                    ("hh:mmyear (latent)", -4.470209200553974),
                                    ("Holiyear (latent)", -5.856503561673865),
                                    ("until <time><time-of-day> am|pm", -5.856503561673865),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.4510384535657),
                                    ("dayminute", -3.2174462320586064),
                                    ("yyyy-mm-ddhh:mm", -5.4510384535657),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -5.856503561673865),
                                    ("since <time><day-of-month> (ordinal or number) <named-month>",
                                     -5.856503561673865),
                                    ("intersectSeptember", -3.9847013847722734),
                                    ("minuteday", -2.788450626540248),
                                    ("absorption of , after named dayintersect",
                                     -5.856503561673865),
                                    ("Februaryin|during the <part-of-day>", -5.856503561673865),
                                    ("<duration> after|before|from|past <time>December",
                                     -5.856503561673865),
                                    ("Saturdayyear (latent)", -5.856503561673865),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.856503561673865),
                                    ("at <time-of-day>on <day>", -4.94021282979971),
                                    ("absorption of , after named daySeptember",
                                     -4.603740593178497),
                                    ("Naraka Chaturdashiyear (latent)", -5.856503561673865),
                                    ("Easter Sundayyear (latent)", -5.4510384535657),
                                    ("Thursday<time-of-day> am|pm", -4.757891273005756),
                                    ("weekyear", -5.4510384535657),
                                    ("after <time>year (latent)", -5.4510384535657),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.163356381113919),
                                    ("absorption of , after named dayFebruary", -4.94021282979971),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.856503561673865),
                                    ("tomorrowat <time-of-day>", -5.856503561673865),
                                    ("Fridayin|during <named-month>|year", -5.856503561673865),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.4510384535657),
                                    ("tomorrow<time-of-day> am|pm", -5.856503561673865),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.4510384535657),
                                    ("Diwaliyear (latent)", -5.4510384535657),
                                    ("this <part-of-day>at <time-of-day>", -4.94021282979971),
                                    ("Fridayyear (latent)", -4.94021282979971),
                                    ("minuteyear", -3.716437398177594)],
                               n = 216}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -1.3862943611198906,
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.12470347850095725,
                               unseen = -5.564520407322694,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.3347363996991177e-2),
                                    ("intersect 2 numbers", -4.174387269895637)],
                               n = 256},
                   koData =
       ...
       ("<datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -0.6716409753389816, unseen = -4.890349128221754,
                               likelihoods =
                                 HashMap.fromList
                                   [("daymonth", -3.4965075614664802),
                                    ("monthday", -2.580216829592325),
                                    ("at the beginning|end of <named-month>June",
                                     -3.4965075614664802),
                                    ("minuteminute", -1.9924301646902063),
                                    ("<time> timezone<time> timezone", -3.4965075614664802),
                                    ("hh:mmhh:mm", -2.6855773452501515),
                                    ("dayday", -2.3178525651248343),
                                    ("monthmonth", -3.784189633918261),
                                    ...
                                    ("Mayat the beginning|end of <named-month>",
                                     -2.580216829592325),
                                    ("MayJune", -3.784189633918261)],
                               n = 47},
                   koData =
                     ClassData{prior = -0.7151260872787205, unseen = -4.859812404361672,
                               likelihoods =
                                 HashMap.fromList
                                   [("hhhmm<time> timezone", -3.7534179752515073),
                                    ("<time> timezonehhhmm", -3.7534179752515073),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -3.242592351485517),
                                    ("daymonth", -2.6548056865833978),
                                    ("<time-of-day> am|pm<time-of-day> - <time-of-day> (interval)",
                                     -3.7534179752515073),
                                    ("monthday", -3.4657359027997265),
                                    ("<time-of-day> am|pmintersect", -4.1588830833596715),
                                    ("MondayOctober", -3.7534179752515073),
                                    ("hh:mm<time-of-day> am|pm", -3.0602707946915624),
                                    ("hhhmmintersect", -4.1588830833596715),
                                    ("minuteminute", -1.9075912847531766),
                                    ("hh:mmhh:mm", -3.4657359027997265),
                                    ("dayday", -2.906120114864304),
                                    ("monthmonth", -3.4657359027997265),
                                    ("hhhmmhhhmm", -3.7534179752515073),
                                    ("hourhour", -4.1588830833596715),
                                    ("hourminute", -3.4657359027997265),
                                    ("minutehour", -3.4657359027997265),
                                    ("<time> timezonehh:mm", -4.1588830833596715),
                                    ("hh:mm<time> timezone", -4.1588830833596715),
                                    ("hh:mmintersect", -3.242592351485517),
                                    ("since <time>July", -4.1588830833596715),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -4.1588830833596715),
                                    ("Christmastoday", -3.4657359027997265),
                                    ("Monday<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -3.7534179752515073),
                                    ("<time-of-day> am|pmhh:mm", -4.1588830833596715),
                                    ("Monday<named-month> <day-of-month> (non ordinal)",
                                     -4.1588830833596715),
                                    ("Mayat the beginning|end of <named-month>",
                                     -3.4657359027997265),
                                    ("MayJune", -3.4657359027997265)],
                               n = 45}}),
       ("Tuesday",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.772588722239781,
