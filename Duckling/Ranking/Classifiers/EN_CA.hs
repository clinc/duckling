...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5690945318899665, unseen = -6.1779441140506,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 480},
                   koData =
                     ClassData{prior = -0.8347976976229721, unseen = -5.91350300563827,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("day", -2.772588722239781), ("quarter", -2.772588722239781),
                                    ...
                                    ("<> <unit-of-duration>", -1.6739764335716716)],
                               n = 7}}),
       ("January",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45618020068718085,
                               unseen = -7.2078598714324755,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.51397167564781),
                                    ("Father's Dayyear (latent)", -6.51397167564781),
                                    ("Karva Chauthyear (latent)", -6.51397167564781),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.51397167564781),
                                    ("Maha Shivaratriyear (latent)", -6.51397167564781),
                                    ("Ramadanyear (latent)", -5.261208707152442),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.12767731452792),
                                    ("Bhai Doojyear (latent)", -6.51397167564781),
                                    ("hourday", -4.499068655105546),
                                    ("dayhour", -3.493546789503448),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.12767731452792),
                                    ("Martin Luther King's Dayyear (latent)", -6.108506567539647),
                                    ("Shemini Atzeretyear (latent)", -6.51397167564781),
                                    ("daymonth", -4.499068655105546),
                                    ("monthday", -6.108506567539647),
                                    ("monthyear", -4.722212206419756),
                                    ("Yom Ha'atzmautyear (latent)", -6.51397167564781),
                                    ("Vijayadashamiyear (latent)", -6.51397167564781),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.108506567539647),
                                    ("Thanksgiving Dayyear (latent)", -5.415359386979701),
                                    ("Thai Pongalyear (latent)", -5.820824495087865),
                                    ("Thiru Onamyear (latent)", -5.820824495087865),
                                    ("hhhmmabsorption of , after named day", -6.51397167564781),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.51397167564781),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.597680943773655),
                                    ("<day-of-month> (ordinal)Wednesday", -6.51397167564781),
                                    ("Krishna Janmashtamiyear (latent)", -6.108506567539647),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.51397167564781),
                                    ("houryear", -5.597680943773655),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.51397167564781),
                                    ("Christmas<time-of-day> am|pm", -6.51397167564781),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.51397167564781),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.820824495087865),
                                    ("intersectin|during <named-month>|year", -6.51397167564781),
                                    ("<time-of-day> am|pmintersect", -5.261208707152442),
                                    ("Earth Houryear (latent)", -6.51397167564781),
                                    ("Ganesh Chaturthiyear (latent)", -6.51397167564781),
                                    ("Family Dayyear (latent)", -5.597680943773655),
                                    ("Octoberyear (latent)", -5.009894278871537),
                                    ("intersect<time-of-day> am|pm", -6.51397167564781),
                                    ("Mattu Pongalyear (latent)", -6.51397167564781),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.51397167564781),
                                    ("Shavuotyear (latent)", -6.51397167564781),
                                    ("Parsi New Yearyear (latent)", -5.597680943773655),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.51397167564781),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.51397167564781),
                                    ("todayin|within|after <duration>", -6.51397167564781),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.108506567539647),
                                    ("Marchyear (latent)", -6.51397167564781),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.108506567539647),
                                    ("Sukkotyear (latent)", -6.108506567539647),
                                    ("hhhmmintersect", -6.108506567539647),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.108506567539647),
                                    ("Clean Mondayyear (latent)", -6.108506567539647),
                                    ("monthhour", -6.108506567539647),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.820824495087865),
                                    ("todayat <time-of-day>", -6.51397167564781),
                                    ("Thursday<time> timezone", -4.11607640284944),
                                    ("tonight<time-of-day> am|pm", -6.51397167564781),
                                    ("time-of-day (latent)tonight", -6.108506567539647),
                                    ("from|since|after <time>December", -6.51397167564781),
                                    ("<time-of-day> am|pmon <day>", -4.499068655105546),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm", -6.51397167564781),
                                    ("yyyy-mm-ddhh:mm:ss", -6.108506567539647),
                                    ("dayday", -3.8059214745456003),
                                    ("<time> <part-of-day>at <time-of-day>", -6.108506567539647),
                                    ("mm/ddat <time-of-day>", -6.51397167564781),
                                    ("tonightat <time-of-day>", -5.415359386979701),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.820824495087865),
                                    ("Dayananda Saraswati Jayantiyear (latent)", -6.51397167564781),
                                    ("today<time-of-day> am|pm", -6.51397167564781),
                                    ("Februarythe <day-of-month> (ordinal)", -6.108506567539647),
                                    ("at <time-of-day><time> <part-of-day>", -6.51397167564781),
                                    ("<day-of-month> (ordinal)intersect", -6.108506567539647),
                                    ("mm/dd<time-of-day> am|pm", -6.51397167564781),
                                    ("hourhour", -3.5435572100781094),
                                    ("Mahavir Jayantiyear (latent)", -6.108506567539647),
                                    ("Navaratriin|during <named-month>|year", -6.51397167564781),
                                    ("National Patriots' Dayyear (latent)", -5.820824495087865),
                                    ("Wednesdaythis|last|next <cycle>", -6.51397167564781),
                                    ("Lentyear (latent)", -6.51397167564781),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.642169498746219),
                                    ("Boghiyear (latent)", -6.51397167564781),
                                    ("dayyear", -1.864784604242945),
                                    ("Karva Chauthin|during <named-month>|year", -6.51397167564781),
                                    ("Thursdayfrom|since|after <time>", -6.108506567539647),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.51397167564781),
                                    ("Thursdayat <time-of-day>", -5.820824495087865),
                                    ("Islamic New Yearyear (latent)", -6.108506567539647),
                                    ("Laylat al-Qadryear (latent)", -5.597680943773655),
                                    ("part of days<time-of-day> am|pm", -6.51397167564781),
                                    ("Discovery Dayyear (latent)", -6.108506567539647),
                                    ("Shrove Tuesdayyear (latent)", -6.51397167564781),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.820824495087865),
                                    ("hourminute", -6.108506567539647),
                                    ("<time-of-day> am|pmtomorrow", -5.820824495087865),
                                    ("Yom Kippuryear (latent)", -6.51397167564781),
                                    ("<day-of-month> (ordinal)Tuesday", -6.108506567539647),
                                    ("<part-of-day> of <time>year (latent)", -6.51397167564781),
                                    ("minutehour", -5.261208707152442),
                                    ("Kaanum Pongalyear (latent)", -6.108506567539647),
                                    ("Maha Saptamiyear (latent)", -6.51397167564781),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.820824495087865),
                                    ("time-of-day (latent)tomorrow", -5.597680943773655),
                                    ("part of daysat <time-of-day>", -4.90453376321371),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.499068655105546),
                                    ("for <duration> from <time>December", -6.51397167564781),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.51397167564781),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.261208707152442),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.261208707152442),
                                    ("time-of-day (latent)this <part-of-day>", -6.51397167564781),
                                    ("Pentecostyear (latent)", -6.51397167564781),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.261208707152442),
                                    ("<day-of-month> (ordinal)February", -6.51397167564781),
                                    ("Eid al-Fitryear (latent)", -5.12767731452792),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.51397167564781),
                                    ("Mondayin|during the <part-of-day>", -6.51397167564781),
                                    ("Chhathin|during <named-month>|year", -6.51397167564781),
                                    ("Diwaliin|during <named-month>|year", -6.51397167564781),
                                    ("this <part-of-day><time-of-day> am|pm", -6.51397167564781),
                                    ("Vaisakhiin|during <named-month>|year", -6.51397167564781),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.261208707152442),
                                    ("Raksha Bandhanyear (latent)", -6.51397167564781),
                                    ("daysecond", -6.108506567539647),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.108506567539647),
                                    ("Ratha-Yatrayear (latent)", -6.51397167564781),
                                    ("Ashurayear (latent)", -6.51397167564781),
                                    ("Tuesdayin|during <named-month>|year", -6.51397167564781),
                                    ("Chinese New Yearyear (latent)", -6.51397167564781),
                                    ("tomorrowintersect", -6.51397167564781),
                                    ("Lag BaOmeryear (latent)", -6.51397167564781),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.51397167564781),
                                    ("Eid al-Adhayear (latent)", -4.3739055121515396),
                                    ("intersectin|during the <part-of-day>", -6.51397167564781),
                                    ("Palm Sundayyear (latent)", -6.51397167564781),
                                    ("Christmasat <time-of-day>", -6.51397167564781),
                                    ("Passoveryear (latent)", -6.51397167564781),
                                    ("Lazarus Saturdayyear (latent)", -6.51397167564781),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.51397167564781),
                                    ("the last <cycle> of <time>year (latent)", -5.820824495087865),
                                    ("hhhmmon <day>", -5.597680943773655),
                                    ("Yom HaShoahyear (latent)", -6.108506567539647),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.108506567539647),
                                    ("Septemberyear (latent)", -6.108506567539647),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.009894278871537),
                                    ("Halloweenyear (latent)", -6.51397167564781),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.51397167564781),
                                    ("at <time-of-day>intersect", -5.597680943773655),
                                    ("Rosh Hashanahyear (latent)", -5.820824495087865),
                                    ("Dhanterasyear (latent)", -6.51397167564781),
                                    ("Tu BiShvatyear (latent)", -6.51397167564781),
                                    ("<day-of-month> (ordinal)December", -5.820824495087865),
                                    ("Holiyear (latent)", -5.820824495087865),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.51397167564781),
                                    ("Holika Dahanyear (latent)", -5.820824495087865),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.108506567539647),
                                    ("dayminute", -3.164067588373206),
                                    ("Mawlidyear (latent)", -6.51397167564781),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.108506567539647),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.51397167564781),
                                    ("Jumu'atul-Widayear (latent)", -5.597680943773655),
                                    ("minuteday", -2.7763020573644424),
                                    ("absorption of , after named dayintersect",
                                     -5.820824495087865),
                                    ("intersectyear (latent)", -6.51397167564781),
                                    ("Orthodox Easter Sundayyear (latent)", -6.51397167564781),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.51397167564781),
                                    ("<ordinal> <cycle> of <time>year (latent)", -6.51397167564781),
                                    ("intersecthhhmm", -6.108506567539647),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.51397167564781),
                                    ("Boss's Dayyear (latent)", -6.108506567539647),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.51397167564781),
                                    ("Global Youth Service Dayyear (latent)", -6.51397167564781),
                                    ("Dhanterasin|during <named-month>|year", -6.51397167564781),
                                    ("tonight<time-of-day> o'clock", -6.51397167564781),
                                    ("Tisha B'Avyear (latent)", -6.51397167564781),
                                    ("Isra and Mi'rajyear (latent)", -5.597680943773655),
                                    ("at <time-of-day>on <day>", -4.90453376321371),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.108506567539647),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.820824495087865),
                                    ("Christmasyear (latent)", -6.108506567539647),
                                    ("Saturdayintersect", -6.51397167564781),
                                    ("Naraka Chaturdashiyear (latent)", -6.108506567539647),
                                    ("Thai Pongalin|during <named-month>|year", -6.51397167564781),
                                    ("dayweek", -6.51397167564781),
                                    ("Easter Sundayyear (latent)", -5.820824495087865),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.108506567539647),
                                    ("Labour Dayyear (latent)", -6.51397167564781),
                                    ("weekyear", -5.261208707152442),
                                    ("King's Dayyear (latent)", -5.009894278871537),
                                    ("hh:mmin|during the <part-of-day>", -5.597680943773655),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.108506567539647),
                                    ("Hanukkahyear (latent)", -5.820824495087865),
                                    ("Rama Navamiyear (latent)", -6.51397167564781),
                                    ("February<time> <part-of-day>", -6.51397167564781),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.820824495087865),
                                    ("Great Lentyear (latent)", -6.51397167564781),
                                    ("tomorrowat <time-of-day>", -5.820824495087865),
                                    ("hhmm (latent)in|during the <part-of-day>", -6.51397167564781),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.108506567539647),
                                    ("Ugadiyear (latent)", -5.12767731452792),
                                    ("Vaisakhiyear (latent)", -5.820824495087865),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.820824495087865),
                                    ("last <cycle> of <time>year (latent)", -5.820824495087865),
                                    ("at <time-of-day>tomorrow", -6.108506567539647),
                                    ("tomorrow<time-of-day> am|pm", -6.51397167564781),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.51397167564781),
                                    ("Diwaliyear (latent)", -6.51397167564781),
                                    ("between <time> and <time>on <day>", -6.108506567539647),
                                    ("Black Fridayyear (latent)", -6.108506567539647),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.51397167564781),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.51397167564781),
                                    ("Chhathyear (latent)", -6.108506567539647),
                                    ("Vasant Panchamiyear (latent)", -6.51397167564781),
                                    ("Rabindra Jayantiyear (latent)", -5.261208707152442),
                                    ("this <part-of-day>at <time-of-day>", -5.261208707152442),
                                    ("St Patrick's Dayyear (latent)", -6.51397167564781),
                                    ("Thursday<time> (timezone)", -6.51397167564781),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.51397167564781),
                                    ("Pargat Diwasyear (latent)", -5.261208707152442),
                                    ("<datetime> - <datetime> (interval)July", -6.108506567539647),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.820824495087865),
                                    ("Februaryintersect", -6.51397167564781),
                                    ("Mother's Dayyear (latent)", -6.51397167564781),
                                    ("Simchat Torahyear (latent)", -6.51397167564781),
                                    ("Victoria Dayyear (latent)", -6.108506567539647),
                                    ("minuteyear", -6.51397167564781)],
                               n = 519},
                   koData =
                     ClassData{prior = -1.0043016091968684, unseen = -6.815639990074332,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.617318319923739),
                                    ("hourday", -3.7235004439016426),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.121395716700013),
                                    ("<day-of-month> (ordinal)August", -6.121395716700013),
                                    ("dayhour", -3.413345515597803),
                                    ("<time> timezoneyear (latent)", -5.428248536140067),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.205104984825858),
                                    ("after <time><time-of-day> am|pm", -6.121395716700013),
                                    ("Tuesdayfrom|since|after <time>", -5.428248536140067),
                                    ("daymonth", -3.447247067273484),
                                    ("hourquarter", -6.121395716700013),
                                    ("monthyear", -4.868632748204645),
                                    ("<time-of-day> am|pmyear (latent)", -5.428248536140067),
                                    ("time-of-day (latent)qq", -6.121395716700013),
                                    ...
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.715930608591849),
                                    ("hourmonth", -4.249593539798422),
                                    ("todayat <time-of-day>", -6.121395716700013),
                                    ("hhhmmyear (latent)", -4.868632748204645),
                                    ...
                                    ("<time-of-day> am|pmtomorrow", -6.121395716700013),
                                    ...
                                    ("from|since|after <time>year (latent)", -5.022783428031904),
                                    ("the last <cycle> of <time>year (latent)", -5.715930608591849),
                                    ...
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.121395716700013),
                                    ("<day-of-month> (ordinal)Monday", -5.205104984825858),
                                    ...
                                    ("weekyear", -5.205104984825858),
                                    ("after <time>year (latent)", -6.121395716700013),
                                    ...
                                    ("Fridayyear (latent)", -5.715930608591849),
                                    ("time-of-day (latent)April", -6.121395716700013),
                                    ("minuteyear", -3.9241711393637937)],
                               n = 300}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.14367292603613852,
                               ...
                               n = 233},
                   koData =
                     ClassData{prior = -2.011192441145729, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -1.491654876777717),
                                    ("negative numbers", -0.4307829160924542),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("monthyear", -1.540445040947149),
                                    ...
                                    ("Vijayadashami<> <unit-of-duration>", -1.9459101490553135),
                                    ("Administrative Professionals' Day<> <unit-of-duration>",
                                     -1.9459101490553135),
                                    ("March<> <unit-of-duration>", -1.9459101490553135)],
                               n = 4},
                   koData =
                     ClassData{prior = -infinity, unseen = -1.9459101490553135,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ...
       ("<time-of-day> - <time-of-day> (interval)",
        Classifier{okData =
                     ClassData{prior = -1.116469906068116, unseen = -4.68213122712422,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 37},
                   koData =
                     ClassData{prior = -0.3966544784260094, unseen = -5.225746673713201,
                               likelihoods =
                                 HashMap.fromList
                                   [("hhhmm<time> timezone", -4.121743536410215),
                                    ("<time> timezonehhhmm", -4.121743536410215),
                                    ("about|exactly <time-of-day>time-of-day (latent)",
                                     -4.527208644518379),
                                    ("until <time>time-of-day (latent)", -3.42859635585027),
                                    ("from|since|after <time>hh:mm", -4.527208644518379),
                                    ("hh:mmtime-of-day (latent)", -2.512305623976115),
                                    ("hh:mm<time-of-day> am|pm", -3.2744456760230114),
                                    ("minuteminute", -2.4477671028385437),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -3.6109179126442243),
                                    ("hh:mmhh:mm", -3.834061463958434),
                                    ("<time-of-day> am|pmtime-of-day (latent)", -4.121743536410215),
                                    ("hhhmmhhhmm", -4.121743536410215),
                                    ("at <time-of-day><time-of-day> am|pm", -4.527208644518379),
                                    ("hourhour", -2.042301994730379),
                                    ("from|since|after <time><integer> to|till|before <hour-of-day>",
                                     -3.834061463958434),
                                    ("hourminute", -3.42859635585027),
                                    ("minutehour", -1.6939953004621633),
                                    ("<time> timezonehh:mm", -4.527208644518379),
                                    ("hh:mm<time> timezone", -4.527208644518379),
                                    ("hhhmmtime-of-day (latent)", -3.834061463958434),
                                    ("until <time><time-of-day> am|pm", -4.527208644518379),
                                    ("about|exactly <time-of-day><time-of-day> am|pm",
                                     -4.527208644518379),
                                    ("<time-of-day> am|pmhh:mm", -4.527208644518379),
                                    ("<part-of-day> at <time-of-day>time-of-day (latent)",
                                     -3.834061463958434),
                                    ("from|since|after <time>time-of-day (latent)",
                                     -3.0231312477421053),
                                    ("at <time-of-day>time-of-day (latent)", -3.6109179126442243),
                                    ("<time> timezonetime-of-day (latent)", -3.834061463958434),
