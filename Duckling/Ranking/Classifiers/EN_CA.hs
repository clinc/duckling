...
classifiers
  = HashMap.fromList
      [("Bhai Dooj",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.5732699033004471, unseen = -6.173786103901937,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 478},
                   koData =
                     ClassData{prior = -0.829377630153633, unseen = -5.918893854273146,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45198512374305727,
                               unseen = -7.189922170745808,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.496020557860377),
                                    ("Father's Dayyear (latent)", -6.496020557860377),
                                    ("Karva Chauthyear (latent)", -6.496020557860377),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.496020557860377),
                                    ("Maha Shivaratriyear (latent)", -6.496020557860377),
                                    ("Ramadanyear (latent)", -5.243257589365009),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.109726196740486),
                                    ("Bhai Doojyear (latent)", -6.496020557860377),
                                    ("hourday", -4.481117537318113),
                                    ("dayhour", -3.5002882843063863),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.109726196740486),
                                    ("Martin Luther King's Dayyear (latent)", -6.0905554497522125),
                                    ("Shemini Atzeretyear (latent)", -6.496020557860377),
                                    ("daymonth", -4.624218380958785),
                                    ("monthyear", -4.704261088632323),
                                    ("Yom Ha'atzmautyear (latent)", -6.496020557860377),
                                    ("Vijayadashamiyear (latent)", -6.496020557860377),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -6.0905554497522125),
                                    ("Thanksgiving Dayyear (latent)", -5.397408269192267),
                                    ("Thai Pongalyear (latent)", -5.802873377300432),
                                    ("Thiru Onamyear (latent)", -5.802873377300432),
                                    ("hhhmmabsorption of , after named day", -6.496020557860377),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.579729825986222),
                                    ("<day-of-month> (ordinal)Wednesday", -6.496020557860377),
                                    ("Krishna Janmashtamiyear (latent)", -6.0905554497522125),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.496020557860377),
                                    ("houryear", -5.579729825986222),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.496020557860377),
                                    ("Christmas<time-of-day> am|pm", -6.496020557860377),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.496020557860377),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.802873377300432),
                                    ("intersectin|during <named-month>|year", -6.496020557860377),
                                    ("<time-of-day> am|pmintersect", -5.243257589365009),
                                    ("Earth Houryear (latent)", -6.496020557860377),
                                    ("Ganesh Chaturthiyear (latent)", -6.496020557860377),
                                    ("Family Dayyear (latent)", -5.579729825986222),
                                    ("Octoberyear (latent)", -4.991943161084103),
                                    ("intersect<time-of-day> am|pm", -6.496020557860377),
                                    ("Mattu Pongalyear (latent)", -6.496020557860377),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.496020557860377),
                                    ("Shavuotyear (latent)", -6.496020557860377),
                                    ("Parsi New Yearyear (latent)", -5.579729825986222),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.496020557860377),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.496020557860377),
                                    ("todayin|within|after <duration>", -6.496020557860377),
                                    ("Marchyear (latent)", -6.496020557860377),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.0905554497522125),
                                    ("Sukkotyear (latent)", -6.0905554497522125),
                                    ("hhhmmintersect", -6.0905554497522125),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.0905554497522125),
                                    ("Clean Mondayyear (latent)", -6.0905554497522125),
                                    ("monthhour", -6.0905554497522125),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.802873377300432),
                                    ("todayat <time-of-day>", -6.496020557860377),
                                    ("Thursday<time> timezone", -4.0981252850620065),
                                    ("tonight<time-of-day> am|pm", -6.496020557860377),
                                    ("time-of-day (latent)tonight", -6.0905554497522125),
                                    ("from|since|after <time>December", -6.496020557860377),
                                    ("<time-of-day> am|pmon <day>", -4.481117537318113),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.496020557860377),
                                    ("yyyy-mm-ddhh:mm:ss", -6.0905554497522125),
                                    ("dayday", -3.8218719084338484),
                                    ("<time> <part-of-day>at <time-of-day>", -6.0905554497522125),
                                    ("mm/ddat <time-of-day>", -6.496020557860377),
                                    ("tonightat <time-of-day>", -5.397408269192267),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.802873377300432),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.496020557860377),
                                    ("today<time-of-day> am|pm", -6.496020557860377),
                                    ("at <time-of-day><time> <part-of-day>", -6.496020557860377),
                                    ("<day-of-month> (ordinal)intersect", -6.0905554497522125),
                                    ("mm/dd<time-of-day> am|pm", -6.496020557860377),
                                    ("hourhour", -3.5256060922906762),
                                    ("Mahavir Jayantiyear (latent)", -6.0905554497522125),
                                    ("Navaratriin|during <named-month>|year", -6.496020557860377),
                                    ("National Patriots' Dayyear (latent)", -5.802873377300432),
                                    ("Wednesdaythis|last|next <cycle>", -6.496020557860377),
                                    ("Lentyear (latent)", -6.496020557860377),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.624218380958785),
                                    ("Boghiyear (latent)", -6.496020557860377),
                                    ("dayyear", -1.8564489451549535),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.496020557860377),
                                    ("Thursdayfrom|since|after <time>", -6.0905554497522125),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.496020557860377),
                                    ("Thursdayat <time-of-day>", -5.802873377300432),
                                    ("Islamic New Yearyear (latent)", -6.0905554497522125),
                                    ("Laylat al-Qadryear (latent)", -5.579729825986222),
                                    ("part of days<time-of-day> am|pm", -6.496020557860377),
                                    ("Discovery Dayyear (latent)", -6.0905554497522125),
                                    ("Shrove Tuesdayyear (latent)", -6.496020557860377),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.802873377300432),
                                    ("hourminute", -6.0905554497522125),
                                    ("<time-of-day> am|pmtomorrow", -5.802873377300432),
                                    ("Yom Kippuryear (latent)", -6.496020557860377),
                                    ("<day-of-month> (ordinal)Tuesday", -6.0905554497522125),
                                    ("<part-of-day> of <time>year (latent)", -6.496020557860377),
                                    ("minutehour", -5.243257589365009),
                                    ("Kaanum Pongalyear (latent)", -6.0905554497522125),
                                    ("Maha Saptamiyear (latent)", -6.496020557860377),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.802873377300432),
                                    ("time-of-day (latent)tomorrow", -5.579729825986222),
                                    ("part of daysat <time-of-day>", -4.886582645426277),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.481117537318113),
                                    ("for <duration> from <time>December", -6.496020557860377),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.496020557860377),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.243257589365009),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.243257589365009),
                                    ("time-of-day (latent)this <part-of-day>", -6.496020557860377),
                                    ("Pentecostyear (latent)", -6.496020557860377),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.243257589365009),
                                    ("<day-of-month> (ordinal)February", -6.496020557860377),
                                    ("Eid al-Fitryear (latent)", -5.109726196740486),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.496020557860377),
                                    ("Mondayin|during the <part-of-day>", -6.496020557860377),
                                    ("Chhathin|during <named-month>|year", -6.496020557860377),
                                    ("Diwaliin|during <named-month>|year", -6.496020557860377),
                                    ("this <part-of-day><time-of-day> am|pm", -6.496020557860377),
                                    ("Vaisakhiin|during <named-month>|year", -6.496020557860377),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.243257589365009),
                                    ("Raksha Bandhanyear (latent)", -6.496020557860377),
                                    ("daysecond", -6.0905554497522125),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.0905554497522125),
                                    ("Ratha-Yatrayear (latent)", -6.496020557860377),
                                    ("Ashurayear (latent)", -6.496020557860377),
                                    ("Tuesdayin|during <named-month>|year", -6.496020557860377),
                                    ("Chinese New Yearyear (latent)", -6.496020557860377),
                                    ("tomorrowintersect", -6.496020557860377),
                                    ("Lag BaOmeryear (latent)", -6.496020557860377),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.496020557860377),
                                    ("Eid al-Adhayear (latent)", -4.355954394364106),
                                    ("Palm Sundayyear (latent)", -6.496020557860377),
                                    ("Christmasat <time-of-day>", -6.496020557860377),
                                    ("Passoveryear (latent)", -6.496020557860377),
                                    ("Lazarus Saturdayyear (latent)", -6.496020557860377),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.496020557860377),
                                    ("the last <cycle> of <time>year (latent)", -5.802873377300432),
                                    ("hhhmmon <day>", -5.579729825986222),
                                    ("Yom HaShoahyear (latent)", -6.0905554497522125),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.0905554497522125),
                                    ("Septemberyear (latent)", -6.0905554497522125),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -4.991943161084103),
                                    ("Halloweenyear (latent)", -6.496020557860377),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.496020557860377),
                                    ("at <time-of-day>intersect", -5.579729825986222),
                                    ("Rosh Hashanahyear (latent)", -5.802873377300432),
                                    ("Dhanterasyear (latent)", -6.496020557860377),
                                    ("Tu BiShvatyear (latent)", -6.496020557860377),
                                    ("<day-of-month> (ordinal)December", -5.802873377300432),
                                    ("Holiyear (latent)", -5.802873377300432),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.496020557860377),
                                    ("Holika Dahanyear (latent)", -5.802873377300432),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.0905554497522125),
                                    ("dayminute", -3.1461164705857723),
                                    ("Mawlidyear (latent)", -6.496020557860377),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.0905554497522125),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.496020557860377),
                                    ("Jumu'atul-Widayear (latent)", -5.579729825986222),
                                    ("minuteday", -2.758350939577009),
                                    ("absorption of , after named dayintersect",
                                     -5.802873377300432),
                                    ("intersectyear (latent)", -6.496020557860377),
                                    ("Orthodox Easter Sundayyear (latent)", -6.496020557860377),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.496020557860377),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.496020557860377),
                                    ("intersecthhhmm", -6.0905554497522125),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.496020557860377),
                                    ("Boss's Dayyear (latent)", -6.0905554497522125),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.496020557860377),
                                    ("Global Youth Service Dayyear (latent)", -6.496020557860377),
                                    ("Dhanterasin|during <named-month>|year", -6.496020557860377),
                                    ("tonight<time-of-day> o'clock", -6.496020557860377),
                                    ("Tisha B'Avyear (latent)", -6.496020557860377),
                                    ("Isra and Mi'rajyear (latent)", -5.579729825986222),
                                    ("at <time-of-day>on <day>", -4.886582645426277),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.0905554497522125),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.802873377300432),
                                    ("Christmasyear (latent)", -6.0905554497522125),
                                    ("Saturdayintersect", -6.496020557860377),
                                    ("Naraka Chaturdashiyear (latent)", -6.0905554497522125),
                                    ("Thai Pongalin|during <named-month>|year", -6.496020557860377),
                                    ("dayweek", -6.496020557860377),
                                    ("Easter Sundayyear (latent)", -5.802873377300432),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.0905554497522125),
                                    ("Labour Dayyear (latent)", -6.496020557860377),
                                    ("weekyear", -5.243257589365009),
                                    ("King's Dayyear (latent)", -4.991943161084103),
                                    ("hh:mmin|during the <part-of-day>", -5.579729825986222),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -6.0905554497522125),
                                    ("Hanukkahyear (latent)", -5.802873377300432),
                                    ("Rama Navamiyear (latent)", -6.496020557860377),
                                    ("February<time> <part-of-day>", -6.496020557860377),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.802873377300432),
                                    ("Great Lentyear (latent)", -6.496020557860377),
                                    ("tomorrowat <time-of-day>", -5.802873377300432),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.496020557860377),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.0905554497522125),
                                    ("Ugadiyear (latent)", -5.109726196740486),
                                    ("Vaisakhiyear (latent)", -5.802873377300432),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.802873377300432),
                                    ("last <cycle> of <time>year (latent)", -5.802873377300432),
                                    ("at <time-of-day>tomorrow", -6.0905554497522125),
                                    ("tomorrow<time-of-day> am|pm", -6.496020557860377),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.496020557860377),
                                    ("Diwaliyear (latent)", -6.496020557860377),
                                    ("between <time> and <time>on <day>", -6.0905554497522125),
                                    ("Black Fridayyear (latent)", -6.0905554497522125),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.496020557860377),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.496020557860377),
                                    ("Chhathyear (latent)", -6.0905554497522125),
                                    ("Vasant Panchamiyear (latent)", -6.496020557860377),
                                    ("Rabindra Jayantiyear (latent)", -5.243257589365009),
                                    ("this <part-of-day>at <time-of-day>", -5.243257589365009),
                                    ("St Patrick's Dayyear (latent)", -6.496020557860377),
                                    ("Thursday<time> (timezone)", -6.496020557860377),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.496020557860377),
                                    ("Pargat Diwasyear (latent)", -5.243257589365009),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.802873377300432),
                                    ("Februaryintersect", -6.496020557860377),
                                    ("Mother's Dayyear (latent)", -6.496020557860377),
                                    ("Simchat Torahyear (latent)", -6.496020557860377),
                                    ("Victoria Dayyear (latent)", -6.0905554497522125),
                                    ("minuteyear", -6.496020557860377)],
                               n = 511},
                   koData =
                     ClassData{prior = -1.0116009116784799, unseen = -6.78897174299217,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.59062040497336),
                                    ("hourday", -3.6968025289512636),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.094697801749634),
                                    ("<day-of-month> (ordinal)August", -6.094697801749634),
                                    ("dayhour", -3.386647600647424),
                                    ("<time> timezoneyear (latent)", -5.401550621189689),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.178407069875479),
                                    ("after <time><time-of-day> am|pm", -6.094697801749634),
                                    ("Tuesdayfrom|since|after <time>", -5.401550621189689),
                                    ("daymonth", -3.4556404721343754),
                                    ("hourquarter", -6.094697801749634),
                                    ("monthyear", -4.841934833254267),
                                    ("<time-of-day> am|pmyear (latent)", -5.401550621189689),
                                    ("time-of-day (latent)qq", -6.094697801749634),
                                    ("Thai Pongalyear (latent)", -5.401550621189689),
                                    ("intersecthh:mm", -6.094697801749634),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.68923269364147),
                                    ("<day-of-month> (ordinal)Wednesday", -6.094697801749634),
                                    ("houryear", -4.841934833254267),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.094697801749634),
                                    ("<day-of-month> (ordinal)October", -6.094697801749634),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.401550621189689),
                                    ("hournograin", -5.178407069875479),
                                    ("<time-of-day> am|pmintersect", -4.841934833254267),
                                    ("Octoberyear (latent)", -6.094697801749634),
                                    ("early morningat <time-of-day>", -6.094697801749634),
                                    ("until <time>on <day>", -5.401550621189689),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.094697801749634),
                                    ("time-of-day (latent)intersect", -5.401550621189689),
                                    ("todayin <number> (implicit minutes)", -6.094697801749634),
                                    ("this <part-of-day><time-of-day> - <time-of-day> (interval)",
                                     -6.094697801749634),
                                    ("hh:mmon <day>", -4.841934833254267),
                                    ("hhhmmintersect", -5.68923269364147),
                                    ("absorption of , after named dayJuly", -5.178407069875479),
                                    ("from|since|after <time>July", -6.094697801749634),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.178407069875479),
                                    ("Clean Mondayyear (latent)", -6.094697801749634),
                                    ("monthhour", -6.094697801749634),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68923269364147),
                                    ("hourmonth", -4.222895624848043),
                                    ("todayat <time-of-day>", -6.094697801749634),
                                    ("hhhmmyear (latent)", -4.841934833254267),
                                    ("from|since|after <time>December", -6.094697801749634),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.094697801749634),
                                    ("<time-of-day> am|pmon <day>", -4.841934833254267),
                                    ("Mondayyear (latent)", -5.401550621189689),
                                    ("dayday", -4.07979478120737),
                                    ("mm/ddat <time-of-day>", -5.68923269364147),
                                    ("on <day>September", -5.401550621189689),
                                    ("time-of-day (latent)September", -5.68923269364147),
                                    ("hourhour", -4.0152562600697985),
                                    ("time-of-day (latent)on <day>", -4.59062040497336),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.68923269364147),
                                    ("dayyear", -3.2324969208201657),
                                    ("Thursdaymm/dd", -6.094697801749634),
                                    ("New Year's Dayyear (latent)", -5.178407069875479),
                                    ("time-of-day (latent)Sunday", -5.68923269364147),
                                    ("Thursdayfrom|since|after <time>", -4.3899497095112086),
                                    ("Thursdayat <time-of-day>", -4.485259889315534),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.094697801749634),
                                    ("Aprilyear (latent)", -6.094697801749634),
                                    ("the <day-of-month> (ordinal)July", -6.094697801749634),
                                    ("the <day-of-month> (number)July", -6.094697801749634),
                                    ("monthminute", -6.094697801749634),
                                    ("<time-of-day> am|pmtomorrow", -6.094697801749634),
                                    ("Thursdayhh:mm", -5.178407069875479),
                                    ("<day-of-month> (ordinal)Tuesday", -5.68923269364147),
                                    ("minutemonth", -3.9546316382533635),
                                    ("time-of-day (latent)Friday", -5.68923269364147),
                                    ("minutehour", -6.094697801749634),
                                    ("part of daysat <time-of-day>", -4.996085513081525),
                                    ("Augustyear (latent)", -5.68923269364147),
                                    ("week-endin|during <named-month>|year", -6.094697801749634),
                                    ("time-of-day (latent)Tuesday", -5.68923269364147),
                                    ...
                                    ("tonight<time-of-day> - <time-of-day> (interval)",
                                     -6.094697801749634),
                                    ("Sundayyear (latent)", -5.178407069875479),
                                    ("the <day-of-month> (ordinal)Monday", -5.401550621189689),
                                    ("Christmasat <time-of-day>", -6.094697801749634),
                                    ("from|since|after <time>year (latent)", -5.178407069875479),
                                    ("the last <cycle> of <time>year (latent)", -5.68923269364147),
                                    ("hhhmmon <day>", -5.178407069875479),
                                    ("yesterday<time-of-day> am|pm", -6.094697801749634),
                                    ("<day-of-month> (ordinal)July", -5.401550621189689),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.094697801749634),
                                    ("mm/ddyear (latent)", -6.094697801749634),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.094697801749634),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.094697801749634),
                                    ("at <time-of-day>intersect", -5.178407069875479),
                                    ("hh:mmyear (latent)", -4.708403440629744),
                                    ("Holiyear (latent)", -6.094697801749634),
                                    ("until <time><time-of-day> am|pm", -6.094697801749634),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.68923269364147),
                                    ("dayminute", -3.2324969208201657),
                                    ("yyyy-mm-ddhh:mm", -5.68923269364147),
                                    ("<named-month> <day-of-month> (non ordinal)through <time>",
                                     -6.094697801749634),
                                    ("intersectfrom|since|after <time>", -5.68923269364147),
                                    ("intersectSeptember", -4.222895624848043),
                                    ("minuteday", -2.937697380599521),
                                    ("absorption of , after named dayintersect",
                                     -6.094697801749634),
                                    ("intersectyear (latent)", -6.094697801749634),
                                    ("Februaryin|during the <part-of-day>", -6.094697801749634),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.094697801749634),
                                    ("time-of-day (latent)July", -5.401550621189689),
                                    ("Saturdayyear (latent)", -6.094697801749634),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.094697801749634),
                                    ("<day-of-month> (ordinal)Monday", -5.178407069875479),
                                    ("at <time-of-day>on <day>", -5.178407069875479),
                                    ("absorption of , after named daySeptember",
                                     -4.841934833254267),
                                    ("Naraka Chaturdashiyear (latent)", -6.094697801749634),
                                    ("from|since|after <time>on <day>", -5.178407069875479),
                                    ("dayweek", -6.094697801749634),
                                    ("Easter Sundayyear (latent)", -5.68923269364147),
                                    ("Thursday<time-of-day> am|pm", -4.841934833254267),
                                    ("weekyear", -5.178407069875479),
                                    ("after <time>year (latent)", -6.094697801749634),
                                    ("time-of-day (latent)Thursday", -5.68923269364147),
                                    ("<day-of-month> (ordinal)April", -6.094697801749634),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.68923269364147),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.401550621189689),
                                    ("Sundayfrom|since|after <time>", -6.094697801749634),
                                    ("absorption of , after named dayFebruary", -5.178407069875479),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.68923269364147),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.094697801749634),
                                    ("tomorrowat <time-of-day>", -6.094697801749634),
                                    ("daynograin", -5.68923269364147),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.68923269364147),
                                    ("last <cycle> of <time>year (latent)", -5.68923269364147),
                                    ("tomorrow<time-of-day> am|pm", -6.094697801749634),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.401550621189689),
                                    ("Diwaliyear (latent)", -5.68923269364147),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.094697801749634),
                                    ("this <part-of-day>at <time-of-day>", -5.178407069875479),
                                    ("Fridayyear (latent)", -5.68923269364147),
                                    ("time-of-day (latent)April", -6.094697801749634),
                                    ("minuteyear", -3.8974732244134147)],
                               n = 292}}),
       ("one eleven",
        Classifier{okData =
       ...
       ("year (latent)",
        Classifier{okData =
                     ClassData{prior = -0.12973632165597107,
                               unseen = -5.4638318050256105,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -2.5863510589919352e-2),
                                    ("intersect 2 numbers", -4.073291153024268)],
                               n = 231},
                   koData =
                     ClassData{prior = -2.106418129378038, unseen = -3.6109179126442243,
                               likelihoods =
                                 HashMap.fromList
       ...
       ("ordinals (first..twentieth,thirtieth,...)",
        Classifier{okData =
                     ClassData{prior = -0.2657031657330056,
                               unseen = -3.2188758248682006,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 23},
                   koData =
                     ClassData{prior = -1.455287232606842, unseen = -2.1972245773362196,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 7}}),
       ("Mawlid",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
       ...
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
        Classifier{okData =
                     ClassData{prior = -0.5389965007326869, unseen = -5.241747015059643,
                               likelihoods =
                                 HashMap.fromList
                                   [("Wednesday<named-month> <day-of-month> (non ordinal)",
                                     -4.543294782270004),
                                    ("dayhour", -4.137829674161839),
                                    ("daymonth", -2.528391761727739),
                                    ...
                                    ("Mondaythis|last|next <cycle>", -4.137829674161839),
                                    ("Fridayintersect", -3.8501476017100584),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -4.137829674161839),
                               ...
                               n = 63},
                   koData =
                     ClassData{prior = -0.8754687373538999, unseen = -5.030437921392435,
                               likelihoods =
                                 HashMap.fromList
