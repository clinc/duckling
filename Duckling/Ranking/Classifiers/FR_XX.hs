  ...
  = HashMap.fromList
      [("n derniers <cycle>",
       ...
       ("<datetime> - <datetime> (interval)",
        Classifier{okData =
                     ClassData{prior = -1.0296194171811581, unseen = -4.442651256490317,
                               likelihoods =
                                 HashMap.fromList
                                 ...
                                 HashMap.fromList
                                   [("<hour-of-day> <integer> (as relative minutes)intersect",
                                    ...
                                    ("year<time-of-day> - <time-of-day> (interval)",
                                     -3.4339872044851463),
                                    ("monthday", -2.8743714165497236),
                                    ("yearhour", -3.4339872044851463),
                                    ("<day-of-week> <day-of-month>Dimanche", -3.721669276936927),
                                    ("Juinintersect", -3.721669276936927),
                                    ("minuteminute", -3.721669276936927),
                                    ("dayday", -1.5244446996007077),
                                    ("<day-of-week> <day-of-month><day-of-week> <day-of-month>",
                                     -3.4339872044851463),
                                    ("day of month (premier)<day-of-month> <named-month>",
                                     -3.4339872044851463),
                                    ("minutehour", -2.6230569882688175),
                                    ("Juillet<day-of-month> <named-month>", -3.721669276936927),
                                    ("<day-of-week> <day-of-month>Mercredi", -4.127134385045092),
                                    ("<hour-of-day> <integer> (as relative minutes)<time-of-day> heures",
                                     -3.4339872044851463),
                                    ("day of month (premier)intersect", -2.8743714165497236),
                                    ("hh(:|h)mm (time-of-day)<time-of-day> heures",
                                     -3.4339872044851463),
                                    ("intersectintersect", -3.2108436531709366),
                                    ("Juinday of month (premier)", -3.721669276936927),
                                    ("hh(:|h)mm (time-of-day)intersect", -3.721669276936927),
                                    ("day of month (premier)Mercredi", -3.4339872044851463),
                                    ("intersectMercredi", -3.721669276936927),
                                    ("<day-of-week> <day-of-month>intersect", -3.721669276936927)],
                               n = 45}}),
